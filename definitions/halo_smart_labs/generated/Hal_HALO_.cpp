...
namespace {
const FzConverter* const kFz_min_HALO_[] = {
    &::zhc::generic::kFzBattery,
    &::zhc::generic::kFzOnOff,
};
constexpr Expose kExp_min_HALO_[] = {
    { "state",   ExposeType::Binary,  ::zhc::Access::StateSet, nullptr, nullptr, nullptr, 0 },
    { "battery", ExposeType::Numeric, ::zhc::Access::State,    "%",  nullptr, nullptr, 0 },
    { "voltage", ExposeType::Numeric, ::zhc::Access::State,    "mV", nullptr, nullptr, 0 },
};
constexpr BindingSpec kBind_min_HALO_[] = {
    { 1, 0x0001 }, { 1, 0x0006 },
};
}
extern const PreparedDefinition kDef_HALO_{
    ...
    .meta=nullptr, .exposes=kExp_min_HALO_, .exposes_count=sizeof(kExp_min_HALO_)/sizeof(kExp_min_HALO_[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_min_HALO_, .from_zigbee_count=sizeof(kFz_min_HALO_)/sizeof(kFz_min_HALO_[0]),
    .to_zigbee=nullptr, .to_zigbee_count=0,
    .configure=nullptr, .on_event=nullptr,
    .bindings                 = kBind_min_HALO_,
    .bindings_count           = sizeof(kBind_min_HALO_)/sizeof(kBind_min_HALO_[0]),
};
