...
// Tier 1: Adurosmart 81809FBA — hand-rewritten to use Adu_ColorCTLight bundle.
...
// z2m-source: adurosmart.ts #81809FBA.
...
constexpr const char* kModels_D81809FBA[] = { "AD-RGBW3001" };

}  // namespace

extern const PreparedDefinition kDef_D81809FBA{
    .zigbee_models=kModels_D81809FBA,
    .zigbee_models_count=sizeof(kModels_D81809FBA)/sizeof(kModels_D81809FBA[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="81809FBA", .vendor="Adurosmart",
    .meta=nullptr,
