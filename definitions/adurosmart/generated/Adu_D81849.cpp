...
// Tier 1: Adurosmart 81849 — hand-rewritten to use Adu_Light bundle.
// ERIA built-in multi dimmer module 300W.
// z2m extend: m.light({configureReporting: true}).
// z2m-source: adurosmart.ts #81849.
...
constexpr const char* kModels_D81849[] = { "AD-Dimmer" };

}  // namespace

extern const PreparedDefinition kDef_D81849{
    .zigbee_models=kModels_D81849,
    .zigbee_models_count=sizeof(kModels_D81849)/sizeof(kModels_D81849[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="81849", .vendor="Adurosmart",
    .meta=nullptr,
