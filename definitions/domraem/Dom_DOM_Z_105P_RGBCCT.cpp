...
// Tier 2: Domraem DOM-Z-105P_RGBCCT — hand-rewritten ColorCTLight bundle.
...
// z2m-source: domraem.ts #DOM-Z-105P_RGBCCT (modelID "RGBWC").
#include "definitions/_generic/_shared.hpp"

namespace zhc::devices::domraem {
namespace {
const FzConverter* const kFz_DOM_Z_105P_RGBCCT[] = {
    &::zhc::generic::kFzOnOff,
    &::zhc::generic::kFzBrightness,
    &::zhc::generic::kFzColorTemperature,
    &::zhc::generic::kFzColor,
};
const TzConverter* const kTz_DOM_Z_105P_RGBCCT[] = {
    &::zhc::generic::kTzOnOff,
    &::zhc::generic::kTzBrightness,
    &::zhc::generic::kTzColorTemp,
    &::zhc::generic::kTzColor,
};
constexpr const char* kModels_DOM_Z_105P_RGBCCT[] = { "RGBWC" };
...
extern const PreparedDefinition kDef_DOM_Z_105P_RGBCCT{
    .zigbee_models=kModels_DOM_Z_105P_RGBCCT, .zigbee_models_count=sizeof(kModels_DOM_Z_105P_RGBCCT)/sizeof(kModels_DOM_Z_105P_RGBCCT[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="DOM-Z-105P_RGBCCT", .vendor="Domraem",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_DOM_Z_105P_RGBCCT, .from_zigbee_count=sizeof(kFz_DOM_Z_105P_RGBCCT)/sizeof(kFz_DOM_Z_105P_RGBCCT[0]),
    .to_zigbee=kTz_DOM_Z_105P_RGBCCT, .to_zigbee_count=sizeof(kTz_DOM_Z_105P_RGBCCT)/sizeof(kTz_DOM_Z_105P_RGBCCT[0]),
