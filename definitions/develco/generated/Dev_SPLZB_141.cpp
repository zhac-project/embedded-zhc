...
namespace {
const FzConverter* const kFz_SPLZB_141[] = {
    &::zhc::generic::kFzOnOff,
    &::zhc::generic::kFzMetering,
    &::zhc::generic::kFzElectricalMeasurement,
};
const TzConverter* const kTz_SPLZB_141[] = {
    &::zhc::generic::kTzOnOff,
};
constexpr const char* kModels_SPLZB_141[] = { "SPLZB-141" };
...
extern const PreparedDefinition kDef_SPLZB_141{
    ...
    .model="SPLZB-141", .vendor="Develco",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_SPLZB_141, .from_zigbee_count=sizeof(kFz_SPLZB_141)/sizeof(kFz_SPLZB_141[0]),
