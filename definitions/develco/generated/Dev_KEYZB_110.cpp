...
// Tier 1: Develco KEYZB-110 — auto-generated.
// Keypad
// z2m-source: develco.ts #KEYZB-110.
#include "definitions/_generic/_shared.hpp"

namespace zhc::devices::develco {
namespace {
const FzConverter* const kFz_KEYZB_110[] = {
    &::zhc::generic::kFzOnOff,
    &::zhc::generic::kFzBattery,
    &::zhc::generic::kFzIasZone,
};
const TzConverter* const kTz_KEYZB_110[] = {
    &::zhc::generic::kTzOnOff,
};
constexpr const char* kModels_KEYZB_110[] = { "KEPZB-110" };
