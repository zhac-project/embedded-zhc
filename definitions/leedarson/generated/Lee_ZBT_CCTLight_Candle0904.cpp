...
// Tier 1: Leedarson ZBT-CCTLight-Candle0904 — hand-rewritten 2026-04-29.
// LED E14 tunable white
// z2m-source: leedarson.ts #ZBT-CCTLight-Candle0904.
...
namespace {
constexpr const char* kModels_ZBT_CCTLight_Candle0904[] = { "ZBT-CCTLight-Candle0904" };
}  // namespace

extern const PreparedDefinition kDef_ZBT_CCTLight_Candle0904{
    .zigbee_models=kModels_ZBT_CCTLight_Candle0904, .zigbee_models_count=sizeof(kModels_ZBT_CCTLight_Candle0904)/sizeof(kModels_ZBT_CCTLight_Candle0904[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="ZBT-CCTLight-Candle0904", .vendor="Leedarson",
    .meta=nullptr,
