...
// Tier 1: Iolloi ID-UK21FW09 — auto-generated.
// Zigbee LED smart dimmer switch
// z2m-source: iolloi.ts #ID-UK21FW09.
#include "definitions/_generic/_shared.hpp"

namespace zhc::devices::iolloi {
namespace {
const FzConverter* const kFz_ID_UK21FW09[] = {
    &::zhc::generic::kFzOnOff,
    &::zhc::generic::kFzBrightness,
};
const TzConverter* const kTz_ID_UK21FW09[] = {
    &::zhc::generic::kTzOnOff,
    &::zhc::generic::kTzBrightness,
};
constexpr const char* kModels_ID_UK21FW09[] = { "Dimmer-Switch-ZB3.0" };
