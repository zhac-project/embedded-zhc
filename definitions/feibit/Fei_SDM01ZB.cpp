...
// Tier 2: Feibit SDM01ZB — hand-curated (was IAS dead-key).
// z2m fz.ias_contact_alarm_1 (bit 0) -> key `contact`;
// generic kFzIasZone emitted bare "alarm". Swapped to kFzIasContactAlarm.
