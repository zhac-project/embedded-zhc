...
extern const PreparedDefinition kDef_STH01ZB{
    .zigbee_models=kModels_STH01ZB, .zigbee_models_count=sizeof(kModels_STH01ZB)/sizeof(kModels_STH01ZB[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="STH01ZB", .vendor="Feibit",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_STH01ZB, .from_zigbee_count=sizeof(kFz_STH01ZB)/sizeof(kFz_STH01ZB[0]),
