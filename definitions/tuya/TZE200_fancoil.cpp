...
// Tier 3: _TZE200_ztvwu4nk fan coil unit. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_ztvwu4nk"};
}
...
extern const PreparedDefinition kDefTZE200_fancoil{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_fancoil",
