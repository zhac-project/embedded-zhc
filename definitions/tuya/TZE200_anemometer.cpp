...
// Tier 3: _TZE200_anemometer precision wind anemometer. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"wind_speed",100),
    ::zhc::tuya::dp::numeric(2,"gust_speed",100),
    ::zhc::tuya::dp::numeric(3,"wind_direction",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_anemometer"};
}
...
extern const PreparedDefinition kDefTZE200_anemometer{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_anemometer",
