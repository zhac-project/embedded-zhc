...
// Tier 3: _TZE200_gate gate-position sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"gate_open"),
    ::zhc::tuya::dp::numeric(2,"angle",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_gate"};
}
...
extern const PreparedDefinition kDefTZE200_gate{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_gate",
