...
// Tier 3: _TZE200_tikbvogc RF-bridge controller. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"rf_code",1),
    ::zhc::tuya::dp::binary(2,"learn_mode")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_tikbvogc"};
}
...
extern const PreparedDefinition kDefTZE200_rf_ctrl{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_rf_ctrl",
