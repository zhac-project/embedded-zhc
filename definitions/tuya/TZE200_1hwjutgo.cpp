...
// Tier 2: _TZE200_1hwjutgo plug variant.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_1hwjutgo"};
}
...
extern const PreparedDefinition kDefTZE200_1hwjutgo{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_1hwjutgo",.vendor="Tuya",
