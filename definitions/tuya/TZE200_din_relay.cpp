...
// Tier 2: _TZE200_lthrd8bz DIN-rail relay. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_lthrd8bz"};
}
...
extern const PreparedDefinition kDefTZE200_din_relay{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_din_relay",
