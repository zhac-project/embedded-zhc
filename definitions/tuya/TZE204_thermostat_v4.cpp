...
// Tier 3: _TZE204_thermostat_v4 thermostat v4. z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kM2[]={{0,"off"},{1,"heat"},{2,"cool"},{3,"auto"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),
    ::zhc::tuya::dp::enum_lookup(2,"system_mode",kM2,4),
    ::zhc::tuya::dp::numeric(16,"setpoint",10),
    ::zhc::tuya::dp::temperature(24),
    ::zhc::tuya::dp::binary(40,"child_lock"),
    ::zhc::tuya::dp::binary(28,"running_state")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,6}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE204_thermostat_v4"};
}
...
extern const PreparedDefinition kDefTZE204_thermostat_v4{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_thermostat_v4",
