...
// Tier 2: _TZE200_d0yu2xgi slim temp/humidity sensor. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_d0yu2xgi"};
}
...
extern const PreparedDefinition kDefTZE200_th_slim{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_th_slim",
