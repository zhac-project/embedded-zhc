...
// Tier 3: _TZE200_washer washing machine. z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kPg[]={
    {0,"idle"},{1,"wash"},{2,"rinse"},{3,"spin"},{4,"done"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),
    ::zhc::tuya::dp::enum_lookup(2,"program",kPg,5),
    ::zhc::tuya::dp::numeric(3,"remaining_minutes",1),
    ::zhc::tuya::dp::numeric(4,"current_cycle",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_washer"};
}
...
extern const PreparedDefinition kDefTZE200_washer{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_washer",
