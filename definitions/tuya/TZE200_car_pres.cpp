...
// Tier 3: _TZE200_dwcarsat car-presence detector. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"car_present"),
    ::zhc::tuya::dp::numeric(4,"distance",100)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_dwcarsat"};
}
...
extern const PreparedDefinition kDefTZE200_car_pres{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_car_pres",
