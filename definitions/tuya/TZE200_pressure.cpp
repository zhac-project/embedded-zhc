...
// Tier 2: _TZE200_nlrfgpny pressure sensor. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_nlrfgpny"};
}
...
extern const PreparedDefinition kDefTZE200_pressure{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_pressure",
