...
// Tier 3: _TZE200_ppuj1vem HCHO+CO2 combo. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_ppuj1vem"};
}
...
extern const PreparedDefinition kDefTZE200_hcho_co2{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_hcho_co2",
