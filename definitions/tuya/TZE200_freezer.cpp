...
// Tier 3: _TZE200_znbl8dj5 freezer temp alarm. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_znbl8dj5"};
}
...
extern const PreparedDefinition kDefTZE200_freezer{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_freezer",
