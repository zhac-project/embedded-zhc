...
// Tier 3: _TZE200_rice_cooker smart rice cooker. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_rice_cooker"};
}
...
extern const PreparedDefinition kDefTZE200_rice_cooker{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_rice_cooker",
