...
// Tier 3: _TZE200_uv_lamp UV sterilization lamp. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(7,"total_runtime",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_uv_lamp"};
}
...
extern const PreparedDefinition kDefTZE200_uv_lamp{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_uv_lamp",
