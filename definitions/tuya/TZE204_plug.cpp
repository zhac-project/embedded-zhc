...
// Tier 2: _TZE204_iuibaj4r newer Tuya plug protocol v4. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),::zhc::tuya::dp::numeric(17,"energy",100),
    ::zhc::tuya::dp::numeric(18,"current",1000),::zhc::tuya::dp::numeric(19,"power",10)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE204_iuibaj4r"};
}
...
extern const PreparedDefinition kDefTZE204_plug{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_plug_v4",
