...
// Tier 2: _TZE200_tz32mtia 4-gang switch.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_tz32mtia"};
}
...
extern const PreparedDefinition kDefTZE200_tz32mtia{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_tz32mtia",.vendor="Tuya",
