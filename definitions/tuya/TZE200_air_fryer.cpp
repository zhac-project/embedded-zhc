...
// Tier 3: _TZE200_air_fryer air fryer. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(3,"target_temp",10),
    ::zhc::tuya::dp::numeric(4,"remaining_minutes",1),
    ::zhc::tuya::dp::binary(5,"preset_mode")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,5}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_air_fryer"};
}
...
extern const PreparedDefinition kDefTZE200_air_fryer{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_air_fryer",
