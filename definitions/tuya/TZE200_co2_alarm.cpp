...
// Tier 2: _TZE200_kb5noeto CO2 alarm. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_kb5noeto"};
}
...
extern const PreparedDefinition kDefTZE200_co2_alarm{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_co2_alarm",
