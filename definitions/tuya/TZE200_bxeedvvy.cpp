...
// Tier 2: _TZE200_bxeedvvy dimmer.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),::zhc::tuya::dp::numeric(2,"brightness",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaLight<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_bxeedvvy"};
}
...
extern const PreparedDefinition kDefTZE200_bxeedvvy{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_bxeedvvy",.vendor="Tuya",
