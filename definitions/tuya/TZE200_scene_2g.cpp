...
// Tier 2: _TZE200_amp6tsvy 2-gang scene wall. z2m-source: tuya.ts.
...
static constexpr ::zhc::tuya::TuyaEnumEntry kA[]={
    {0,"scene_1"},{1,"scene_2"},{2,"hold_1"},{3,"hold_2"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::action(101,kA,4),
    ::zhc::tuya::dp::numeric(102,"battery",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_amp6tsvy"};
}
...
extern const PreparedDefinition kDefTZE200_scene_2g{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_scene_2g",
