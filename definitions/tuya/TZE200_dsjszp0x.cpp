...
// Tier 2: _TZE200_dsjszp0x light sensor.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"illuminance",1),::zhc::tuya::dp::numeric(4,"battery",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_dsjszp0x"};
}
...
extern const PreparedDefinition kDefTZE200_dsjszp0x{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_dsjszp0x",.vendor="Tuya",
