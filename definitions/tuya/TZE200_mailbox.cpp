...
// Tier 3: _TZE200_kdpc5rfd mailbox delivery sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"delivery"),
    ::zhc::tuya::dp::numeric(2,"mail_count",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_kdpc5rfd"};
}
...
extern const PreparedDefinition kDefTZE200_mailbox{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_mailbox",
