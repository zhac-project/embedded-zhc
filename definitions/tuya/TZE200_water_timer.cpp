...
// Tier 3: _TZE200_water_timer irrigation water timer. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(7,"run_time",1),
    ::zhc::tuya::dp::numeric(11,"flow_total",100)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_water_timer"};
}
...
extern const PreparedDefinition kDefTZE200_water_timer{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_water_timer",
