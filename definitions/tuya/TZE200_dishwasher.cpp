...
// Tier 3: _TZE200_dishwasher smart dishwasher. z2m-source: tuya.ts.
...
static constexpr ::zhc::tuya::TuyaEnumEntry kPg[]={
    {0,"idle"},{1,"eco"},{2,"intensive"},{3,"quick"},{4,"rinse"}};
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_dishwasher"};
}
...
extern const PreparedDefinition kDefTZE200_dishwasher{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_dishwasher",
