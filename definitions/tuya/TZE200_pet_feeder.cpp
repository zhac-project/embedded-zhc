...
// Tier 3: _TZE200_xrskcfuc DP pet feeder. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"feed_size",1),
    ::zhc::tuya::dp::numeric(13,"feed_count",1),
    ::zhc::tuya::dp::binary(18,"led_indicator"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_xrskcfuc"};
}
...
extern const PreparedDefinition kDefTZE200_pet_feeder{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_pet_feeder",
