...
// Tier 3: _TZE200_eueudvys projector screen. z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kCtl[]={{0,"open"},{1,"stop"},{2,"close"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::enum_lookup(1,"control",kCtl,3),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_eueudvys"};
}
...
extern const PreparedDefinition kDefTZE200_proj_screen{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_proj_screen",
