...
// Tier 3: _TZE200_tank tank fluid-level sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"level_percent",1),
    ::zhc::tuya::dp::numeric(2,"level_cm",1),
    ::zhc::tuya::dp::binary(3,"low_alarm"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_tank"};
}
...
extern const PreparedDefinition kDefTZE200_tank{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_tank",
