...
// Tier 2: _TZE200_8nyaanzb plug variant.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_8nyaanzb"};
}
...
extern const PreparedDefinition kDefTZE200_8nyaanzb{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_8nyaanzb",.vendor="Tuya",
