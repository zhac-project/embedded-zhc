...
// Tier 3: _TZE200_ryfmq5rl radar v5. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(3,"detection_range_min",100),
    ::zhc::tuya::dp::numeric(4,"detection_range_max",100)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_ryfmq5rl"};
}
...
extern const PreparedDefinition kDefTZE200_radar_v5{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_radar_v5",
