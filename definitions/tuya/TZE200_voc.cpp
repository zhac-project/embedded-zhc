...
// Tier 2: _TZE200_0pvxcnqk DP VOC air quality. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"voc",1),::zhc::tuya::dp::numeric(18,"co2",1),
    ::zhc::tuya::dp::temperature(19),::zhc::tuya::dp::numeric(20,"humidity",10)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_0pvxcnqk"};
}
...
extern const PreparedDefinition kDefTZE200_voc{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_voc",
