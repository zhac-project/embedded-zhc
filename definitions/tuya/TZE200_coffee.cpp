...
// Tier 3: _TZE200_coffee coffee machine. z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kCp[]={
    {0,"espresso"},{1,"americano"},{2,"latte"},{3,"cappuccino"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),
    ::zhc::tuya::dp::enum_lookup(2,"beverage",kCp,4),
    ::zhc::tuya::dp::numeric(3,"cups_made",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_coffee"};
}
...
extern const PreparedDefinition kDefTZE200_coffee{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_coffee",
