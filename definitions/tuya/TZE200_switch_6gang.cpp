...
// Tier 2: _TZE200_nh9m9emk 6-gang switch. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_nh9m9emk"};
}
...
extern const PreparedDefinition kDefTZE200_switch_6gang{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_switch_6g",
