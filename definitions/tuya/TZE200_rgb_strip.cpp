...
// Tier 3: _TZE200_rgb_strip RGB LED strip. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(24,"color_hsv",1),
    ::zhc::tuya::dp::numeric(26,"scene",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaLight<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_rgb_strip"};
}
...
extern const PreparedDefinition kDefTZE200_rgb_strip{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_rgb_strip",
