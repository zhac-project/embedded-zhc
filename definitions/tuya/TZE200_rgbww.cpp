...
// Tier 3: _TZE200_riwp3k79 RGBWW light via DP. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(23,"color_temp",1),
    ::zhc::tuya::dp::binary(21,"work_mode")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaLight<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_riwp3k79"};
}
...
extern const PreparedDefinition kDefTZE200_rgbww{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_rgbww",
