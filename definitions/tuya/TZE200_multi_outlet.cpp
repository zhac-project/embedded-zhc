...
// Tier 2: _TZE200_fdtjuw7u 4-socket power strip. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(7,"state_usb"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_fdtjuw7u"};
}
...
constexpr WhiteLabel kWhiteLabels_TZE200_multi_outlet[] = {
    {"Yushun","YS-MT750L"},
...
extern const PreparedDefinition kDefTZE200_multi_outlet{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_multi_outlet",
    .vendor="Tuya",.meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_TZE200_multi_outlet, .white_labels_count=sizeof(kWhiteLabels_TZE200_multi_outlet)/sizeof(kWhiteLabels_TZE200_multi_outlet[0]),
