...
// Tier 3: _TZE200_8chrdpld vanadium / heavy metal sensor. z2m-source: tuya.ts.
...
extern const PreparedDefinition kDefTZE200_vanadium{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_vanadium",
