...
// Tier 3: _TZE200_azqp6ssj TRV v2. z2m-source: tuya.ts.
...
static constexpr ::zhc::tuya::TuyaEnumEntry kModes[]={
    {0,"auto"},{1,"manual"},{2,"off"},{3,"on"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::enum_lookup(2,"system_mode",kModes,4),
    ::zhc::tuya::dp::numeric(3,"current_heating_setpoint",10),
    ::zhc::tuya::dp::temperature(4),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_azqp6ssj"};
}
...
extern const PreparedDefinition kDefTZE200_trv_v2{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_trv_v2",
