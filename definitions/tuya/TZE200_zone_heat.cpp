...
// Tier 3: _TZE200_zone_heat multi-zone heating controller. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"zone1_state"),
    ::zhc::tuya::dp::numeric(2,"zone1_setpoint",10),
    ::zhc::tuya::dp::binary(3,"zone2_state"),
    ::zhc::tuya::dp::numeric(4,"zone2_setpoint",10)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_zone_heat"};
}
...
extern const PreparedDefinition kDefTZE200_zone_heat{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_zone_heat",
