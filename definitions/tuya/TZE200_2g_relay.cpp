...
// Tier 2: _TZE200_2g_relay 2-gang scene relay. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(9,"backlight")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_2g_relay"};
}
...
extern const PreparedDefinition kDefTZE200_2g_relay{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_2g_relay",
