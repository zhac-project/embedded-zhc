...
// Tier 2: _TZE200_3lh2mfyy 1-gang + USB + countdowns. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state_l1"),::zhc::tuya::dp::binary(7,"state_usb"),
    ::zhc::tuya::dp::numeric(9,"countdown_l1",1),
    ::zhc::tuya::dp::numeric(10,"countdown_usb",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_3lh2mfyy"};
}
...
extern const PreparedDefinition kDefTZE200_1g_usb_cd{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_1g_usb_cd",
