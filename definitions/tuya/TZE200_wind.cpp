...
// Tier 3: _TZE200_wreyozwk wind speed + direction. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"wind_speed",10),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_wreyozwk"};
}
...
extern const PreparedDefinition kDefTZE200_wind{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_wind",
