...
// Tier 2: _TZE200_5d3vhjro plug variant.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_5d3vhjro"};
}
...
extern const PreparedDefinition kDefTZE200_5d3vhjro{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_5d3vhjro",.vendor="Tuya",
