...
// Tier 3: _TZE200_street_light street / outdoor LED light. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(101,"auto_on_dusk"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_street_light"};
}
...
extern const PreparedDefinition kDefTZE200_street_light{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_street_light",
