...
// Tier 3: _TZE200_9qquxjyr IR remote blaster. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::temperature(101),
    ::zhc::tuya::dp::numeric(102,"humidity",10),
    ::zhc::tuya::dp::numeric(201,"learn_code",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_9qquxjyr"};
}
...
extern const PreparedDefinition kDefTZE200_ir_blaster{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_ir_blaster",
