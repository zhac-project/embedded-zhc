...
// Tier 2: _TZE200_g8jqeidm DP formaldehyde sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"formaldehyde",1000),
    ::zhc::tuya::dp::temperature(18),::zhc::tuya::dp::numeric(19,"humidity",10)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_g8jqeidm"};
}
...
extern const PreparedDefinition kDefTZE200_formaldehyde{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_hcho",
