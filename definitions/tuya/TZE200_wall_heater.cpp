...
// Tier 3: _TZE200_wall_heater electric wall heater. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_wall_heater"};
}
...
extern const PreparedDefinition kDefTZE200_wall_heater{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_wall_heater",
