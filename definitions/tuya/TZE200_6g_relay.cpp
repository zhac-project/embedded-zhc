...
// Tier 2: _TZE200_6g_relay 6-channel relay module. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state_c1"),::zhc::tuya::dp::binary(2,"state_c2"),
    ::zhc::tuya::dp::binary(3,"state_c3"),::zhc::tuya::dp::binary(4,"state_c4"),
    ::zhc::tuya::dp::binary(5,"state_c5"),::zhc::tuya::dp::binary(6,"state_c6")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,6}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_6g_relay"};
}
...
extern const PreparedDefinition kDefTZE200_6g_relay{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_6g_relay",
