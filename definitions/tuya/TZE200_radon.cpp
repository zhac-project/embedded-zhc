...
// Tier 3: _TZE200_8w7ixedx radon detector. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"radon_bqm3",1),
    ::zhc::tuya::dp::numeric(3,"radon_avg_24h",1),
    ::zhc::tuya::dp::binary(13,"alarm")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_8w7ixedx"};
}
...
extern const PreparedDefinition kDefTZE200_radon{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_radon",
