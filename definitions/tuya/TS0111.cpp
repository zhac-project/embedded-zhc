...
// Tier 2: Tuya TS0111 metering plug (non-DP). z2m-source: tuya.ts.
#include "definitions/_generic/_shared.hpp"
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::tuya {
namespace {
constexpr ::zhc::lumi::LumiPowerCalibration kP{1,1000,10};
constexpr ::zhc::lumi::LumiMeterCalibration kM{1000};
