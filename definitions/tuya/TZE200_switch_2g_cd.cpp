...
// Tier 2: _TZE200_a8fqmxlm 2-gang + per-gang countdowns. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_a8fqmxlm"};
}
...
extern const PreparedDefinition kDefTZE200_switch_2g_cd{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_2g_cd",
