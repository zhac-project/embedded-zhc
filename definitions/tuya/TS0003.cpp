...
// Tier 1: Tuya TS0003 3-gang on/off.
// z2m-source: tuya.ts #TS0003.
#include "definitions/_generic/_shared.hpp"
#include "definitions/tuya/_shared.hpp"   // kReportsOnOff_3ep
namespace zhc::devices::tuya {
namespace {
const FzConverter* const kFz[] = { &::zhc::generic::kFzOnOff };
const TzConverter* const kTz[] = { &::zhc::generic::kTzOnOff };
constexpr const char* kModels[] = { "TS0003", "ZG-301Z-3CH" };  // ZG-301Z-3CH: HOBEIAN 3-gang, z2m TS0003_switch_module_3 zigbeeModel
}
...
constexpr WhiteLabel kWhiteLabels_TS0003[] = {
    {"Tuya","TS0003_1"},
    {"Zemismart","TB26-3"},
    {"BSEED","TS0003"},
};
extern const PreparedDefinition kDefTS0003{
    ...
    .white_labels=kWhiteLabels_TS0003, .white_labels_count=sizeof(kWhiteLabels_TS0003)/sizeof(kWhiteLabels_TS0003[0]),
    .from_zigbee=kFz,.from_zigbee_count=sizeof(kFz)/sizeof(kFz[0]),
    .to_zigbee=kTz,.to_zigbee_count=sizeof(kTz)/sizeof(kTz[0]),
    .configure=nullptr,.on_event=nullptr,
.bindings=kAutoBindings,.bindings_count=sizeof(kAutoBindings)/sizeof(kAutoBindings[0]),
    // z2m TS0003 m.onOff(left/center/right): reporting.onOff EP1..3. 3-gang.
