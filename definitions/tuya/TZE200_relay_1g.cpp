...
// Tier 2: _TZE200_1ih5dmk7 1-gang relay module. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(101,"inching_mode")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_1ih5dmk7"};
}
...
extern const PreparedDefinition kDefTZE200_relay_1g{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_relay_1g",
