...
// Tier 3: _TZE200_dj4fcdht solar-powered outdoor sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(5,"solar_power",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,5}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_dj4fcdht"};
}
...
extern const PreparedDefinition kDefTZE200_solar{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_solar",
