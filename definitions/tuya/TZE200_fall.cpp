...
// Tier 3: _TZE200_a7sghmms fall detector. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"fall_detected"),
    ::zhc::tuya::dp::numeric(2,"impact_level",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_a7sghmms"};
}
...
extern const PreparedDefinition kDefTZE200_fall{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_fall",
