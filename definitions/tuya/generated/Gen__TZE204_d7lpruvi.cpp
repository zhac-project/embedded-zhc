...
constexpr const char* kAutoOpts__TZE204_d7lpruvi_2[] = {"low", "medium", "high"};
constexpr const char* kAutoOpts__TZE204_d7lpruvi_3[] = {"celsius", "fahrenheit"};
constexpr Expose kAutoExposes__TZE204_d7lpruvi[] = {
    {"temperature", ExposeType::Numeric, Access::State, "°C", nullptr, nullptr, 0},
    {"humidity", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0},
    {"battery_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE204_d7lpruvi_2, 3, ExposeCategory::Diagnostic},
    {"temperature_unit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_d7lpruvi_3, 2},
};
...
extern const PreparedDefinition kDefGen__TZE204_d7lpruvi{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_d7lpruvi,.exposes_count=sizeof(kAutoExposes__TZE204_d7lpruvi)/sizeof(kAutoExposes__TZE204_d7lpruvi[0]),
