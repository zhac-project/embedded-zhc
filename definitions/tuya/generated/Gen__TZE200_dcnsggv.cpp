...
constexpr const char* kAutoOpts__TZE200_dcnsggv_4[] = {"off", "on", "previous"};
constexpr const char* kAutoOpts__TZE200_dcnsggv_6[] = {"led", "incandescent", "halogen"};
constexpr const char* kAutoOpts__TZE200_dcnsggv_7[] = {"toggle", "state", "momentary"};
constexpr Expose kAutoExposes__TZE200_dcnsggv[] = {
    ...
    {"power_on_behavior", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_dcnsggv_4, 3},
    {"countdown", ExposeType::Numeric, Access::StateSet, "s", nullptr, nullptr, 0, ExposeCategory::State, 0, 43200, 1},
    {"light_type", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_dcnsggv_6, 3},
    {"switch_type", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_dcnsggv_7, 3, ExposeCategory::Config},
};
...
extern const PreparedDefinition kDefGen__TZE200_dcnsggv{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_dcnsggv,.exposes_count=sizeof(kAutoExposes__TZE200_dcnsggv)/sizeof(kAutoExposes__TZE200_dcnsggv[0]),
