...
constexpr const char* kAutoOpts__TZE204_6a4vxfnv_0[] = {"off", "heat"};
constexpr const char* kAutoOpts__TZE204_6a4vxfnv_1[] = {"manual", "auto"};
constexpr const char* kAutoOpts__TZE204_6a4vxfnv_2[] = {"idle", "heat"};
constexpr Expose kAutoExposes__TZE204_6a4vxfnv[] = {
    {"system_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_6a4vxfnv_0, 2},
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_6a4vxfnv_1, 2},
    {"running_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE204_6a4vxfnv_2, 2},
...
extern const PreparedDefinition kDefGen__TZE204_6a4vxfnv{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_6a4vxfnv,.exposes_count=sizeof(kAutoExposes__TZE204_6a4vxfnv)/sizeof(kAutoExposes__TZE204_6a4vxfnv[0]),
