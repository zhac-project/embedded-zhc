...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0105 / _TZE600_ogyg1y6b).
// Placeholder — fill in DP map + swap to factory::TuyaOnOff when porting.
#include "definitions/_generic/_shared.hpp"
#include "definitions/tuya/_shared.hpp"
namespace zhc::devices::tuya {
namespace {
const FzConverter* const kFzGen__TZE600_ogyg1y6b[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
};
constexpr const char* kMGen__TZE600_ogyg1y6b[]  = { "TS0105" };
constexpr const char* kNGen__TZE600_ogyg1y6b[]  = { "_TZE600_ogyg1y6b" };
}
...
namespace {
const FzConverter* const kFz_min_TS0105__TZE600_ogyg1y6b_Gen__TZE600_ogyg1y6b[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &::zhc::generic::kFzBattery, &::zhc::generic::kFzOnOff,
};
constexpr Expose kExp_min_TS0105__TZE600_ogyg1y6b_Gen__TZE600_ogyg1y6b[] = {
