...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE204_o3x45p96).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_o3x45p96_system_mode_dp2[] = {
    { 0, "auto" },
    { 1, "heat" },
    { 2, "off" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_o3x45p96_running_state_dp3[] = {
    { 0, "heat" },
    { 1, "idle" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE204_o3x45p96[] = {
    { 2, "system_mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_o3x45p96_system_mode_dp2, sizeof(kEnum__TZE204_o3x45p96_system_mode_dp2)/sizeof(kEnum__TZE204_o3x45p96_system_mode_dp2[0]) },
    { 3, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_o3x45p96_running_state_dp3, sizeof(kEnum__TZE204_o3x45p96_running_state_dp3)/sizeof(kEnum__TZE204_o3x45p96_running_state_dp3[0]) },
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE204_o3x45p96{ kEntries__TZE204_o3x45p96, 16 };
constexpr FzConverter kFzDp__TZE204_o3x45p96{
    ...
    .user_config       = &kMap__TZE204_o3x45p96,
};
const FzConverter* const kFz__TZE204_o3x45p96[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE204_o3x45p96,
};
constexpr TzConverter kTzDp__TZE204_o3x45p96{
...
const TzConverter* const kTz__TZE204_o3x45p96[] = { &kTzDp__TZE204_o3x45p96 };
constexpr const char* kM__TZE204_o3x45p96[] = { "TS0601" };
constexpr const char* kN__TZE204_o3x45p96[] = { "_TZE204_o3x45p96" };
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0) ---
constexpr const char* kAutoOpts__TZE204_o3x45p96_4[] = {"auto", "heat", "off"};
constexpr const char* kAutoOpts__TZE204_o3x45p96_5[] = {"idle", "heat"};
constexpr Expose kAutoExposes__TZE204_o3x45p96[] = {
    ...
    {"system_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_o3x45p96_4, 3},
    {"running_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE204_o3x45p96_5, 2},
...
constexpr WhiteLabel kWhiteLabels_Gen_TZE204_o3x45p96[] = {
    {"AVATTO","ME167"},
    {"AVATTO","ME168_1"},
    {"AVATTO","TRV06_1"},
    {"EARU","TRV06"},
...
extern const PreparedDefinition kDefGen__TZE204_o3x45p96{
    .zigbee_models=kM__TZE204_o3x45p96,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE204_o3x45p96,.manufacturer_names_count=1,
    .model="TS0601__TZE204_o3x45p96",.vendor="Tuya",
    .meta=nullptr,.exposes=kAutoExposes__TZE204_o3x45p96,.exposes_count=sizeof(kAutoExposes__TZE204_o3x45p96)/sizeof(kAutoExposes__TZE204_o3x45p96[0]),
    .white_labels=kWhiteLabels_Gen_TZE204_o3x45p96, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE204_o3x45p96)/sizeof(kWhiteLabels_Gen_TZE204_o3x45p96[0]),
    .from_zigbee=kFz__TZE204_o3x45p96,
    .from_zigbee_count=sizeof(kFz__TZE204_o3x45p96)/sizeof(kFz__TZE204_o3x45p96[0]),
    .to_zigbee=kTz__TZE204_o3x45p96,
    .to_zigbee_count=sizeof(kTz__TZE204_o3x45p96)/sizeof(kTz__TZE204_o3x45p96[0]),
