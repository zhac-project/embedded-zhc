...
constexpr const char* kAutoOpts__TZE204_jygvp6fk_2[] = {"low", "medium", "high"};
constexpr const char* kAutoOpts__TZE204_jygvp6fk_3[] = {"celsius", "fahrenheit"};
constexpr Expose kAutoExposes__TZE204_jygvp6fk[] = {
    {"temperature", ExposeType::Numeric, Access::State, "°C", nullptr, nullptr, 0},
    {"humidity", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0},
    {"battery_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE204_jygvp6fk_2, 3, ExposeCategory::Diagnostic},
    {"temperature_unit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_jygvp6fk_3, 2},
};
// --- end auto-generated exposes ---
}  // namespace

constexpr WhiteLabel kWhiteLabels_Gen_TZE204_jygvp6fk[] = {
    {"Tuya","ZTH01"},
    {"Tuya","SZTH02"},
    {"Tuya","ZTH02"},
    {"Tuya","ZTH05"},
...
extern const PreparedDefinition kDefGen__TZE204_jygvp6fk{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_jygvp6fk,.exposes_count=sizeof(kAutoExposes__TZE204_jygvp6fk)/sizeof(kAutoExposes__TZE204_jygvp6fk[0]),
    .white_labels=kWhiteLabels_Gen_TZE204_jygvp6fk, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE204_jygvp6fk)/sizeof(kWhiteLabels_Gen_TZE204_jygvp6fk[0]),
