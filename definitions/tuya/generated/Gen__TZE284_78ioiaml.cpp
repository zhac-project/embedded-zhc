...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE284_78ioiaml).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE284_78ioiaml[] = {
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE284_78ioiaml{ kEntries__TZE284_78ioiaml, 17 };
constexpr FzConverter kFzDp__TZE284_78ioiaml{
    ...
    .user_config       = &kMap__TZE284_78ioiaml,
};
const FzConverter* const kFz__TZE284_78ioiaml[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE284_78ioiaml,
};
constexpr TzConverter kTzDp__TZE284_78ioiaml{
...
const TzConverter* const kTz__TZE284_78ioiaml[] = { &kTzDp__TZE284_78ioiaml };
constexpr const char* kM__TZE284_78ioiaml[] = { "TS0601" };
constexpr const char* kN__TZE284_78ioiaml[] = { "_TZE284_78ioiaml" };
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0) ---
constexpr Expose kAutoExposes__TZE284_78ioiaml[] = {
...
extern const PreparedDefinition kDefGen__TZE284_78ioiaml{
    .zigbee_models=kM__TZE284_78ioiaml,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE284_78ioiaml,.manufacturer_names_count=1,
    .model="TS0601__TZE284_78ioiaml",.vendor="Tuya",
    .meta=nullptr,.exposes=kAutoExposes__TZE284_78ioiaml,.exposes_count=sizeof(kAutoExposes__TZE284_78ioiaml)/sizeof(kAutoExposes__TZE284_78ioiaml[0]),
    .white_labels=nullptr,.white_labels_count=0,
    .from_zigbee=kFz__TZE284_78ioiaml,
    .from_zigbee_count=sizeof(kFz__TZE284_78ioiaml)/sizeof(kFz__TZE284_78ioiaml[0]),
    .to_zigbee=kTz__TZE284_78ioiaml,
    .to_zigbee_count=sizeof(kTz__TZE284_78ioiaml)/sizeof(kTz__TZE284_78ioiaml[0]),
