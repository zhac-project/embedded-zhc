...
constexpr const char* kAutoOpts__TZE200_lllliz3p_6[] = {"auto", "manual", "holiday"};
constexpr const char* kAutoOpts__TZE200_lllliz3p_10[] = {"off", "heat"};
constexpr const char* kAutoOpts__TZE200_lllliz3p_16[] = {"mon_sun", "mon_fri+sat+sun", "separate"};
constexpr Expose kAutoExposes__TZE200_lllliz3p[] = {
    ...
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_lllliz3p_6, 3},
    ...
    {"system_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_lllliz3p_10, 2},
    ...
    {"working_day", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_lllliz3p_16, 3},
...
constexpr WhiteLabel kWhiteLabels_Gen_TZE200_lllliz3p[] = {
...
extern const PreparedDefinition kDefGen__TZE200_lllliz3p{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_lllliz3p,.exposes_count=sizeof(kAutoExposes__TZE200_lllliz3p)/sizeof(kAutoExposes__TZE200_lllliz3p[0]),
    .white_labels=kWhiteLabels_Gen_TZE200_lllliz3p, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE200_lllliz3p)/sizeof(kWhiteLabels_Gen_TZE200_lllliz3p[0]),
