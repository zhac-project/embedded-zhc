...
constexpr const char* kAutoOpts__TZE284_6ycgarab_1[] = {"alarm", "none", "detecting", "unknown"};
constexpr const char* kAutoOpts__TZE284_6ycgarab_2[] = {"mute", "low", "medium", "high"};
constexpr Expose kAutoExposes__TZE284_6ycgarab[] = {
    {"smoke", ExposeType::Binary, Access::State, nullptr, nullptr, nullptr, 0},
    {"smoke_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_6ycgarab_1, 4},
    {"alarm_volume", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_6ycgarab_2, 4},
...
extern const PreparedDefinition kDefGen__TZE284_6ycgarab{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_6ycgarab,.exposes_count=sizeof(kAutoExposes__TZE284_6ycgarab)/sizeof(kAutoExposes__TZE284_6ycgarab[0]),
