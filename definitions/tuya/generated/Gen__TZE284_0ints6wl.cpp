...
constexpr const char* kAutoOpts__TZE284_0ints6wl_0[] = {"none", "alarm"};
constexpr const char* kAutoOpts__TZE284_0ints6wl_1[] = {"low", "middle", "high"};
constexpr Expose kAutoExposes__TZE284_0ints6wl[] = {
    {"water_warning", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_0ints6wl_0, 2},
    {"battery_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_0ints6wl_1, 3, ExposeCategory::Diagnostic},
...
extern const PreparedDefinition kDefGen__TZE284_0ints6wl{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_0ints6wl,.exposes_count=sizeof(kAutoExposes__TZE284_0ints6wl)/sizeof(kAutoExposes__TZE284_0ints6wl[0]),
