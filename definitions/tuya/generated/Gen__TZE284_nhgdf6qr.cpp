...
constexpr const char* kAutoOpts__TZE284_nhgdf6qr_2[] = {"celsius", "fahrenheit"};
constexpr const char* kAutoOpts__TZE284_nhgdf6qr_4[] = {"low", "medium", "high"};
constexpr Expose kAutoExposes__TZE284_nhgdf6qr[] = {
    {"temperature", ExposeType::Numeric, Access::State, "°C", nullptr, nullptr, 0},
    {"soil_moisture", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0},
    {"temperature_unit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_nhgdf6qr_2, 2},
    {"battery", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0, ExposeCategory::Diagnostic, 0, 100, 0},
    {"battery_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_nhgdf6qr_4, 3, ExposeCategory::Diagnostic},
};
...
extern const PreparedDefinition kDefGen__TZE284_nhgdf6qr{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_nhgdf6qr,.exposes_count=sizeof(kAutoExposes__TZE284_nhgdf6qr)/sizeof(kAutoExposes__TZE284_nhgdf6qr[0]),
