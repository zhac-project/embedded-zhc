...
constexpr const char* kAutoOpts__TZE204_chbyv06x_3[] = {"checking", "success", "failure", "others"};
constexpr const char* kAutoOpts__TZE204_chbyv06x_5[] = {"melody_1", "melody_2", "melody_3", "melody_4", "melody_5"};
constexpr Expose kAutoExposes__TZE204_chbyv06x[] = {
    ...
    {"self_test_result", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE204_chbyv06x_3, 4},
    {"silence", ExposeType::Binary, Access::StateSet, nullptr, nullptr, nullptr, 0},
    {"alarm_ringtone", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_chbyv06x_5, 5},
...
extern const PreparedDefinition kDefGen__TZE204_chbyv06x{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_chbyv06x,.exposes_count=sizeof(kAutoExposes__TZE204_chbyv06x)/sizeof(kAutoExposes__TZE204_chbyv06x[0]),
