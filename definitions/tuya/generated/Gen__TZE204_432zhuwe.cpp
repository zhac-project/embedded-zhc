...
constexpr Expose kAutoExposes__TZE204_432zhuwe[] = {
    ...
    {"event", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE204_432zhuwe_6, 23},
    {"over_voltage_setting", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_432zhuwe_7, 3},
    {"over_voltage_threshold", ExposeType::Numeric, Access::StateSet, "V", nullptr, nullptr, 0, ExposeCategory::State, 240, 295, 0},
    {"under_voltage_setting", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_432zhuwe_9, 3},
    {"under_voltage_threshold", ExposeType::Numeric, Access::StateSet, "V", nullptr, nullptr, 0, ExposeCategory::State, 145, 220, 0},
    {"temperature_setting", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_432zhuwe_11, 3},
    {"temperature_threshold", ExposeType::Numeric, Access::StateSet, "°C", nullptr, nullptr, 0, ExposeCategory::State, -25, 100, 0},
    {"over_power_setting", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_432zhuwe_13, 3},
...
extern const PreparedDefinition kDefGen__TZE204_432zhuwe{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_432zhuwe,.exposes_count=sizeof(kAutoExposes__TZE204_432zhuwe)/sizeof(kAutoExposes__TZE204_432zhuwe[0]),
