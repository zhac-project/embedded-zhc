...
constexpr const char* kAutoOpts__TZE200_ykgar0ow_5[] = {"off", "previous", "on"};
constexpr const char* kAutoOpts__TZE200_ykgar0ow_6[] = {"led", "incandescent", "halogen"};
constexpr const char* kAutoOpts__TZE200_ykgar0ow_7[] = {"off", "normal", "inverted"};
constexpr Expose kAutoExposes__TZE200_ykgar0ow[] = {
    ...
    {"power_on_behavior", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ykgar0ow_5, 3, ExposeCategory::Config},
    {"light_type", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ykgar0ow_6, 3},
    {"backlight_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ykgar0ow_7, 3, ExposeCategory::Config},
};
...
extern const PreparedDefinition kDefGen__TZE200_ykgar0ow{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_ykgar0ow,.exposes_count=sizeof(kAutoExposes__TZE200_ykgar0ow)/sizeof(kAutoExposes__TZE200_ykgar0ow[0]),
