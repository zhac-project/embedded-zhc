...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE284_cgr0rhza).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE284_cgr0rhza_preset_dp2[] = {
    { 0, "manual" },
    { 1, "schedule" },
    { 2, "eco" },
    { 3, "comfort" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE284_cgr0rhza_system_mode_dp49[] = {
    { 0, "off" },
    { 1, "heat" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE284_cgr0rhza[] = {
    { 2, "preset", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE284_cgr0rhza_preset_dp2, sizeof(kEnum__TZE284_cgr0rhza_preset_dp2)/sizeof(kEnum__TZE284_cgr0rhza_preset_dp2[0]) },
    ...
    { 14, "open_window", ::zhc::TuyaDpType::Bool, 1, nullptr, 0, 0 },
    ...
    { 49, "system_mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE284_cgr0rhza_system_mode_dp49, sizeof(kEnum__TZE284_cgr0rhza_system_mode_dp49)/sizeof(kEnum__TZE284_cgr0rhza_system_mode_dp49[0]) },
};
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE284_cgr0rhza{ kEntries__TZE284_cgr0rhza, 21 };
constexpr FzConverter kFzDp__TZE284_cgr0rhza{
    ...
    .user_config       = &kMap__TZE284_cgr0rhza,
};
const FzConverter* const kFz__TZE284_cgr0rhza[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE284_cgr0rhza,
};
constexpr TzConverter kTzDp__TZE284_cgr0rhza{
...
const TzConverter* const kTz__TZE284_cgr0rhza[] = { &kTzDp__TZE284_cgr0rhza };
constexpr const char* kM__TZE284_cgr0rhza[] = { "TS0601" };
constexpr const char* kN__TZE284_cgr0rhza[] = { "_TZE284_cgr0rhza" };
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0) ---
constexpr const char* kAutoOpts__TZE284_cgr0rhza_7[] = {"manual", "schedule", "eco", "comfort", "antifrost", "off"};
constexpr const char* kAutoOpts__TZE284_cgr0rhza_8[] = {"off", "heat"};
constexpr Expose kAutoExposes__TZE284_cgr0rhza[] = {
    ...
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_cgr0rhza_7, 6},
    {"system_mode", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_cgr0rhza_8, 2},
...
extern const PreparedDefinition kDefGen__TZE284_cgr0rhza{
    .zigbee_models=kM__TZE284_cgr0rhza,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE284_cgr0rhza,.manufacturer_names_count=1,
    .model="TS0601__TZE284_cgr0rhza",.vendor="Tuya",
    .meta=nullptr,.exposes=kAutoExposes__TZE284_cgr0rhza,.exposes_count=sizeof(kAutoExposes__TZE284_cgr0rhza)/sizeof(kAutoExposes__TZE284_cgr0rhza[0]),
    .white_labels=nullptr,.white_labels_count=0,
    .from_zigbee=kFz__TZE284_cgr0rhza,
    .from_zigbee_count=sizeof(kFz__TZE284_cgr0rhza)/sizeof(kFz__TZE284_cgr0rhza[0]),
    .to_zigbee=kTz__TZE284_cgr0rhza,
    .to_zigbee_count=sizeof(kTz__TZE284_cgr0rhza)/sizeof(kTz__TZE284_cgr0rhza[0]),
