...
constexpr const char* kAutoOpts__TZE284_noixx2uz_2[] = {"auto", "manual", "leave"};
constexpr const char* kAutoOpts__TZE284_noixx2uz_5[] = {"heat"};
constexpr const char* kAutoOpts__TZE284_noixx2uz_6[] = {"idle", "heat"};
constexpr Expose kAutoExposes__TZE284_noixx2uz[] = {
    {"battery", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0, ExposeCategory::Diagnostic, 0, 100, 0},
    {"child_lock", ExposeType::Binary, Access::StateSet, nullptr, nullptr, nullptr, 0},
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_noixx2uz_2, 3},
    {"current_heating_setpoint", ExposeType::Numeric, Access::StateSet, "°C", nullptr, nullptr, 0, ExposeCategory::State, 5, 40, 0},
    {"local_temperature", ExposeType::Numeric, Access::State, "°C", nullptr, nullptr, 0},
    {"system_mode", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_noixx2uz_5, 1},
    {"running_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_noixx2uz_6, 2},
...
extern const PreparedDefinition kDefGen__TZE284_noixx2uz{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_noixx2uz,.exposes_count=sizeof(kAutoExposes__TZE284_noixx2uz)/sizeof(kAutoExposes__TZE284_noixx2uz[0]),
