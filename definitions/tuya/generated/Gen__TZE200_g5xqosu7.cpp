...
constexpr const char* kAutoOpts__TZE200_g5xqosu7_0[] = {"OPEN", "CLOSE", "STOP"};
constexpr const char* kAutoOpts__TZE200_g5xqosu7_2[] = {"forward", "back"};
constexpr const char* kAutoOpts__TZE200_g5xqosu7_4[] = {"SET", "RESET"};
constexpr const char* kAutoOpts__TZE200_g5xqosu7_5[] = {"SET", "RESET"};
constexpr const char* kAutoOpts__TZE200_g5xqosu7_6[] = {"SET", "RESET"};
constexpr const char* kAutoOpts__TZE200_g5xqosu7_7[] = {"continuous", "intermittently"};
constexpr Expose kAutoExposes__TZE200_g5xqosu7[] = {
    {"state", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_g5xqosu7_0, 3},
    {"position", ExposeType::Numeric, Access::StateSet, "%", nullptr, nullptr, 0, ExposeCategory::State, 0, 100, 0},
    {"reverse_direction", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_g5xqosu7_2, 2},
    {"motor_fault", ExposeType::Binary, Access::State, nullptr, nullptr, nullptr, 0},
    {"upper_stroke_limit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_g5xqosu7_4, 2, ExposeCategory::Config},
    {"middle_stroke_limit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_g5xqosu7_5, 2, ExposeCategory::Config},
    {"lower_stroke_limit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_g5xqosu7_6, 2, ExposeCategory::Config},
    {"motor_working_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_g5xqosu7_7, 2, ExposeCategory::Config},
};
...
extern const PreparedDefinition kDefGen__TZE200_g5xqosu7{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_g5xqosu7,.exposes_count=sizeof(kAutoExposes__TZE200_g5xqosu7)/sizeof(kAutoExposes__TZE200_g5xqosu7[0]),
