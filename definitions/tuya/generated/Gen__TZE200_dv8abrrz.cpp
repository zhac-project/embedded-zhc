...
constexpr const char* kAutoOpts__TZE200_dv8abrrz_11[] = {"auto", "manual", "off", "on"};
constexpr const char* kAutoOpts__TZE200_dv8abrrz_12[] = {"auto", "heat", "off"};
constexpr const char* kAutoOpts__TZE200_dv8abrrz_13[] = {"idle", "heat"};
constexpr const char* kAutoOpts__TZE200_dv8abrrz_14[] = {"up", "down"};
constexpr const char* kAutoOpts__TZE200_dv8abrrz_15[] = {"high", "middle", "low"};
constexpr const char* kAutoOpts__TZE200_dv8abrrz_16[] = {"comfort", "eco"};
constexpr Expose kAutoExposes__TZE200_dv8abrrz[] = {
    ...
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_dv8abrrz_11, 4},
    {"system_mode", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE200_dv8abrrz_12, 3},
    {"running_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE200_dv8abrrz_13, 2},
    {"screen_orientation", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_dv8abrrz_14, 2},
    {"display_brightness", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_dv8abrrz_15, 3},
    {"mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_dv8abrrz_16, 2},
...
extern const PreparedDefinition kDefGen__TZE200_dv8abrrz{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_dv8abrrz,.exposes_count=sizeof(kAutoExposes__TZE200_dv8abrrz)/sizeof(kAutoExposes__TZE200_dv8abrrz[0]),
