...
// z2m-source: tuya.ts zigbeeModel "ZG-204Z" — uses m.iasZoneAlarm
// (alarm_1 → occupancy, battery_low) + battery + battery_voltage on
// genPowerCfg. Generator previously emitted Tuya MCU converters and
// bindings on 0xEF00/0x0006 (wrong); real device speaks pure IAS Zone
// Status Change Notification on EP1 cluster 0x0500 cmd 0x00.
