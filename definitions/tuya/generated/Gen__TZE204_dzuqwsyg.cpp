...
constexpr const char* kAutoOpts__TZE204_dzuqwsyg_1[] = {"off", "cool", "heat", "fan_only"};
constexpr const char* kAutoOpts__TZE204_dzuqwsyg_2[] = {"low", "medium", "high", "auto"};
constexpr const char* kAutoOpts__TZE204_dzuqwsyg_4[] = {"auto", "manual"};
constexpr Expose kAutoExposes__TZE204_dzuqwsyg[] = {
    {"local_temperature", ExposeType::Numeric, Access::State, "°C", nullptr, nullptr, 0},
    {"system_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_dzuqwsyg_1, 4},
    {"fan_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_dzuqwsyg_2, 4},
    {"current_heating_setpoint", ExposeType::Numeric, Access::StateSet, "°C", nullptr, nullptr, 0, ExposeCategory::State, 5, 35, 1},
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_dzuqwsyg_4, 2},
...
extern const PreparedDefinition kDefGen__TZE204_dzuqwsyg{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_dzuqwsyg,.exposes_count=sizeof(kAutoExposes__TZE204_dzuqwsyg)/sizeof(kAutoExposes__TZE204_dzuqwsyg[0]),
