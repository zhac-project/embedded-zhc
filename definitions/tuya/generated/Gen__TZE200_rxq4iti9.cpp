...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE200_rxq4iti9).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_rxq4iti9_system_mode_dp2[] = {
    { 0, "auto" },
    { 1, "heat" },
    { 2, "off" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_rxq4iti9_running_state_dp3[] = {
    { 0, "heat" },
    { 1, "idle" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE200_rxq4iti9[] = {
    { 2, "system_mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_rxq4iti9_system_mode_dp2, sizeof(kEnum__TZE200_rxq4iti9_system_mode_dp2)/sizeof(kEnum__TZE200_rxq4iti9_system_mode_dp2[0]) },
    { 3, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_rxq4iti9_running_state_dp3, sizeof(kEnum__TZE200_rxq4iti9_running_state_dp3)/sizeof(kEnum__TZE200_rxq4iti9_running_state_dp3[0]) },
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE200_rxq4iti9{ kEntries__TZE200_rxq4iti9, 16 };
constexpr FzConverter kFzDp__TZE200_rxq4iti9{
    ...
    .user_config       = &kMap__TZE200_rxq4iti9,
};
const FzConverter* const kFz__TZE200_rxq4iti9[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE200_rxq4iti9,
};
constexpr TzConverter kTzDp__TZE200_rxq4iti9{
...
const TzConverter* const kTz__TZE200_rxq4iti9[] = { &kTzDp__TZE200_rxq4iti9 };
constexpr const char* kM__TZE200_rxq4iti9[] = { "TS0601" };
constexpr const char* kN__TZE200_rxq4iti9[] = { "_TZE200_rxq4iti9" };
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0) ---
constexpr const char* kAutoOpts__TZE200_rxq4iti9_4[] = {"auto", "heat", "off"};
constexpr const char* kAutoOpts__TZE200_rxq4iti9_5[] = {"idle", "heat"};
constexpr Expose kAutoExposes__TZE200_rxq4iti9[] = {
    ...
    {"system_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_rxq4iti9_4, 3},
    {"running_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE200_rxq4iti9_5, 2},
...
constexpr WhiteLabel kWhiteLabels_Gen_TZE200_rxq4iti9[] = {
    {"AVATTO","ME167"},
    {"AVATTO","ME168_1"},
    {"AVATTO","TRV06_1"},
    {"EARU","TRV06"},
...
extern const PreparedDefinition kDefGen__TZE200_rxq4iti9{
    .zigbee_models=kM__TZE200_rxq4iti9,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE200_rxq4iti9,.manufacturer_names_count=1,
    .model="TS0601__TZE200_rxq4iti9",.vendor="Tuya",
    .meta=nullptr,.exposes=kAutoExposes__TZE200_rxq4iti9,.exposes_count=sizeof(kAutoExposes__TZE200_rxq4iti9)/sizeof(kAutoExposes__TZE200_rxq4iti9[0]),
    .white_labels=kWhiteLabels_Gen_TZE200_rxq4iti9, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE200_rxq4iti9)/sizeof(kWhiteLabels_Gen_TZE200_rxq4iti9[0]),
    .from_zigbee=kFz__TZE200_rxq4iti9,
    .from_zigbee_count=sizeof(kFz__TZE200_rxq4iti9)/sizeof(kFz__TZE200_rxq4iti9[0]),
    .to_zigbee=kTz__TZE200_rxq4iti9,
    .to_zigbee_count=sizeof(kTz__TZE200_rxq4iti9)/sizeof(kTz__TZE200_rxq4iti9[0]),
