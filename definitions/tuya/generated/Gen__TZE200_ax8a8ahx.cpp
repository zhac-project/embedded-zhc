...
constexpr const char* kAutoOpts__TZE200_ax8a8ahx_1[] = {"OPEN", "CLOSE", "STOP"};
constexpr const char* kAutoOpts__TZE200_ax8a8ahx_3[] = {"tilt", "lift"};
constexpr const char* kAutoOpts__TZE200_ax8a8ahx_4[] = {"left", "right"};
constexpr const char* kAutoOpts__TZE200_ax8a8ahx_5[] = {"start", "stop"};
constexpr const char* kAutoOpts__TZE200_ax8a8ahx_6[] = {"SET"};
constexpr Expose kAutoExposes__TZE200_ax8a8ahx[] = {
    {"work_state", ExposeType::String, Access::State, nullptr, nullptr, nullptr, 0},
    {"state", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ax8a8ahx_1, 3},
    {"position", ExposeType::Numeric, Access::StateSet, "%", nullptr, nullptr, 0, ExposeCategory::State, 0, 100, 0},
    {"opening_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ax8a8ahx_3, 2},
    {"motor_direction", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ax8a8ahx_4, 2, ExposeCategory::Config},
    {"set_upper_limit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ax8a8ahx_5, 2},
    {"factory_reset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ax8a8ahx_6, 1},
};
...
extern const PreparedDefinition kDefGen__TZE200_ax8a8ahx{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_ax8a8ahx,.exposes_count=sizeof(kAutoExposes__TZE200_ax8a8ahx)/sizeof(kAutoExposes__TZE200_ax8a8ahx[0]),
