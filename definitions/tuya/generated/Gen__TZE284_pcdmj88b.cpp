...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE284_pcdmj88b).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE284_pcdmj88b_preset_dp2[] = {
    { 0, "schedule" },
    { 1, "holiday" },
    { 2, "manual" },
    { 3, "comfort" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE284_pcdmj88b_system_mode_dp49[] = {
    { 0, "off" },
    { 1, "heat" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE284_pcdmj88b[] = {
    { 2, "preset", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE284_pcdmj88b_preset_dp2, sizeof(kEnum__TZE284_pcdmj88b_preset_dp2)/sizeof(kEnum__TZE284_pcdmj88b_preset_dp2[0]) },
    ...
    { 49, "system_mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE284_pcdmj88b_system_mode_dp49, sizeof(kEnum__TZE284_pcdmj88b_system_mode_dp49)/sizeof(kEnum__TZE284_pcdmj88b_system_mode_dp49[0]) },
};
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE284_pcdmj88b{ kEntries__TZE284_pcdmj88b, 21 };
constexpr FzConverter kFzDp__TZE284_pcdmj88b{
    ...
    .user_config       = &kMap__TZE284_pcdmj88b,
};
const FzConverter* const kFz__TZE284_pcdmj88b[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE284_pcdmj88b,
};
constexpr TzConverter kTzDp__TZE284_pcdmj88b{
...
const TzConverter* const kTz__TZE284_pcdmj88b[] = { &kTzDp__TZE284_pcdmj88b };
constexpr const char* kM__TZE284_pcdmj88b[] = { "TS0601" };
constexpr const char* kN__TZE284_pcdmj88b[] = { "_TZE284_pcdmj88b" };
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0) ---
constexpr const char* kAutoOpts__TZE284_pcdmj88b_5[] = {"schedule", "holiday", "manual", "comfort", "eco"};
constexpr const char* kAutoOpts__TZE284_pcdmj88b_6[] = {"off", "heat"};
constexpr Expose kAutoExposes__TZE284_pcdmj88b[] = {
    ...
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_pcdmj88b_5, 5},
    {"system_mode", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_pcdmj88b_6, 2},
...
extern const PreparedDefinition kDefGen__TZE284_pcdmj88b{
    .zigbee_models=kM__TZE284_pcdmj88b,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE284_pcdmj88b,.manufacturer_names_count=1,
    .model="TS0601__TZE284_pcdmj88b",.vendor="Tuya",
    .meta=nullptr,.exposes=kAutoExposes__TZE284_pcdmj88b,.exposes_count=sizeof(kAutoExposes__TZE284_pcdmj88b)/sizeof(kAutoExposes__TZE284_pcdmj88b[0]),
    .white_labels=nullptr,.white_labels_count=0,
    .from_zigbee=kFz__TZE284_pcdmj88b,
    .from_zigbee_count=sizeof(kFz__TZE284_pcdmj88b)/sizeof(kFz__TZE284_pcdmj88b[0]),
    .to_zigbee=kTz__TZE284_pcdmj88b,
    .to_zigbee_count=sizeof(kTz__TZE284_pcdmj88b)/sizeof(kTz__TZE284_pcdmj88b[0]),
