...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE200_qq9mpfhw).
// Placeholder — fill in DP map + swap to factory::TuyaOnOff when porting.
#include "definitions/_generic/_shared.hpp"
#include "definitions/tuya/_shared.hpp"
namespace zhc::devices::tuya {
namespace {
const FzConverter* const kFzGen__TZE200_qq9mpfhw[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
};
constexpr const char* kMGen__TZE200_qq9mpfhw[]  = { "TS0601" };
constexpr const char* kNGen__TZE200_qq9mpfhw[]  = { "_TZE200_qq9mpfhw" };
}
...
namespace {
const FzConverter* const kFz_min_TS0601__TZE200_qq9mpfhw_Gen__TZE200_qq9mpfhw[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &::zhc::generic::kFzBattery, &::zhc::generic::kFzOnOff,
};
constexpr Expose kExp_min_TS0601__TZE200_qq9mpfhw_Gen__TZE200_qq9mpfhw[] = {
