...
constexpr const char* kAutoOpts__TZE284_o3x45p96_4[] = {"auto", "heat", "off"};
constexpr const char* kAutoOpts__TZE284_o3x45p96_5[] = {"idle", "heat"};
constexpr Expose kAutoExposes__TZE284_o3x45p96[] = {
    ...
    {"system_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_o3x45p96_4, 3},
    {"running_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_o3x45p96_5, 2},
...
extern const PreparedDefinition kDefGen__TZE284_o3x45p96{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_o3x45p96,.exposes_count=sizeof(kAutoExposes__TZE284_o3x45p96)/sizeof(kAutoExposes__TZE284_o3x45p96[0]),
