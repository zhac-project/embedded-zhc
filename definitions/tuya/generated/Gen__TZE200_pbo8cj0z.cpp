...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE200_pbo8cj0z).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_pbo8cj0z_running_state_dp49[] = {
    { 0, "idle" },
    { 1, "heat" },
    { 2, "closing" },
    { 3, "opening" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_pbo8cj0z_screen_orientation_dp119[] = {
    { 0, "up" },
    { 1, "down" },
    { 2, "left" },
    { 3, "right" },
...
constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE200_pbo8cj0z[] = {
    ...
    { 49, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_pbo8cj0z_running_state_dp49, sizeof(kEnum__TZE200_pbo8cj0z_running_state_dp49)/sizeof(kEnum__TZE200_pbo8cj0z_running_state_dp49[0]) },
    { 113, "switch_type", ::zhc::TuyaDpType::Bool, 1, nullptr, 0, 0 },
    { 115, "position", ::zhc::TuyaDpType::Numeric, 1, nullptr, 0, 0 },
    { 119, "screen_orientation", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_pbo8cj0z_screen_orientation_dp119, sizeof(kEnum__TZE200_pbo8cj0z_screen_orientation_dp119)/sizeof(kEnum__TZE200_pbo8cj0z_screen_orientation_dp119[0]) },
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE200_pbo8cj0z{ kEntries__TZE200_pbo8cj0z, 45 };
constexpr FzConverter kFzDp__TZE200_pbo8cj0z{
    ...
    .user_config       = &kMap__TZE200_pbo8cj0z,
};
const FzConverter* const kFz__TZE200_pbo8cj0z[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE200_pbo8cj0z,
};
constexpr TzConverter kTzDp__TZE200_pbo8cj0z{
...
extern const PreparedDefinition kDefGen__TZE200_pbo8cj0z{
    ...
    .to_zigbee=kTz__TZE200_pbo8cj0z,
    .to_zigbee_count=sizeof(kTz__TZE200_pbo8cj0z)/sizeof(kTz__TZE200_pbo8cj0z[0]),
