...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE204_atpwqgml).
// Placeholder — fill in DP map + swap to factory::TuyaOnOff when porting.
#include "definitions/_generic/_shared.hpp"
#include "definitions/tuya/_shared.hpp"
namespace zhc::devices::tuya {
namespace {
const FzConverter* const kFzGen__TZE204_atpwqgml[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
};
constexpr const char* kMGen__TZE204_atpwqgml[]  = { "TS0601" };
constexpr const char* kNGen__TZE204_atpwqgml[]  = { "_TZE204_atpwqgml" };
}
...
namespace {
const FzConverter* const kFz_min_TS0601__TZE204_atpwqgml_Gen__TZE204_atpwqgml[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &::zhc::generic::kFzBattery, &::zhc::generic::kFzOnOff,
};
constexpr Expose kExp_min_TS0601__TZE204_atpwqgml_Gen__TZE204_atpwqgml[] = {
