...
constexpr const char* kAutoOpts__TZE204_68utemio_5[] = {"off", "previous", "on"};
constexpr const char* kAutoOpts__TZE204_68utemio_6[] = {"led", "incandescent", "halogen"};
constexpr const char* kAutoOpts__TZE204_68utemio_7[] = {"off", "normal", "inverted"};
constexpr Expose kAutoExposes__TZE204_68utemio[] = {
    ...
    {"power_on_behavior", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_68utemio_5, 3, ExposeCategory::Config},
    {"light_type", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_68utemio_6, 3},
    {"backlight_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_68utemio_7, 3, ExposeCategory::Config},
};
...
extern const PreparedDefinition kDefGen__TZE204_68utemio{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_68utemio,.exposes_count=sizeof(kAutoExposes__TZE204_68utemio)/sizeof(kAutoExposes__TZE204_68utemio[0]),
