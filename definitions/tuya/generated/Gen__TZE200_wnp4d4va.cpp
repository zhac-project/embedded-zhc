...
constexpr const char* kAutoOpts__TZE200_wnp4d4va_6[] = {"off", "on", "previous"};
constexpr const char* kAutoOpts__TZE200_wnp4d4va_7[] = {"none", "relay", "pos"};
constexpr Expose kAutoExposes__TZE200_wnp4d4va[] = {
    ...
    {"power_on_behavior", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_wnp4d4va_6, 3, ExposeCategory::Config},
    {"indicator_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_wnp4d4va_7, 3, ExposeCategory::Config},
};
...
extern const PreparedDefinition kDefGen__TZE200_wnp4d4va{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_wnp4d4va,.exposes_count=sizeof(kAutoExposes__TZE200_wnp4d4va)/sizeof(kAutoExposes__TZE200_wnp4d4va[0]),
