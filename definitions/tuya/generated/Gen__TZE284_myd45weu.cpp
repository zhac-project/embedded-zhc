...
constexpr const char* kAutoOpts__TZE284_myd45weu_2[] = {"celsius", "fahrenheit"};
constexpr const char* kAutoOpts__TZE284_myd45weu_4[] = {"low", "medium", "high"};
constexpr Expose kAutoExposes__TZE284_myd45weu[] = {
    {"temperature", ExposeType::Numeric, Access::State, "°C", nullptr, nullptr, 0},
    {"soil_moisture", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0},
    {"temperature_unit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_myd45weu_2, 2},
    {"battery", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0, ExposeCategory::Diagnostic, 0, 100, 0},
    {"battery_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_myd45weu_4, 3, ExposeCategory::Diagnostic},
};
...
extern const PreparedDefinition kDefGen__TZE284_myd45weu{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_myd45weu,.exposes_count=sizeof(kAutoExposes__TZE284_myd45weu)/sizeof(kAutoExposes__TZE284_myd45weu[0]),
