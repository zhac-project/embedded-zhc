...
constexpr const char* kAutoOpts__TZE284_awepdiwi_1[] = {"normal", "lower", "low", "middle", "high", "higher"};
constexpr const char* kAutoOpts__TZE284_awepdiwi_7[] = {"lower_alarm", "upper_alarm", "cancel"};
constexpr const char* kAutoOpts__TZE284_awepdiwi_8[] = {"lower_alarm", "upper_alarm", "cancel"};
constexpr const char* kAutoOpts__TZE284_awepdiwi_14[] = {"low", "medium", "high"};
constexpr Expose kAutoExposes__TZE284_awepdiwi[] = {
    {"ec", ExposeType::Numeric, Access::State, "µS/cm", nullptr, nullptr, 0, ExposeCategory::State, 0, 20000, 0},
    {"fertility", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_awepdiwi_1, 6},
    {"humidity", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0, ExposeCategory::State, 0, 100, 0},
    ...
    {"temperature_alarm", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_awepdiwi_7, 3},
    {"humidity_alarm", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_awepdiwi_8, 3},
    ...
    {"battery_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_awepdiwi_14, 3, ExposeCategory::Diagnostic},
...
extern const PreparedDefinition kDefGen__TZE284_awepdiwi{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_awepdiwi,.exposes_count=sizeof(kAutoExposes__TZE284_awepdiwi)/sizeof(kAutoExposes__TZE284_awepdiwi[0]),
