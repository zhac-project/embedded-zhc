...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE284_gomuk3dc).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE284_gomuk3dc[] = {
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE284_gomuk3dc{ kEntries__TZE284_gomuk3dc, 23 };
constexpr FzConverter kFzDp__TZE284_gomuk3dc{
    ...
    .user_config       = &kMap__TZE284_gomuk3dc,
};
const FzConverter* const kFz__TZE284_gomuk3dc[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE284_gomuk3dc,
};
constexpr TzConverter kTzDp__TZE284_gomuk3dc{
...
const TzConverter* const kTz__TZE284_gomuk3dc[] = { &kTzDp__TZE284_gomuk3dc };
constexpr const char* kM__TZE284_gomuk3dc[] = { "TS0601" };
constexpr const char* kN__TZE284_gomuk3dc[] = { "_TZE284_gomuk3dc" };
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0) ---
constexpr Expose kAutoExposes__TZE284_gomuk3dc[] = {
...
extern const PreparedDefinition kDefGen__TZE284_gomuk3dc{
    .zigbee_models=kM__TZE284_gomuk3dc,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE284_gomuk3dc,.manufacturer_names_count=1,
    .model="TS0601__TZE284_gomuk3dc",.vendor="Tuya",
    .meta=nullptr,.exposes=kAutoExposes__TZE284_gomuk3dc,.exposes_count=sizeof(kAutoExposes__TZE284_gomuk3dc)/sizeof(kAutoExposes__TZE284_gomuk3dc[0]),
    .white_labels=nullptr,.white_labels_count=0,
    .from_zigbee=kFz__TZE284_gomuk3dc,
    .from_zigbee_count=sizeof(kFz__TZE284_gomuk3dc)/sizeof(kFz__TZE284_gomuk3dc[0]),
    .to_zigbee=kTz__TZE284_gomuk3dc,
    .to_zigbee_count=sizeof(kTz__TZE284_gomuk3dc)/sizeof(kTz__TZE284_gomuk3dc[0]),
