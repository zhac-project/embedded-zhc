...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE284_hgeqeyuv).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE284_hgeqeyuv[] = {
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE284_hgeqeyuv{ kEntries__TZE284_hgeqeyuv, 13 };
constexpr FzConverter kFzDp__TZE284_hgeqeyuv{
    ...
    .user_config       = &kMap__TZE284_hgeqeyuv,
};
const FzConverter* const kFz__TZE284_hgeqeyuv[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE284_hgeqeyuv,
};
constexpr TzConverter kTzDp__TZE284_hgeqeyuv{
...
extern const PreparedDefinition kDefGen__TZE284_hgeqeyuv{
    .zigbee_models=kM__TZE284_hgeqeyuv,.zigbee_models_count=1,
    ...
    .to_zigbee=kTz__TZE284_hgeqeyuv,
    .to_zigbee_count=sizeof(kTz__TZE284_hgeqeyuv)/sizeof(kTz__TZE284_hgeqeyuv[0]),
