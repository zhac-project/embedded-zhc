...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE284_loejka0i).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE284_loejka0i[] = {
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE284_loejka0i{ kEntries__TZE284_loejka0i, 23 };
constexpr FzConverter kFzDp__TZE284_loejka0i{
    ...
    .user_config       = &kMap__TZE284_loejka0i,
};
const FzConverter* const kFz__TZE284_loejka0i[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE284_loejka0i,
};
constexpr TzConverter kTzDp__TZE284_loejka0i{
...
const TzConverter* const kTz__TZE284_loejka0i[] = { &kTzDp__TZE284_loejka0i };
constexpr const char* kM__TZE284_loejka0i[] = { "TS0601" };
constexpr const char* kN__TZE284_loejka0i[] = { "_TZE284_loejka0i" };
}  // namespace

constexpr WhiteLabel kWhiteLabels_Gen_TZE284_loejka0i[] = {
    {"Nous","D4Z"},
};
extern const PreparedDefinition kDefGen__TZE284_loejka0i{
    .zigbee_models=kM__TZE284_loejka0i,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE284_loejka0i,.manufacturer_names_count=1,
    .model="TS0601__TZE284_loejka0i",.vendor="Tuya",
    .meta=nullptr,.exposes=nullptr,.exposes_count=0,
    .white_labels=kWhiteLabels_Gen_TZE284_loejka0i, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE284_loejka0i)/sizeof(kWhiteLabels_Gen_TZE284_loejka0i[0]),
    .from_zigbee=kFz__TZE284_loejka0i,
    .from_zigbee_count=sizeof(kFz__TZE284_loejka0i)/sizeof(kFz__TZE284_loejka0i[0]),
    .to_zigbee=kTz__TZE284_loejka0i,
    .to_zigbee_count=sizeof(kTz__TZE284_loejka0i)/sizeof(kTz__TZE284_loejka0i[0]),
