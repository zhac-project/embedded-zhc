...
constexpr const char* kAutoOpts__TZE200_kds0pmmv_6[] = {"auto", "manual", "holiday"};
constexpr const char* kAutoOpts__TZE200_kds0pmmv_10[] = {"off", "heat"};
constexpr const char* kAutoOpts__TZE200_kds0pmmv_16[] = {"mon_sun", "mon_fri+sat+sun", "separate"};
constexpr Expose kAutoExposes__TZE200_kds0pmmv[] = {
    ...
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_kds0pmmv_6, 3},
    ...
    {"system_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_kds0pmmv_10, 2},
    ...
    {"working_day", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_kds0pmmv_16, 3},
...
extern const PreparedDefinition kDefGen__TZE200_kds0pmmv{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_kds0pmmv,.exposes_count=sizeof(kAutoExposes__TZE200_kds0pmmv)/sizeof(kAutoExposes__TZE200_kds0pmmv[0]),
