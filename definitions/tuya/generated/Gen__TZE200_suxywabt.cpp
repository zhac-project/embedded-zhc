...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE200_suxywabt).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_suxywabt_system_mode_dp2[] = {
    { 0, "auto" },
    { 1, "heat" },
    { 2, "off" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_suxywabt_running_state_dp3[] = {
    { 0, "heat" },
    { 1, "idle" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE200_suxywabt[] = {
    { 2, "system_mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_suxywabt_system_mode_dp2, sizeof(kEnum__TZE200_suxywabt_system_mode_dp2)/sizeof(kEnum__TZE200_suxywabt_system_mode_dp2[0]) },
    { 3, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_suxywabt_running_state_dp3, sizeof(kEnum__TZE200_suxywabt_running_state_dp3)/sizeof(kEnum__TZE200_suxywabt_running_state_dp3[0]) },
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE200_suxywabt{ kEntries__TZE200_suxywabt, 16 };
constexpr FzConverter kFzDp__TZE200_suxywabt{
    ...
    .user_config       = &kMap__TZE200_suxywabt,
};
const FzConverter* const kFz__TZE200_suxywabt[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE200_suxywabt,
};
constexpr TzConverter kTzDp__TZE200_suxywabt{
...
const TzConverter* const kTz__TZE200_suxywabt[] = { &kTzDp__TZE200_suxywabt };
constexpr const char* kM__TZE200_suxywabt[] = { "TS0601" };
constexpr const char* kN__TZE200_suxywabt[] = { "_TZE200_suxywabt" };
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0) ---
constexpr const char* kAutoOpts__TZE200_suxywabt_4[] = {"auto", "heat", "off"};
constexpr const char* kAutoOpts__TZE200_suxywabt_5[] = {"idle", "heat"};
constexpr Expose kAutoExposes__TZE200_suxywabt[] = {
    ...
    {"system_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_suxywabt_4, 3},
    {"running_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE200_suxywabt_5, 2},
...
constexpr WhiteLabel kWhiteLabels_Gen_TZE200_suxywabt[] = {
    {"AVATTO","ME167"},
    {"AVATTO","ME168_1"},
    {"AVATTO","TRV06_1"},
    {"EARU","TRV06"},
...
extern const PreparedDefinition kDefGen__TZE200_suxywabt{
    .zigbee_models=kM__TZE200_suxywabt,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE200_suxywabt,.manufacturer_names_count=1,
    .model="TS0601__TZE200_suxywabt",.vendor="Tuya",
    .meta=nullptr,.exposes=kAutoExposes__TZE200_suxywabt,.exposes_count=sizeof(kAutoExposes__TZE200_suxywabt)/sizeof(kAutoExposes__TZE200_suxywabt[0]),
    .white_labels=kWhiteLabels_Gen_TZE200_suxywabt, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE200_suxywabt)/sizeof(kWhiteLabels_Gen_TZE200_suxywabt[0]),
    .from_zigbee=kFz__TZE200_suxywabt,
    .from_zigbee_count=sizeof(kFz__TZE200_suxywabt)/sizeof(kFz__TZE200_suxywabt[0]),
    .to_zigbee=kTz__TZE200_suxywabt,
    .to_zigbee_count=sizeof(kTz__TZE200_suxywabt)/sizeof(kTz__TZE200_suxywabt[0]),
