...
constexpr const char* kAutoOpts__TZE284_9yapgbuv_2[] = {"low", "medium", "high"};
constexpr const char* kAutoOpts__TZE284_9yapgbuv_3[] = {"celsius", "fahrenheit"};
constexpr Expose kAutoExposes__TZE284_9yapgbuv[] = {
    {"temperature", ExposeType::Numeric, Access::State, "°C", nullptr, nullptr, 0},
    {"humidity", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0},
    {"battery_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_9yapgbuv_2, 3, ExposeCategory::Diagnostic},
    {"temperature_unit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_9yapgbuv_3, 2},
};
// --- end auto-generated exposes ---
}  // namespace

constexpr WhiteLabel kWhiteLabels_Gen_TZE284_9yapgbuv[] = {
    {"Tuya","ZTH01"},
    {"Tuya","SZTH02"},
    {"Tuya","ZTH02"},
    {"Tuya","ZTH05"},
...
extern const PreparedDefinition kDefGen__TZE284_9yapgbuv{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_9yapgbuv,.exposes_count=sizeof(kAutoExposes__TZE284_9yapgbuv)/sizeof(kAutoExposes__TZE284_9yapgbuv[0]),
    .white_labels=kWhiteLabels_Gen_TZE284_9yapgbuv, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE284_9yapgbuv)/sizeof(kWhiteLabels_Gen_TZE284_9yapgbuv[0]),
