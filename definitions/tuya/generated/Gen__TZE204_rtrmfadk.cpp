...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE204_rtrmfadk).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_rtrmfadk_display_brightness_dp111[] = {
    { 0, "high" },
    { 1, "middle" },
    { 2, "low" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_rtrmfadk_screen_orientation_dp113[] = {
    { 0, "up" },
    { 2, "down" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_rtrmfadk_mode_dp114[] = {
    { 0, "comfort" },
    { 1, "eco" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE204_rtrmfadk[] = {
    ...
    { 111, "display_brightness", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_rtrmfadk_display_brightness_dp111, sizeof(kEnum__TZE204_rtrmfadk_display_brightness_dp111)/sizeof(kEnum__TZE204_rtrmfadk_display_brightness_dp111[0]) },
    { 113, "screen_orientation", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_rtrmfadk_screen_orientation_dp113, sizeof(kEnum__TZE204_rtrmfadk_screen_orientation_dp113)/sizeof(kEnum__TZE204_rtrmfadk_screen_orientation_dp113[0]) },
    { 114, "mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_rtrmfadk_mode_dp114, sizeof(kEnum__TZE204_rtrmfadk_mode_dp114)/sizeof(kEnum__TZE204_rtrmfadk_mode_dp114[0]) },
    { 115, "switch_deviation_eco", ::zhc::TuyaDpType::Numeric, 10, nullptr, 0, 0 },
};
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE204_rtrmfadk{ kEntries__TZE204_rtrmfadk, 23 };
constexpr FzConverter kFzDp__TZE204_rtrmfadk{
    ...
    .user_config       = &kMap__TZE204_rtrmfadk,
};
const FzConverter* const kFz__TZE204_rtrmfadk[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE204_rtrmfadk,
};
constexpr TzConverter kTzDp__TZE204_rtrmfadk{
...
extern const PreparedDefinition kDefGen__TZE204_rtrmfadk{
    ...
    .to_zigbee_count=sizeof(kTz__TZE204_rtrmfadk)/sizeof(kTz__TZE204_rtrmfadk[0]),
