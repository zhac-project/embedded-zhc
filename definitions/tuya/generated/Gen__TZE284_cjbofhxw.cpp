...
constexpr Expose kAutoExposes__TZE284_cjbofhxw[] = {
...
constexpr WhiteLabel kWhiteLabels_Gen_TZE284_cjbofhxw[] = {
    {"Tuya","PJ-1203-W"},
};
extern const PreparedDefinition kDefGen__TZE284_cjbofhxw{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_cjbofhxw,.exposes_count=sizeof(kAutoExposes__TZE284_cjbofhxw)/sizeof(kAutoExposes__TZE284_cjbofhxw[0]),
    .white_labels=kWhiteLabels_Gen_TZE284_cjbofhxw, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE284_cjbofhxw)/sizeof(kWhiteLabels_Gen_TZE284_cjbofhxw[0]),
