...
constexpr const char* kAutoOpts__TZE204_r0jdjrvi_0[] = {"OPEN", "CLOSE", "STOP"};
constexpr const char* kAutoOpts__TZE204_r0jdjrvi_2[] = {"forward", "back"};
constexpr const char* kAutoOpts__TZE204_r0jdjrvi_4[] = {"SET", "RESET"};
constexpr const char* kAutoOpts__TZE204_r0jdjrvi_5[] = {"SET", "RESET"};
constexpr const char* kAutoOpts__TZE204_r0jdjrvi_6[] = {"SET", "RESET"};
constexpr const char* kAutoOpts__TZE204_r0jdjrvi_7[] = {"continuous", "intermittently"};
constexpr Expose kAutoExposes__TZE204_r0jdjrvi[] = {
    {"state", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_r0jdjrvi_0, 3},
    {"position", ExposeType::Numeric, Access::StateSet, "%", nullptr, nullptr, 0, ExposeCategory::State, 0, 100, 0},
    {"reverse_direction", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_r0jdjrvi_2, 2},
    {"motor_fault", ExposeType::Binary, Access::State, nullptr, nullptr, nullptr, 0},
    {"upper_stroke_limit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_r0jdjrvi_4, 2, ExposeCategory::Config},
    {"middle_stroke_limit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_r0jdjrvi_5, 2, ExposeCategory::Config},
    {"lower_stroke_limit", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_r0jdjrvi_6, 2, ExposeCategory::Config},
    {"motor_working_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_r0jdjrvi_7, 2, ExposeCategory::Config},
};
...
extern const PreparedDefinition kDefGen__TZE204_r0jdjrvi{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_r0jdjrvi,.exposes_count=sizeof(kAutoExposes__TZE204_r0jdjrvi)/sizeof(kAutoExposes__TZE204_r0jdjrvi[0]),
