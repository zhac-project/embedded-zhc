...
constexpr const char* kAutoOpts__TZE204_9qhuzgo0_5[] = {"off", "previous", "on"};
constexpr const char* kAutoOpts__TZE204_9qhuzgo0_6[] = {"led", "incandescent", "halogen"};
constexpr const char* kAutoOpts__TZE204_9qhuzgo0_7[] = {"off", "normal", "inverted"};
constexpr Expose kAutoExposes__TZE204_9qhuzgo0[] = {
    ...
    {"power_on_behavior", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_9qhuzgo0_5, 3, ExposeCategory::Config},
    {"light_type", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_9qhuzgo0_6, 3},
    {"backlight_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE204_9qhuzgo0_7, 3, ExposeCategory::Config},
};
// --- end auto-generated exposes ---
}  // namespace

constexpr WhiteLabel kWhiteLabels_Gen_TZE204_9qhuzgo0[] = {
    {"Moes","ZS-SR-EUD-1"},
    {"Moes","MS-105Z"},
...
extern const PreparedDefinition kDefGen__TZE204_9qhuzgo0{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_9qhuzgo0,.exposes_count=sizeof(kAutoExposes__TZE204_9qhuzgo0)/sizeof(kAutoExposes__TZE204_9qhuzgo0[0]),
    .white_labels=kWhiteLabels_Gen_TZE204_9qhuzgo0, .white_labels_count=sizeof(kWhiteLabels_Gen_TZE204_9qhuzgo0)/sizeof(kWhiteLabels_Gen_TZE204_9qhuzgo0[0]),
