...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0001 / _TZ3210_a04acm9s).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZ3210_a04acm9s_mode_dp101[] = {
    { 0, "click" },
    { 1, "switch" },
    { 2, "program" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZ3210_a04acm9s_reverse_dp104[] = {
    { 1, "ON" },
    { 0, "OFF" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZ3210_a04acm9s[] = {
    { 101, "mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZ3210_a04acm9s_mode_dp101, sizeof(kEnum__TZ3210_a04acm9s_mode_dp101)/sizeof(kEnum__TZ3210_a04acm9s_mode_dp101[0]) },
    { 102, "lower", ::zhc::TuyaDpType::Numeric, 1, nullptr, 0, 0 },
    { 103, "delay", ::zhc::TuyaDpType::Numeric, 1, nullptr, 0, 0 },
    { 104, "reverse", ::zhc::TuyaDpType::Enum, 1, kEnum__TZ3210_a04acm9s_reverse_dp104, sizeof(kEnum__TZ3210_a04acm9s_reverse_dp104)/sizeof(kEnum__TZ3210_a04acm9s_reverse_dp104[0]) },
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZ3210_a04acm9s{ kEntries__TZ3210_a04acm9s, 7 };
constexpr FzConverter kFzDp__TZ3210_a04acm9s{
    ...
    .user_config       = &kMap__TZ3210_a04acm9s,
};
const FzConverter* const kFz__TZ3210_a04acm9s[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZ3210_a04acm9s,
};
constexpr TzConverter kTzDp__TZ3210_a04acm9s{
...
const TzConverter* const kTz__TZ3210_a04acm9s[] = { &kTzDp__TZ3210_a04acm9s };
constexpr const char* kM__TZ3210_a04acm9s[] = { "TS0001" };
constexpr const char* kN__TZ3210_a04acm9s[] = { "_TZ3210_a04acm9s" };
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0) ---
constexpr const char* kAutoOpts__TZ3210_a04acm9s_2[] = {"click", "switch", "program"};
constexpr Expose kAutoExposes__TZ3210_a04acm9s[] = {
    {"state", ExposeType::Binary, Access::StateSet, nullptr, nullptr, nullptr, 0},
    {"battery", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0, ExposeCategory::Diagnostic, 0, 100, 0},
    {"mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZ3210_a04acm9s_2, 3},
...
extern const PreparedDefinition kDefGen__TZ3210_a04acm9s{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZ3210_a04acm9s,.exposes_count=sizeof(kAutoExposes__TZ3210_a04acm9s)/sizeof(kAutoExposes__TZ3210_a04acm9s[0]),
    ...
    .to_zigbee_count=sizeof(kTz__TZ3210_a04acm9s)/sizeof(kTz__TZ3210_a04acm9s[0]),
