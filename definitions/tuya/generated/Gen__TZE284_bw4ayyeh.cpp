...
constexpr const char* kAutoOpts__TZE284_bw4ayyeh_3[] = {"none", "static", "small", "large"};
constexpr const char* kAutoOpts__TZE284_bw4ayyeh_9[] = {"pir_and_radar", "only_radar", "pir_or_radar"};
constexpr Expose kAutoExposes__TZE284_bw4ayyeh[] = {
    ...
    {"motion_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE284_bw4ayyeh_3, 4},
    {"distance", ExposeType::Numeric, Access::State, "m", nullptr, nullptr, 0},
    {"init", ExposeType::Binary, Access::StateSet, nullptr, nullptr, nullptr, 0},
    {"fading_time", ExposeType::Numeric, Access::StateSet, "s", nullptr, nullptr, 0, ExposeCategory::State, 10, 3600, 1},
    {"motion_detection_sensitivity", ExposeType::Numeric, Access::StateSet, nullptr, nullptr, nullptr, 0, ExposeCategory::State, 1, 10, 1},
    {"static_detection_sensitivity", ExposeType::Numeric, Access::StateSet, nullptr, nullptr, nullptr, 0, ExposeCategory::State, 1, 10, 1},
    {"motion_detection_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_bw4ayyeh_9, 3},
};
...
extern const PreparedDefinition kDefGen__TZE284_bw4ayyeh{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE284_bw4ayyeh,.exposes_count=sizeof(kAutoExposes__TZE284_bw4ayyeh)/sizeof(kAutoExposes__TZE284_bw4ayyeh[0]),
