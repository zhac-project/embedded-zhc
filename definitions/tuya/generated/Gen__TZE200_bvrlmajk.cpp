...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE200_bvrlmajk).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_bvrlmajk_screen_orientation_dp116[] = {
    { 0, "up" },
    { 2, "down" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_bvrlmajk_display_brightness_dp152[] = {
    { 0, "high" },
    { 1, "middle" },
    { 2, "low" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_bvrlmajk_mode_dp153[] = {
    { 0, "comfort" },
    { 1, "eco" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE200_bvrlmajk[] = {
    ...
    { 116, "screen_orientation", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_bvrlmajk_screen_orientation_dp116, sizeof(kEnum__TZE200_bvrlmajk_screen_orientation_dp116)/sizeof(kEnum__TZE200_bvrlmajk_screen_orientation_dp116[0]) },
    { 152, "display_brightness", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_bvrlmajk_display_brightness_dp152, sizeof(kEnum__TZE200_bvrlmajk_display_brightness_dp152)/sizeof(kEnum__TZE200_bvrlmajk_display_brightness_dp152[0]) },
    { 153, "mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_bvrlmajk_mode_dp153, sizeof(kEnum__TZE200_bvrlmajk_mode_dp153)/sizeof(kEnum__TZE200_bvrlmajk_mode_dp153[0]) },
    { 154, "switch_deviation_eco", ::zhc::TuyaDpType::Numeric, 10, nullptr, 0, 0 },
};
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE200_bvrlmajk{ kEntries__TZE200_bvrlmajk, 25 };
constexpr FzConverter kFzDp__TZE200_bvrlmajk{
    ...
    .user_config       = &kMap__TZE200_bvrlmajk,
};
const FzConverter* const kFz__TZE200_bvrlmajk[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE200_bvrlmajk,
};
constexpr TzConverter kTzDp__TZE200_bvrlmajk{
...
extern const PreparedDefinition kDefGen__TZE200_bvrlmajk{
    .zigbee_models=kM__TZE200_bvrlmajk,.zigbee_models_count=1,
    ...
    .to_zigbee=kTz__TZE200_bvrlmajk,
    .to_zigbee_count=sizeof(kTz__TZE200_bvrlmajk)/sizeof(kTz__TZE200_bvrlmajk[0]),
