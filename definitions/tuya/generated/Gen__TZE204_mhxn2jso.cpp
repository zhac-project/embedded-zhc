...
constexpr Expose kAutoExposes__TZE204_mhxn2jso[] = {
    ...
    {"detection_distance", ExposeType::Numeric, Access::State, "cm", nullptr, nullptr, 0, ExposeCategory::State, 0, 1000, 1},
    {"sensitivity", ExposeType::Numeric, Access::StateSet, nullptr, nullptr, nullptr, 0, ExposeCategory::State, 0, 10, 1},
    {"keep_time", ExposeType::Numeric, Access::StateSet, "s", nullptr, nullptr, 0, ExposeCategory::State, 5, 3600, 1},
    {"minimum_range", ExposeType::Numeric, Access::StateSet, "m", nullptr, nullptr, 0, ExposeCategory::State, 0, 1000, 50},
    {"maximum_range", ExposeType::Numeric, Access::StateSet, "m", nullptr, nullptr, 0, ExposeCategory::State, 50, 1000, 50},
};
...
extern const PreparedDefinition kDefGen__TZE204_mhxn2jso{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE204_mhxn2jso,.exposes_count=sizeof(kAutoExposes__TZE204_mhxn2jso)/sizeof(kAutoExposes__TZE204_mhxn2jso[0]),
