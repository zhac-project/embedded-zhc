...
// Tier 3: _TZE200_y6cvyskj acceleration sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"accel_x",100),
    ::zhc::tuya::dp::numeric(3,"accel_y",100),
    ::zhc::tuya::dp::numeric(4,"accel_z",100),
    ::zhc::tuya::dp::binary(1,"vibration")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_y6cvyskj"};
}
...
extern const PreparedDefinition kDefTZE200_accel{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_accel",
