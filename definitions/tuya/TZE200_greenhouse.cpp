...
// Tier 3: _TZE200_p3lqqldn greenhouse sensor (multi-DP). z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(2,"humidity",10),
    ::zhc::tuya::dp::numeric(3,"illuminance",1),
    ::zhc::tuya::dp::numeric(4,"soil_moisture",1),
    ::zhc::tuya::dp::numeric(5,"co2",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,5}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_p3lqqldn"};
}
...
extern const PreparedDefinition kDefTZE200_greenhouse{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_greenhouse",
