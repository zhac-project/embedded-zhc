...
// Tier 3: _TZE200_batt_tester battery tester. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"voltage",1000),
    ::zhc::tuya::dp::numeric(3,"capacity",1),
    ::zhc::tuya::dp::numeric(4,"internal_resistance",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_batt_tester"};
}
...
extern const PreparedDefinition kDefTZE200_batt_tester{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_batt_tester",
