...
// Tier 3: _TZE200_night_light with PIR. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(3,"pir_enabled"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_night_light"};
}
...
extern const PreparedDefinition kDefTZE200_night_light{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_night_light",
