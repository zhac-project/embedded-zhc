...
// Tier 3: _TZE200_k4egjpp0 sound-level alarm. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(4,"sound_level",1),
    ::zhc::tuya::dp::binary(5,"alarm")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_k4egjpp0"};
}
...
extern const PreparedDefinition kDefTZE200_volume_alarm{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_vol_alarm",
