...
// Tier 3: _TZE200_pisltm67 body-presence + fall detector. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(2,"fall_detected"),
    ::zhc::tuya::dp::numeric(3,"heart_rate",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_pisltm67"};
}
...
extern const PreparedDefinition kDefTZE200_body{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_body",
