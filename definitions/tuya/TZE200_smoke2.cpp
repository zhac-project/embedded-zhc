...
// Tier 2: _TZE200_ffxsrh1e DP smoke sensor v2. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"smoke"),::zhc::tuya::dp::numeric(15,"battery",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_ffxsrh1e"};
}
...
extern const PreparedDefinition kDefTZE200_smoke2{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_smoke2",
