...
// Tier 3: _TZE200_scada industrial SCADA I/O module. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"di_1"),::zhc::tuya::dp::binary(2,"di_2"),
    ::zhc::tuya::dp::binary(3,"do_1"),::zhc::tuya::dp::binary(4,"do_2"),
    ::zhc::tuya::dp::numeric(5,"ai_1",100),::zhc::tuya::dp::numeric(6,"ai_2",100)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,6}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_scada"};
}
...
extern const PreparedDefinition kDefTZE200_scada{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_scada",
