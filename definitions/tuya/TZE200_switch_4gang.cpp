...
// Tier 2: _TZE200_fsb6zw01 DP 4-gang switch. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_fsb6zw01"};
}
...
extern const PreparedDefinition kDefTZE200_switch_4gang{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_switch_4g",
