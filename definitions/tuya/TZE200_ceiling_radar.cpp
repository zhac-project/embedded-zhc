...
// Tier 3: _TZE200_mrf6vtua ceiling mmWave radar. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(2,"radar_sensitivity",1),
    ::zhc::tuya::dp::numeric(101,"distance",100),
    ::zhc::tuya::dp::numeric(102,"detection_range",100)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_mrf6vtua"};
}
...
extern const PreparedDefinition kDefTZE200_ceiling_radar{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_ceiling_radar",
