...
// Tier 3: _TZE200_m1m4a2o5 energy monitor clamp. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_m1m4a2o5"};
}
...
extern const PreparedDefinition kDefTZE200_clamp{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_clamp",
