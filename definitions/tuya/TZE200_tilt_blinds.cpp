...
// Tier 3: _TZE200_mqnyfcfw tilt blinds. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(3,"tilt",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_mqnyfcfw"};
}
...
extern const PreparedDefinition kDefTZE200_tilt_blinds{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_tilt_blinds",
