...
// Tier 3: Tuya TS0601 2-gang DP switch _TZE204_he9apaui (z2m v26.76.0 parity).
// z2m-source: tuya.ts #TS0601_2gang_switch
...
constexpr const char* kN[]={"_TZE204_he9apaui"};
...
extern const PreparedDefinition kDef_TS0601_2gang_switch{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_2gang_switch",
