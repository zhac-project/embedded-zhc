...
// Tier 2: _TZE200_zrm3oxsh DP multi-gas air quality. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"co2",1),::zhc::tuya::dp::numeric(18,"tvoc",1),
    ::zhc::tuya::dp::numeric(19,"formaldehyde",1000),
    ::zhc::tuya::dp::temperature(20),::zhc::tuya::dp::numeric(21,"humidity",10),
    ::zhc::tuya::dp::numeric(22,"pm25",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,6}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_zrm3oxsh"};
}
...
extern const PreparedDefinition kDefTZE200_airquality{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_airq",
