...
// Tier 2: _TZE200_g1o5lwkd 3-gang switch.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state_l1"),::zhc::tuya::dp::binary(2,"state_l2"),::zhc::tuya::dp::binary(3,"state_l3")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_g1o5lwkd"};
}
...
extern const PreparedDefinition kDefTZE200_g1o5lwkd{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_g1o5lwkd",.vendor="Tuya",
