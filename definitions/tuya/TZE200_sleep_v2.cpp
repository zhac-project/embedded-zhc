...
// Tier 3: _TZE200_sleep_v2 advanced sleep monitor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"in_bed"),
    ::zhc::tuya::dp::numeric(2,"heart_rate",1),
    ::zhc::tuya::dp::numeric(3,"breath_rate",1),
    ::zhc::tuya::dp::numeric(4,"movement",1),
    ::zhc::tuya::dp::numeric(5,"sleep_stage",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,5}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_sleep_v2"};
}
...
extern const PreparedDefinition kDefTZE200_sleep_v2{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_sleep_v2",
