...
// Tier 3: _TZE200_u8pwxqka underfloor heating controller. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(104,"floor_temp",10)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,6}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_u8pwxqka"};
}
...
extern const PreparedDefinition kDefTZE200_underfloor{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_underfloor",
