...
// Tier 3: _TZE200_w0yp1a1c split-AC / HVAC controller. z2m-source: tuya.ts.
...
static constexpr ::zhc::tuya::TuyaEnumEntry kModes[]={
    {0,"off"},{1,"cool"},{2,"heat"},{3,"dry"},{4,"fan_only"},{5,"auto"}};
static constexpr ::zhc::tuya::TuyaEnumEntry kFans[]={
    {0,"low"},{1,"medium"},{2,"high"},{3,"auto"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),
    ::zhc::tuya::dp::enum_lookup(2,"mode",kModes,6),
    ::zhc::tuya::dp::enum_lookup(4,"fan_mode",kFans,4),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_w0yp1a1c"};
}
...
extern const PreparedDefinition kDefTZE200_hvac{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_hvac",
