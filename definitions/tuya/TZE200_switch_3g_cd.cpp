...
// Tier 2: _TZE200_rvjzkxkl 3-gang + countdowns. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_rvjzkxkl"};
}
...
extern const PreparedDefinition kDefTZE200_switch_3g_cd{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_3g_cd",
