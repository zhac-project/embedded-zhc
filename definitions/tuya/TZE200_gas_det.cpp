...
// Tier 3: _TZE200_gas_det generic gas detector. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"gas"),
    ::zhc::tuya::dp::numeric(2,"gas_value_ppm",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_gas_det"};
}
...
extern const PreparedDefinition kDefTZE200_gas_det{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_gas_det",
