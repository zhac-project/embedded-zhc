...
// Tier 2: _TZE200_3ooaz3ng window contact + tamper. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_3ooaz3ng"};
}
...
extern const PreparedDefinition kDefTZE200_window{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_window",
