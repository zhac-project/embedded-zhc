...
// Tier 3: _TZE200_humidifier smart humidifier. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(2,"target_humidity",1),
    ::zhc::tuya::dp::numeric(3,"current_humidity",10),
    ::zhc::tuya::dp::numeric(4,"water_level",1),
    ::zhc::tuya::dp::binary(5,"night_mode")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,5}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_humidifier"};
}
...
extern const PreparedDefinition kDefTZE200_humidifier{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_humidifier",
