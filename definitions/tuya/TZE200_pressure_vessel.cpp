...
// Tier 3: _TZE200_pressure_vessel high-pressure vessel. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"pressure_bar",100),
    ::zhc::tuya::dp::temperature(2),
    ::zhc::tuya::dp::binary(3,"relief_valve"),
    ::zhc::tuya::dp::binary(4,"high_alarm")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_pressure_vessel"};
}
...
extern const PreparedDefinition kDefTZE200_pressure_vessel{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_pressure_vessel",
