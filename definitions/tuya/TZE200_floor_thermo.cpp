...
// Tier 3: _TZE200_3snvkkrf floor thermostat. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_3snvkkrf"};
}
...
extern const PreparedDefinition kDefTZE200_floor_thermo{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_floor_thermo",
