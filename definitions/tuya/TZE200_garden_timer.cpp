...
// Tier 3: _TZE200_qefvfrft garden irrigation timer. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(11,"water_used",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_qefvfrft"};
}
...
extern const PreparedDefinition kDefTZE200_garden_timer{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_garden_timer",
