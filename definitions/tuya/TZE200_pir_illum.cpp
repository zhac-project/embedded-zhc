...
// Tier 2: _TZE200_ux5v4dbq PIR + illuminance combo. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"occupancy"),::zhc::tuya::dp::numeric(2,"illuminance",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_ux5v4dbq"};
}
...
extern const PreparedDefinition kDefTZE200_pir_illum{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_pir_illum",
