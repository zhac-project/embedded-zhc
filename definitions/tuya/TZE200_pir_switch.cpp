...
// Tier 2: _TZE200_ebnpxjce PIR + switch combo. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(2,"occupancy"),
    ::zhc::tuya::dp::numeric(3,"countdown",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_ebnpxjce"};
}
...
extern const PreparedDefinition kDefTZE200_pir_switch{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_pir_switch",
