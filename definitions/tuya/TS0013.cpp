...
constexpr const char* kModels[] = { "TS0013", "ZG-302Z3" };  // z2m folded ZG-302Z3 alias
}
...
constexpr WhiteLabel kWhiteLabels_TS0013[] = {
...
extern const PreparedDefinition kDefTS0013{
    ...
    .white_labels=kWhiteLabels_TS0013, .white_labels_count=sizeof(kWhiteLabels_TS0013)/sizeof(kWhiteLabels_TS0013[0]),
    .from_zigbee=kFz,.from_zigbee_count=sizeof(kFz)/sizeof(kFz[0]),
    .to_zigbee=kTz,.to_zigbee_count=sizeof(kTz)/sizeof(kTz[0]),
    .configure=nullptr,.on_event=nullptr,
.bindings=kAutoBindings,.bindings_count=sizeof(kAutoBindings)/sizeof(kAutoBindings[0]),
    // z2m TS0013 configure: reporting.onOff for EP1..3 loop. 3-gang.
