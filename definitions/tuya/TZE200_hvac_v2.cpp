...
// Tier 3: _TZE200_hvac_v2 HVAC controller v2. z2m-source: tuya.ts.
...
extern const PreparedDefinition kDefTZE200_hvac_v2{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_hvac_v2",
