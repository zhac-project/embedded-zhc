...
// Tier 3: _TZE200_k3vmoak6 towel warmer. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_k3vmoak6"};
}
...
extern const PreparedDefinition kDefTZE200_towel_warmer{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_towel_warmer",
