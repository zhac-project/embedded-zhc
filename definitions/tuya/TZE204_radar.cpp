...
// Tier 3: _TZE204_sooucan5 mmWave 5.8GHz radar protocol v4. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(9,"radar_sensitivity",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE204_sooucan5"};
}
...
extern const PreparedDefinition kDefTZE204_radar{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_radar_v4",
