...
// Tier 3: _TZE200_vugkm0du flow meter. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"flow_rate",1),
    ::zhc::tuya::dp::numeric(2,"total_volume",1000),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_vugkm0du"};
}
...
extern const PreparedDefinition kDefTZE200_flow{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_flow",
