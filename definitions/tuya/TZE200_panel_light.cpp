...
// Tier 3: _TZE200_panel_light square panel light. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_panel_light"};
}
...
extern const PreparedDefinition kDefTZE200_panel_light{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_panel_light",
