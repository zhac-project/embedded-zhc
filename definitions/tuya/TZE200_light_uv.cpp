...
// Tier 3: _TZE200_light_uv lux + UV combined sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"illuminance",1),
    ::zhc::tuya::dp::numeric(3,"uv_index",10),
    ::zhc::tuya::dp::numeric(4,"uv_dose",100)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_light_uv"};
}
...
extern const PreparedDefinition kDefTZE200_light_uv{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_light_uv",
