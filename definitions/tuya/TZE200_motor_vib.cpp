...
// Tier 3: _TZE200_motor_vib motor vibration monitor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"rms_vibration",1000),
    ::zhc::tuya::dp::numeric(2,"frequency_hz",1),
    ::zhc::tuya::dp::temperature(3),
    ::zhc::tuya::dp::binary(4,"fault")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_motor_vib"};
}
...
extern const PreparedDefinition kDefTZE200_motor_vib{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_motor_vib",
