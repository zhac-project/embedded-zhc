...
// Tier 3: _TZE200_g5xawfcq thermostat v3. z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kM2[]={{0,"hold"},{1,"schedule"},{2,"away"},{3,"frost"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),
    ::zhc::tuya::dp::enum_lookup(2,"preset",kM2,4),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_g5xawfcq"};
}
...
extern const PreparedDefinition kDefTZE200_thermostat_v3{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_thermostat_v3",
