...
// Tier 2: _TZE200_socket_v3 smart socket v3 with usage stats. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(17,"energy_today",100),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_socket_v3"};
}
...
extern const PreparedDefinition kDefTZE200_socket_v3{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_socket_v3",
