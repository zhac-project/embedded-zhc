...
// Tier 2: _TZE200_8isdky6j low-voltage DC-load switch. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_8isdky6j"};
}
...
extern const PreparedDefinition kDefTZE200_dc_switch{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_dc_switch",
