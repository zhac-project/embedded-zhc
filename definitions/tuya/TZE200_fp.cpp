...
// Tier 3: _TZE200_fp fingerprint access module. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"verified"),
    ::zhc::tuya::dp::numeric(2,"user_id",1),
    ::zhc::tuya::dp::binary(15,"tamper")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_fp"};
}
...
extern const PreparedDefinition kDefTZE200_fp{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_fp",
