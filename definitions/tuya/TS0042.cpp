...
// Tier 1: Tuya TS0042 2-button scene switch. z2m-source: tuya.ts.
...
constexpr WhiteLabel kWhiteLabels_TS0042[] = {
    {"Marmitek","Push_LO"},
    {"Smart9","S9TSZGB"},
    {"Lonsonho","TS0042"},
...
extern const PreparedDefinition kDefTS0042{
    ...
    .white_labels=kWhiteLabels_TS0042, .white_labels_count=sizeof(kWhiteLabels_TS0042)/sizeof(kWhiteLabels_TS0042[0]),
