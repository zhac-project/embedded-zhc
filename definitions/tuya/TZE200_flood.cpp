...
// Tier 2: _TZE200_cirvgep4 flood alarm. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_cirvgep4"};
}
...
constexpr WhiteLabel kWhiteLabels_TZE200_flood[] = {
    {"Tuya","ZTH01"},
    {"Tuya","SZTH02"},
    {"Tuya","ZTH02"},
    {"Tuya","ZTH05"},
...
extern const PreparedDefinition kDefTZE200_flood{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_flood",
    .vendor="Tuya",.meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_TZE200_flood, .white_labels_count=sizeof(kWhiteLabels_TZE200_flood)/sizeof(kWhiteLabels_TZE200_flood[0]),
