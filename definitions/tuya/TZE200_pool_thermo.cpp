...
// Tier 3: _TZE200_7bodvqd3 pool thermostat / heat-pump. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_7bodvqd3"};
}
...
extern const PreparedDefinition kDefTZE200_pool_thermo{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_pool_thermo",
