...
// Tier 2: _TZE200_phhmwggw scheduled-timer switch. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(101,"schedule_id",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_phhmwggw"};
}
...
extern const PreparedDefinition kDefTZE200_timer_switch{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_timer_sw",
