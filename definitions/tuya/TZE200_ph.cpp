...
// Tier 3: _TZE200_v7h3cpmw pool pH meter. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"ph",100),
    ::zhc::tuya::dp::temperature(3),
    ::zhc::tuya::dp::numeric(4,"electrical_conductivity",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_v7h3cpmw"};
}
...
extern const PreparedDefinition kDefTZE200_ph{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_ph",
