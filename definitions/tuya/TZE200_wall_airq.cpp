...
// Tier 3: _TZE200_nsngmvbu wall-mounted air quality. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::temperature(18),
    ::zhc::tuya::dp::numeric(19,"humidity",10),
    ::zhc::tuya::dp::numeric(2,"pm25",1),
    ::zhc::tuya::dp::numeric(20,"tvoc",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_nsngmvbu"};
}
...
extern const PreparedDefinition kDefTZE200_wall_airq{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_wall_airq",
