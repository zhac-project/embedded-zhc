...
// Tier 3: _TZE200_cowvfni3 DP cover / roller blind. z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kStates[]={
    {0,"open"},{1,"stop"},{2,"close"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::enum_lookup(1,"motor_state",kStates,3),
    ::zhc::tuya::dp::numeric(2,"position",1),
    ::zhc::tuya::dp::numeric(7,"work_state",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_cowvfni3"};
}
...
constexpr WhiteLabel kWhiteLabels_TZE200_cover[] = {
    {"Yushun","YS-MT750L"},
...
extern const PreparedDefinition kDefTZE200_cover{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_cover",
    .vendor="Tuya",.meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_TZE200_cover, .white_labels_count=sizeof(kWhiteLabels_TZE200_cover)/sizeof(kWhiteLabels_TZE200_cover[0]),
