...
// Tier 2: _TZE200_jthf7vb6 gas (methane) sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(2,"gas_value",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_jthf7vb6"};
}
...
extern const PreparedDefinition kDefTZE200_gas{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_gas",
