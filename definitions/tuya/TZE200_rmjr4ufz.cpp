...
// Tier 2: _TZE200_rmjr4ufz plug variant.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_rmjr4ufz"};
}
...
extern const PreparedDefinition kDefTZE200_rmjr4ufz{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_rmjr4ufz",.vendor="Tuya",
