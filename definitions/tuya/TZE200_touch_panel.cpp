...
// Tier 2: _TZE200_oh7qx9md 3-gang touch panel. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(3,"state_l3"),::zhc::tuya::dp::binary(40,"child_lock"),
    ::zhc::tuya::dp::binary(41,"backlight")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,5}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_oh7qx9md"};
}
...
extern const PreparedDefinition kDefTZE200_touch_panel{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_touch_panel",
