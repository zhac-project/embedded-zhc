...
// Tier 3: Tuya TR-M3Z thermostat (_TZE204_eekpf0ft) — z2m parity v26.92.0.
// GRADUATED from definitions/tuya/generated/Gen__TZE204_eekpf0ft.cpp — z2m parity v26.92.0.
//
...
// Originally auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE204_eekpf0ft).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::tuya {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_eekpf0ft_preset_dp2[] = {
    { 0, "manual" },
    { 1, "schedule" },
    { 2, "eco" },
    { 3, "comfort" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_eekpf0ft_running_state_dp3[] = {
    { 0, "idle" },
    { 1, "heat" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_eekpf0ft_window_open_dp15[] = {
    { 0, "CLOSE" },
    { 1, "OPEN" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE204_eekpf0ft[] = {
    { 2, "preset", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_eekpf0ft_preset_dp2, sizeof(kEnum__TZE204_eekpf0ft_preset_dp2)/sizeof(kEnum__TZE204_eekpf0ft_preset_dp2[0]) },
    { 3, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_eekpf0ft_running_state_dp3, sizeof(kEnum__TZE204_eekpf0ft_running_state_dp3)/sizeof(kEnum__TZE204_eekpf0ft_running_state_dp3[0]) },
    ...
    { 15, "window_open", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_eekpf0ft_window_open_dp15, sizeof(kEnum__TZE204_eekpf0ft_window_open_dp15)/sizeof(kEnum__TZE204_eekpf0ft_window_open_dp15[0]) },
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE204_eekpf0ft{ kEntries__TZE204_eekpf0ft, 24 };
constexpr FzConverter kFzDp__TZE204_eekpf0ft{
    ...
    .user_config       = &kMap__TZE204_eekpf0ft,
};
const FzConverter* const kFz__TZE204_eekpf0ft[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE204_eekpf0ft,
};
constexpr TzConverter kTzDp__TZE204_eekpf0ft{
...
const TzConverter* const kTz__TZE204_eekpf0ft[] = { &kTzDp__TZE204_eekpf0ft };
constexpr const char* kM__TZE204_eekpf0ft[] = { "TS0601" };
constexpr const char* kN__TZE204_eekpf0ft[] = { "_TZE204_eekpf0ft" };
}  // namespace
extern const PreparedDefinition kDef__TZE204_eekpf0ft{
    .zigbee_models=kM__TZE204_eekpf0ft,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE204_eekpf0ft,.manufacturer_names_count=1,
    .model="TS0601__TZE204_eekpf0ft",.vendor="Tuya",
    .meta=nullptr,.exposes=nullptr,.exposes_count=0,
    .white_labels=nullptr,.white_labels_count=0,
    .from_zigbee=kFz__TZE204_eekpf0ft,
    .from_zigbee_count=sizeof(kFz__TZE204_eekpf0ft)/sizeof(kFz__TZE204_eekpf0ft[0]),
    .to_zigbee=kTz__TZE204_eekpf0ft,
    .to_zigbee_count=sizeof(kTz__TZE204_eekpf0ft)/sizeof(kTz__TZE204_eekpf0ft[0]),
