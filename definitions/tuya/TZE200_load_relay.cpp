...
// Tier 2: _TZE200_load_relay load-sensing weighing relay. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(21,"load_detected",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_load_relay"};
}
...
extern const PreparedDefinition kDefTZE200_load_relay{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_load_relay",
