...
// Tier 3: _TZE200_9gxlg4uz presence + temp/humidity combo. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(3,"humidity",10),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_9gxlg4uz"};
}
...
extern const PreparedDefinition kDefTZE200_presence_th{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_presence_th",
