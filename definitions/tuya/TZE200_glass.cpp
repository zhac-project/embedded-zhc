...
// Tier 3: _TZE200_glass glass-break detector. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"glass_break"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_glass"};
}
...
extern const PreparedDefinition kDefTZE200_glass{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_glass",
