...
// Tier 3: _TZE200_sprinkler irrigation / garden sprinkler. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(11,"total_volume",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_sprinkler"};
}
...
extern const PreparedDefinition kDefTZE200_sprinkler{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_sprinkler",
