...
// Tier 2: _TZE200_cabdlh02 neutral-line relay. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_cabdlh02"};
}
...
extern const PreparedDefinition kDefTZE200_neutral_relay{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_neutral_relay",
