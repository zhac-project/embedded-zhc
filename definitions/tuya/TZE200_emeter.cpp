...
// Tier 3: _TZE200_emeter 3-phase energy meter. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(17,"total_energy",100),
    ::zhc::tuya::dp::numeric(101,"power_a",10),
    ::zhc::tuya::dp::numeric(102,"power_b",10),
    ::zhc::tuya::dp::numeric(103,"power_c",10),
    ::zhc::tuya::dp::numeric(104,"freq",100)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,5}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_emeter"};
}
...
extern const PreparedDefinition kDefTZE200_emeter{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_emeter",
