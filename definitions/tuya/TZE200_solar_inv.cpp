...
// Tier 3: _TZE200_solar_inv solar inverter monitor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(101,"pv_power",10),
    ::zhc::tuya::dp::numeric(102,"pv_energy_today",100),
    ::zhc::tuya::dp::numeric(103,"grid_power",10),
    ::zhc::tuya::dp::numeric(104,"battery_soc",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_solar_inv"};
}
...
extern const PreparedDefinition kDefTZE200_solar_inv{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_solar_inv",
