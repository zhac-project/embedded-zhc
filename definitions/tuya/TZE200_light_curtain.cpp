...
// Tier 3: _TZE200_a3y89msq photoelectric light curtain (break-beam). z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"beam_broken"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_a3y89msq"};
}
...
extern const PreparedDefinition kDefTZE200_light_curtain{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_light_curtain",
