...
// Tier 3: _TZE200_air_filter air-purifier filter status. z2m-source: tuya.ts.
...
extern const PreparedDefinition kDefTZE200_air_filter{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_air_filter",
