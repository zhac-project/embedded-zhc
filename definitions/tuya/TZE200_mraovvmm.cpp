...
// Tier 2: _TZE200_mraovvmm plug variant.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_mraovvmm"};
}
...
extern const PreparedDefinition kDefTZE200_mraovvmm{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_mraovvmm",.vendor="Tuya",
