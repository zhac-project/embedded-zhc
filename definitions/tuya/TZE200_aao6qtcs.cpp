...
// Tier 2: _TZE200_aao6qtcs occupancy+illuminance.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"occupancy"),::zhc::tuya::dp::numeric(4,"illuminance",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_aao6qtcs"};
}
...
extern const PreparedDefinition kDefTZE200_aao6qtcs{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_aao6qtcs",.vendor="Tuya",
