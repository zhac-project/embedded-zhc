...
// Tier 2: _TZE200_5g_scene 5-gang scene wall. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_5g_scene"};
}
...
extern const PreparedDefinition kDefTZE200_5g_scene{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_5g_scene",
