...
// Tier 2: _TZE200_pocj9rhd USB charging switch. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_pocj9rhd"};
}
...
extern const PreparedDefinition kDefTZE200_usb_sw{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_usb_sw",
