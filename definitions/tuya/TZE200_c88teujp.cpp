...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"sos"),::zhc::tuya::dp::numeric(15,"battery",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_c88teujp"};
}
...
extern const PreparedDefinition kDefTZE200_c88teujp{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_c88teujp",.vendor="Tuya",
