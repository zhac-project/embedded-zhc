...
// Tier 3: _TZE200_rudlzptp swamp cooler. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_rudlzptp"};
}
...
extern const PreparedDefinition kDefTZE200_swamp{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_swamp",
