...
// Tier 2: _TZE200_qyxeznqk barometric air pressure. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"pressure",100),
    ::zhc::tuya::dp::temperature(3),
    ::zhc::tuya::dp::numeric(4,"humidity",10)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_qyxeznqk"};
}
...
extern const PreparedDefinition kDefTZE200_air_pressure{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_air_press",
