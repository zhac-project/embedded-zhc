...
// Tier 3: _TZE200_shutter_ctrl shutter controller. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(5,"reverse"),
    ::zhc::tuya::dp::numeric(6,"max_speed",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_shutter_ctrl"};
}
...
extern const PreparedDefinition kDefTZE200_shutter_ctrl{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_shutter_ctrl",
