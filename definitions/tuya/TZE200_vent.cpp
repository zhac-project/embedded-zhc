...
// Tier 3: _TZE200_7eiviecm greenhouse vent motor. z2m-source: tuya.ts.
...
extern const PreparedDefinition kDefTZE200_vent{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_vent",
