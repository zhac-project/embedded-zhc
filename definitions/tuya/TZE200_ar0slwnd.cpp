...
// Tier 3: _TZE200_ar0slwnd cover/curtain variant.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_ar0slwnd"};
}
...
extern const PreparedDefinition kDefTZE200_ar0slwnd{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_ar0slwnd",.vendor="Tuya",
