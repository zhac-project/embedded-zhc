...
// Tier 3: _TZE200_fridge smart fridge. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(2,"fridge_temp",10),
    ::zhc::tuya::dp::numeric(3,"freezer_temp",10),
    ::zhc::tuya::dp::binary(4,"door_open")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_fridge"};
}
...
extern const PreparedDefinition kDefTZE200_fridge{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_fridge",
