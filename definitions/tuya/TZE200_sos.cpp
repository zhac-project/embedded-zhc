...
// Tier 2: _TZE200_3towulqd SOS emergency button (DP-only).
// z2m-source: tuya.ts #_TZE200_3towulqd.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kActs[] = { {0,"emergency"},{1,"sos"} };
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry entries[] = {
    ::zhc::tuya::dp::action(24, kActs, 2) };
...
constexpr const char* kManu[]={"_TZE200_3towulqd"};
}
