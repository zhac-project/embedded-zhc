...
// Tier 3: Tuya TS0601 3-gang DP switch _TZE204_ccgyhbvd (z2m v26.76.0 parity).
// z2m-source: tuya.ts #TS0601_3gang_switch
...
constexpr const char* kN[]={"_TZE204_ccgyhbvd"};
...
extern const PreparedDefinition kDef_TS0601_3gang_switch{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_3gang_switch",
