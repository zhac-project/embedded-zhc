...
// Tier 3: _TZE200_jnjt9z8u smart circuit breaker. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(22,"overload")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,6}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_jnjt9z8u"};
}
...
extern const PreparedDefinition kDefTZE200_smart_breaker{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_smart_breaker",
