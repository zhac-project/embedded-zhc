...
// Tier 2: _TZE200_8ygsuhe1 zone-based presence. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(2,"zone_1_presence",1),
    ::zhc::tuya::dp::numeric(3,"zone_2_presence",1),
    ::zhc::tuya::dp::numeric(4,"zone_3_presence",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_8ygsuhe1"};
}
...
extern const PreparedDefinition kDefTZE200_presence_zone{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_presence_zone",
