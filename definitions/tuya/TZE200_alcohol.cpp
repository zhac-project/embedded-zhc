...
// Tier 3: _TZE200_alcohol ethanol breath/room sensor. z2m-source: tuya.ts.
...
extern const PreparedDefinition kDefTZE200_alcohol{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_alcohol",
