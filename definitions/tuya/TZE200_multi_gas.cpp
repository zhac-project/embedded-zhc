...
// Tier 3: _TZE200_zzzmyhnh multi-gas alarm (CO+CO2+CH4). z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"carbon_monoxide"),
    ::zhc::tuya::dp::numeric(2,"co_value",1),
    ::zhc::tuya::dp::binary(5,"methane"),
    ::zhc::tuya::dp::numeric(7,"methane_value",1),
    ::zhc::tuya::dp::numeric(14,"co2",1),
    ::zhc::tuya::dp::binary(13,"alarm")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,6}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_zzzmyhnh"};
}
...
extern const PreparedDefinition kDefTZE200_multi_gas{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_multi_gas",
