...
// Tier 3: _TZE200_a1s3dfwa snow depth sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"snow_depth_cm",10),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_a1s3dfwa"};
}
...
extern const PreparedDefinition kDefTZE200_snow{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_snow",
