...
// Tier 2: _TZE200_locansqn DP particulate-matter sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"pm25",1),::zhc::tuya::dp::numeric(5,"pm10",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_locansqn"};
}
...
extern const PreparedDefinition kDefTZE200_pm25{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_pm25",
