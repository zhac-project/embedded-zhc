...
// Tier 2: _TZE200_rawkwrj2 scenario switch (scene-triggering wall panel).
// z2m-source: tuya.ts.
...
extern const PreparedDefinition kDefTZE200_scenario{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_scenario",
