...
// Tier 3: _TZE200_bme680 BME680 multi-sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(3,"pressure",100),
    ::zhc::tuya::dp::numeric(4,"gas_resistance",1),
    ::zhc::tuya::dp::numeric(5,"iaq",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,5}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_bme680"};
}
...
extern const PreparedDefinition kDefTZE200_bme680{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_bme680",
