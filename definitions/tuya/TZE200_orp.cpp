...
// Tier 3: _TZE200_orp ORP/redox sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"orp_mv",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_orp"};
}
...
extern const PreparedDefinition kDefTZE200_orp{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_orp",
