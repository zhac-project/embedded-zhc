...
// Tier 3: _TZE200_gubdgai2 dual-motor curtain. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"position_left",1),
    ::zhc::tuya::dp::numeric(3,"position_right",1),
    ::zhc::tuya::dp::binary(7,"moving")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_gubdgai2"};
}
...
extern const PreparedDefinition kDefTZE200_dual_curtain{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_dual_curtain",
