...
// Tier 3: _TZE200_0zaf1cr6 soil moisture + EC. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(6,"electrical_conductivity",1),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_0zaf1cr6"};
}
...
extern const PreparedDefinition kDefTZE200_soil_ec{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_soil_ec",
