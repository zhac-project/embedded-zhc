...
// Tier 3: _TZE200_conveyor conveyor-belt sensor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"running"),
    ::zhc::tuya::dp::numeric(2,"belt_speed",100),
    ::zhc::tuya::dp::numeric(3,"total_count",1),
    ::zhc::tuya::dp::binary(4,"fault")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_conveyor"};
}
...
extern const PreparedDefinition kDefTZE200_conveyor{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_conveyor",
