...
// Tier 2: _TZE200_yinkbgft wall dimmer. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(3,"min_brightness",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaLight<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_yinkbgft"};
}
...
extern const PreparedDefinition kDefTZE200_dimmer{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_dimmer",
