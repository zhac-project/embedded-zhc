...
// Tier 2: _TZE200_cpbsvpsp outdoor switch. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_cpbsvpsp"};
}
...
extern const PreparedDefinition kDefTZE200_outdoor_switch{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_outdoor_sw",
