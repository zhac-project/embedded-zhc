...
// Tier 3: _TZE200_digital_scale precision digital scale. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"weight_g",10),
    ::zhc::tuya::dp::binary(2,"tare"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_digital_scale"};
}
...
extern const PreparedDefinition kDefTZE200_digital_scale{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_digital_scale",
