...
// Tier 3: _TZE200_0mhbtblp electric heated mat. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_0mhbtblp"};
}
...
extern const PreparedDefinition kDefTZE200_heated_mat{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_heated_mat",
