...
// Tier 2: _TZE200_5f7xqvkh soil-moisture sensor. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_5f7xqvkh"};
}
...
extern const PreparedDefinition kDefTZE200_soil{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_soil",
