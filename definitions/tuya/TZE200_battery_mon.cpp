...
// Tier 3: _TZE200_vmodcgxw battery voltage monitor. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"voltage",100),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_vmodcgxw"};
}
...
extern const PreparedDefinition kDefTZE200_battery_mon{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_batt_mon",
