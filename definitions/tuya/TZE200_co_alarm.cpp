...
// Tier 2: _TZE200_7hfcudw5 DP CO alarm. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"carbon_monoxide"),::zhc::tuya::dp::numeric(15,"battery",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_7hfcudw5"};
}
...
extern const PreparedDefinition kDefTZE200_co_alarm{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_co_alarm",
