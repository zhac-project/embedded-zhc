...
// Tier 3: _TZE200_outdoor_siren outdoor siren. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_outdoor_siren"};
}
...
extern const PreparedDefinition kDefTZE200_outdoor_siren{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_outdoor_siren",
