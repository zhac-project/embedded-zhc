...
// Tier 3: _TZE200_r6nbmbvv dehumidifier. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(4,"child_lock")};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_r6nbmbvv"};
}
...
extern const PreparedDefinition kDefTZE200_dehumid{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_dehumid",
