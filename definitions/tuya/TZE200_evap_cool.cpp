...
// Tier 3: _TZE200_pekvlu34 evaporative cooler. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::binary(6,"swing"),
    ::zhc::tuya::dp::numeric(7,"water_level",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_pekvlu34"};
}
...
extern const PreparedDefinition kDefTZE200_evap_cool{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_evap_cool",
