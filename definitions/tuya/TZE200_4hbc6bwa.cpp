...
// Tier 3: _TZE200_4hbc6bwa TRV variant.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_4hbc6bwa"};
}
...
extern const PreparedDefinition kDefTZE200_4hbc6bwa{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_4hbc6bwa",.vendor="Tuya",
