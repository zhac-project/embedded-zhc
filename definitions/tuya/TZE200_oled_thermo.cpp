...
// Tier 3: _TZE200_oled_thermo thermostat with OLED display. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ...
    ::zhc::tuya::dp::numeric(105,"display_brightness",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_oled_thermo"};
}
...
extern const PreparedDefinition kDefTZE200_oled_thermo{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_oled_thermo",
