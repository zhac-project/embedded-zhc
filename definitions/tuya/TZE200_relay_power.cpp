...
// Tier 2: _TZE200_fctwhugx relay with power metering. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_fctwhugx"};
}
...
constexpr WhiteLabel kWhiteLabels_TZE200_relay_power[] = {
    {"Yushun","YS-MT750L"},
...
extern const PreparedDefinition kDefTZE200_relay_power{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_relay_power",
    .vendor="Tuya",.meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_TZE200_relay_power, .white_labels_count=sizeof(kWhiteLabels_TZE200_relay_power)/sizeof(kWhiteLabels_TZE200_relay_power[0]),
