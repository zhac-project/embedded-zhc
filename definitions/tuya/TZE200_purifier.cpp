...
// Tier 3: _TZE200_purifier HEPA air purifier. z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kM2[]={{0,"auto"},{1,"sleep"},{2,"high"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),
    ::zhc::tuya::dp::enum_lookup(2,"mode",kM2,3),
    ::zhc::tuya::dp::numeric(3,"pm25",1),
    ::zhc::tuya::dp::numeric(4,"filter_life",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,4}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_purifier"};
}
...
extern const PreparedDefinition kDefTZE200_purifier{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_purifier",
