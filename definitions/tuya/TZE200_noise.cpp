...
// Tier 3: _TZE200_wh1jxuhv noise / decibel meter. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(2,"sound_level",1),
    ::zhc::tuya::dp::binary(3,"noise_alarm"),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_wh1jxuhv"};
}
...
extern const PreparedDefinition kDefTZE200_noise{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_noise",
