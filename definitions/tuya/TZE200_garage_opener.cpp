...
// Tier 3: _TZE200_rjl8qtjw garage door opener. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"trigger"),
    ::zhc::tuya::dp::binary(3,"contact"),
    ::zhc::tuya::dp::numeric(12,"countdown",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,3}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_rjl8qtjw"};
}
...
extern const PreparedDefinition kDefTZE200_garage_opener{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_garage_opener",
