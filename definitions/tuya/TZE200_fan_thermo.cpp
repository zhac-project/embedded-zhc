...
// Tier 3: _TZE200_lellhe6k fan with thermostat. z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kS[]={{0,"low"},{1,"mid"},{2,"high"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"state"),
    ::zhc::tuya::dp::enum_lookup(4,"fan_speed",kS,3),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_lellhe6k"};
}
...
extern const PreparedDefinition kDefTZE200_fan_thermo{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_fan_thermo",
