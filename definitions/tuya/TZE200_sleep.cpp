...
// Tier 3: _TZE200_bcusnqt8 sleep/bed presence monitor. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_bcusnqt8"};
}
...
extern const PreparedDefinition kDefTZE200_sleep{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_sleep",
