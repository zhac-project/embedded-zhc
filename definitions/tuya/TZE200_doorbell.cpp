...
// Tier 3: _TZE200_doorbell (generic DP doorbell). z2m-source: tuya.ts.
...
namespace {
static constexpr ::zhc::tuya::TuyaEnumEntry kMel[]={
    {0,"chime_1"},{1,"chime_2"},{2,"chime_3"},{3,"chime_4"}};
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"pressed"),
    ::zhc::tuya::dp::enum_lookup(21,"melody",kMel,4),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_doorbell"};
}
...
extern const PreparedDefinition kDefTZE200_doorbell{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_doorbell",
