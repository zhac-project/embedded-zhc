...
// Tier 3: _TZE200_9w0p3s8i garage-door controller. z2m-source: tuya.ts.
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_9w0p3s8i"};
}
...
extern const PreparedDefinition kDefTZE200_garage{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_garage",
