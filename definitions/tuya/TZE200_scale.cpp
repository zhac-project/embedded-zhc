...
// Tier 3: _TZE200_hb3onf1u weight scale. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::numeric(1,"weight",10),
...
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_hb3onf1u"};
}
...
extern const PreparedDefinition kDefTZE200_scale{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_scale",
