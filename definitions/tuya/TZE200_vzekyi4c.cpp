...
// Tier 2: _TZE200_vzekyi4c DP PIR occupancy. z2m-source: tuya.ts.
...
struct cfg { static constexpr ::zhc::tuya::TuyaDpMapEntry e[]={
    ::zhc::tuya::dp::binary(1,"occupancy"),::zhc::tuya::dp::numeric(4,"battery",1)};
    static constexpr ::zhc::tuya::TuyaDatapointMap dp_map{e,2}; };
using FX=::zhc::tuya::factory::TuyaOnOff<cfg>;
constexpr const char* kM[]={"TS0601"}; constexpr const char* kN[]={"_TZE200_vzekyi4c"};
}
...
extern const PreparedDefinition kDefTZE200_vzekyi4c{
    ...
    .manufacturer_names=kN,.manufacturer_names_count=1,.model="TS0601_pir_vzekyi4c",
