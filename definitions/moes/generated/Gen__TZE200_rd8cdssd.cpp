...
constexpr const char* kAutoOpts__TZE200_rd8cdssd_9[] = {"switch_1", "scene_1"};
constexpr const char* kAutoOpts__TZE200_rd8cdssd_10[] = {"switch_2", "scene_2"};
constexpr const char* kAutoOpts__TZE200_rd8cdssd_11[] = {"switch_3", "scene_3"};
constexpr const char* kAutoOpts__TZE200_rd8cdssd_13[] = {"off", "previous", "on"};
constexpr const char* kAutoOpts__TZE200_rd8cdssd_14[] = {"off", "relay", "invert"};
constexpr const char* kAutoOpts__TZE200_rd8cdssd_15[] = {"ON", "OFF"};
constexpr const char* kAutoOpts__TZE200_rd8cdssd_16[] = {"Gear 0", "Gear 1", "Gear 2", "Gear 3"};
constexpr const char* kAutoOpts__TZE200_rd8cdssd_17[] = {"scene_1", "scene_2", "scene_3"};
constexpr Expose kAutoExposes__TZE200_rd8cdssd[] = {
    ...
    {"mode_l1", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_rd8cdssd_9, 2},
    {"mode_l2", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_rd8cdssd_10, 2},
    {"mode_l3", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_rd8cdssd_11, 2},
    {"backlight_mode", ExposeType::Binary, Access::StateSet, nullptr, nullptr, nullptr, 0, ExposeCategory::Config},
    {"power_on_behavior", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_rd8cdssd_13, 3, ExposeCategory::Config},
    {"indicator_status", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_rd8cdssd_14, 3},
    {"induction_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_rd8cdssd_15, 2},
    {"vibration_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_rd8cdssd_16, 4},
    {"action", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE200_rd8cdssd_17, 3, ExposeCategory::Diagnostic},
};
...
extern const PreparedDefinition kDefGen__TZE200_rd8cdssd{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_rd8cdssd,.exposes_count=sizeof(kAutoExposes__TZE200_rd8cdssd)/sizeof(kAutoExposes__TZE200_rd8cdssd[0]),
