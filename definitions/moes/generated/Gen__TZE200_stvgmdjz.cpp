...
constexpr const char* kAutoOpts__TZE200_stvgmdjz_4[] = {"off", "previous", "on"};
constexpr const char* kAutoOpts__TZE200_stvgmdjz_5[] = {"switch_1", "scene_1"};
constexpr const char* kAutoOpts__TZE200_stvgmdjz_6[] = {"off", "relay", "invert"};
constexpr const char* kAutoOpts__TZE200_stvgmdjz_7[] = {"ON", "OFF"};
constexpr const char* kAutoOpts__TZE200_stvgmdjz_8[] = {"Gear 0", "Gear 1", "Gear 2", "Gear 3"};
constexpr const char* kAutoOpts__TZE200_stvgmdjz_9[] = {"scene_1"};
constexpr Expose kAutoExposes__TZE200_stvgmdjz[] = {
    ...
    {"power_on_behavior", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_stvgmdjz_4, 3, ExposeCategory::Config},
    {"mode_l1", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_stvgmdjz_5, 2},
    {"indicator_status", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_stvgmdjz_6, 3},
    {"induction_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_stvgmdjz_7, 2},
    {"vibration_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_stvgmdjz_8, 4},
    {"action", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE200_stvgmdjz_9, 1, ExposeCategory::Diagnostic},
};
...
extern const PreparedDefinition kDefGen__TZE200_stvgmdjz{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_stvgmdjz,.exposes_count=sizeof(kAutoExposes__TZE200_stvgmdjz)/sizeof(kAutoExposes__TZE200_stvgmdjz[0]),
