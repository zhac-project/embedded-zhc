...
constexpr const char* kN_ZTS_EU[] = { "_TZE200_amp6tsvy" };
...
extern const PreparedDefinition kDefMoes__TZE200_amp6tsvy{
    ...
    .model="TS0601__TZE200_amp6tsvy", .vendor="Moes",
