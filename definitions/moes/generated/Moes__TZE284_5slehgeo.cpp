...
// Auto-generated from z2m devices/moes.ts (fingerprint TS0601 / _TZE284_5slehgeo).
...
constexpr const char* kN_EURC[] = { "_TZE284_5slehgeo" };
...
extern const PreparedDefinition kDefMoes__TZE284_5slehgeo{
    .zigbee_models=kM_EURC,.zigbee_models_count=sizeof(kM_EURC)/sizeof(kM_EURC[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN_EURC, .manufacturer_names_count=1,
    .model="TS0601__TZE284_5slehgeo", .vendor="Moes",
