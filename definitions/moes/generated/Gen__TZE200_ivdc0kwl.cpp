...
// Auto-generated from z2m devices/tuya.ts (fingerprint TS0601 / _TZE200_ivdc0kwl).
...
constexpr const char* kAutoOpts__TZE200_ivdc0kwl_3[] = {"auto", "manual", "off", "on"};
constexpr const char* kAutoOpts__TZE200_ivdc0kwl_4[] = {"idle", "heat"};
constexpr const char* kAutoOpts__TZE200_ivdc0kwl_22[] = {"0", "1"};
constexpr Expose kAutoExposes__TZE200_ivdc0kwl[] = {
    ...
    {"preset", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ivdc0kwl_3, 4},
    {"running_state", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts__TZE200_ivdc0kwl_4, 2},
    ...
    {"max_temperature", ExposeType::Numeric, Access::StateSet, "°C", nullptr, nullptr, 0, ExposeCategory::State, 20, 35, 0},
    ...
    {"screen_orientation", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE200_ivdc0kwl_22, 2},
};
...
extern const PreparedDefinition kDefGen__TZE200_ivdc0kwl{
    ...
    .meta=nullptr,.exposes=kAutoExposes__TZE200_ivdc0kwl,.exposes_count=sizeof(kAutoExposes__TZE200_ivdc0kwl)/sizeof(kAutoExposes__TZE200_ivdc0kwl[0]),
