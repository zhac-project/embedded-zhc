...
constexpr const char* kAutoOpts__TZE284_a1ovdobn_5[] = {"off", "on", "memory"};
constexpr const char* kAutoOpts__TZE284_a1ovdobn_6[] = {"none", "relay", "pos"};
constexpr Expose kAutoExposes__TZE284_a1ovdobn[] = {
    ...
    {"relay_status", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_a1ovdobn_5, 3},
    {"light_mode", ExposeType::Enum, Access::StateSet, nullptr, nullptr, kAutoOpts__TZE284_a1ovdobn_6, 3},
...
extern const PreparedDefinition kDefGen__TZE284_a1ovdobn{
    .zigbee_models=kM__TZE284_a1ovdobn,.zigbee_models_count=sizeof(kM__TZE284_a1ovdobn)/sizeof(kM__TZE284_a1ovdobn[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE284_a1ovdobn,.manufacturer_names_count=1,
    .model="TS0601__TZE284_a1ovdobn",.vendor="Tuya",
    .meta=nullptr,.exposes=kAutoExposes__TZE284_a1ovdobn,.exposes_count=sizeof(kAutoExposes__TZE284_a1ovdobn)/sizeof(kAutoExposes__TZE284_a1ovdobn[0]),
