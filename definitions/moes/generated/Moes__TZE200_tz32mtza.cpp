...
constexpr const char* kN_ZTS_EU[] = { "_TZE200_tz32mtza" };
...
extern const PreparedDefinition kDefMoes__TZE200_tz32mtza{
    ...
    .model="TS0601__TZE200_tz32mtza", .vendor="Moes",
