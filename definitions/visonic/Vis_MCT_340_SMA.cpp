...
// Tier 2: Visonic MCT-340 SMA — IAS dead-key + dropped temperature channel.
// Magnetic door & window contact sensor
// z2m-source: visonic.ts #MCT-340 SMA
...
namespace {
const FzConverter* const kFz_MCT_340_SMA[] = {
    &::zhc::generic::kFzBattery,
    &::zhc::generic::kFzIasContactAlarm,
    &::zhc::generic::kFzTemperature,
};

constexpr const char* kModels_MCT_340_SMA[] = { "MCT-340 SMA" };
...
extern const PreparedDefinition kDef_MCT_340_SMA{
    .zigbee_models=kModels_MCT_340_SMA, .zigbee_models_count=sizeof(kModels_MCT_340_SMA)/sizeof(kModels_MCT_340_SMA[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="MCT-340 SMA", .vendor="Visonic",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_MCT_340_SMA, .from_zigbee_count=sizeof(kFz_MCT_340_SMA)/sizeof(kFz_MCT_340_SMA[0]),
