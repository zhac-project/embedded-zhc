...
//
// z2m-source: sinope.ts #WL4200S — fromZigbee
...
namespace {
const FzConverter* const kFz_WL4200S[] = {
    &::zhc::generic::kFzBattery,
    &::zhc::generic::kFzTemperature,
    &::zhc::generic::kFzIasWaterLeakAlarm,
};

constexpr const char* kModels_WL4200S[] = { "WL4200S" };
...
extern const PreparedDefinition kDef_WL4200S{
    .zigbee_models=kModels_WL4200S, .zigbee_models_count=sizeof(kModels_WL4200S)/sizeof(kModels_WL4200S[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="WL4200S", .vendor="Sinope",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_WL4200S, .from_zigbee_count=sizeof(kFz_WL4200S)/sizeof(kFz_WL4200S[0]),
