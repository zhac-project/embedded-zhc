...
// Tier 2: AcuityBrandsLighting RB56AC — graduated for a parity fix.
// Juno Retrobasics 4" and 6" LED smart adjustable downlight (RGB + CCT).
// z2m-source: acuity_brands_lighting.ts #RB56AC.
//
// z2m bundle:
...
namespace {
const FzConverter* const kFz_RB56AC[] = {
    &::zhc::generic::kFzOnOff,
    &::zhc::generic::kFzBrightness,
    &::zhc::generic::kFzColorTemperature,
    &::zhc::generic::kFzColor,
};
const TzConverter* const kTz_RB56AC[] = {
    &::zhc::generic::kTzOnOff,
    &::zhc::generic::kTzBrightness,
    &::zhc::generic::kTzColorTemp,
    &::zhc::generic::kTzColor,
};
constexpr const char* kModels_RB56AC[] = { "ABL-LIGHT-Z-202" };
...
extern const PreparedDefinition kDef_RB56AC{
    .zigbee_models=kModels_RB56AC, .zigbee_models_count=sizeof(kModels_RB56AC)/sizeof(kModels_RB56AC[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="RB56AC", .vendor="AcuityBrandsLighting",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_RB56AC, .from_zigbee_count=sizeof(kFz_RB56AC)/sizeof(kFz_RB56AC[0]),
    .to_zigbee=kTz_RB56AC, .to_zigbee_count=sizeof(kTz_RB56AC)/sizeof(kTz_RB56AC[0]),
