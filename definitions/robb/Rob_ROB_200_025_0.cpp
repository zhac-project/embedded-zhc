...
// Tier 2: Robb ROB_200-025-0 — hand-rewritten from a wrong on/off bundle.
// Zigbee 8 button wall switch.
// z2m-source: robb.ts #ROB_200-025-0 — fz.command_on/off/move/stop + fz.battery,
...
// `action` key (a kAlwaysGlobalKey) collapsed all 8 buttons onto one key,
// discarding the originating endpoint that z2m encodes as on_1..brightness_stop_4.
