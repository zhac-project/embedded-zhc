...
// Auto-generated from z2m devices/avatto.ts (fingerprint TS0601 / _TZE284_xdtnpp1a).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::avatto {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE284_xdtnpp1a_running_state_dp49[] = {
    { 1, "heat" },
    { 0, "idle" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE284_xdtnpp1a_system_mode_dp49[] = {
    { 1, "heat" },
    { 0, "off" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE284_xdtnpp1a_preset_dp2[] = {
    { 0, "manual" },
    { 1, "auto" },
    { 2, "eco" },
    { 3, "comfort" },
...
constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE284_xdtnpp1a[] = {
    { 49, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE284_xdtnpp1a_running_state_dp49, sizeof(kEnum__TZE284_xdtnpp1a_running_state_dp49)/sizeof(kEnum__TZE284_xdtnpp1a_running_state_dp49[0]) },
    { 49, "system_mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE284_xdtnpp1a_system_mode_dp49, sizeof(kEnum__TZE284_xdtnpp1a_system_mode_dp49)/sizeof(kEnum__TZE284_xdtnpp1a_system_mode_dp49[0]) },
    { 2, "preset", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE284_xdtnpp1a_preset_dp2, sizeof(kEnum__TZE284_xdtnpp1a_preset_dp2)/sizeof(kEnum__TZE284_xdtnpp1a_preset_dp2[0]) },
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE284_xdtnpp1a{ kEntries__TZE284_xdtnpp1a, 29 };
constexpr FzConverter kFzDp__TZE284_xdtnpp1a{
    ...
    .user_config       = &kMap__TZE284_xdtnpp1a,
};
const FzConverter* const kFz__TZE284_xdtnpp1a[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE284_xdtnpp1a,
};
constexpr TzConverter kTzDp__TZE284_xdtnpp1a{
...
const TzConverter* const kTz__TZE284_xdtnpp1a[] = { &kTzDp__TZE284_xdtnpp1a };
constexpr const char* kM__TZE284_xdtnpp1a[] = { "TS0601" };
constexpr const char* kN__TZE284_xdtnpp1a[] = { "_TZE284_xdtnpp1a" };
}  // namespace
...
extern const PreparedDefinition kDefAva__TZE284_xdtnpp1a{
    .zigbee_models=kM__TZE284_xdtnpp1a,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE284_xdtnpp1a,.manufacturer_names_count=1,
    .model="TS0601__TZE284_xdtnpp1a",.vendor="Avatto",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr,.white_labels_count=0,
    .from_zigbee=kFz__TZE284_xdtnpp1a,
    .from_zigbee_count=sizeof(kFz__TZE284_xdtnpp1a)/sizeof(kFz__TZE284_xdtnpp1a[0]),
    .to_zigbee=kTz__TZE284_xdtnpp1a,
    .to_zigbee_count=sizeof(kTz__TZE284_xdtnpp1a)/sizeof(kTz__TZE284_xdtnpp1a[0]),
