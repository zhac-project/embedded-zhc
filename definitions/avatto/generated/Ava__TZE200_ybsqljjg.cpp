...
// Auto-generated from z2m devices/avatto.ts (fingerprint TS0601 / _TZE200_ybsqljjg).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::avatto {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE200_ybsqljjg_running_state_dp3[] = {
    { 0, "heat" },
    { 1, "idle" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE200_ybsqljjg[] = {
    { 2, "system_mode", ::zhc::TuyaDpType::Raw, 1, nullptr, 0, 0 },
    { 2, "preset", ::zhc::TuyaDpType::Raw, 1, nullptr, 0, 0 },
    { 3, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE200_ybsqljjg_running_state_dp3, sizeof(kEnum__TZE200_ybsqljjg_running_state_dp3)/sizeof(kEnum__TZE200_ybsqljjg_running_state_dp3[0]) },
...
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE200_ybsqljjg{ kEntries__TZE200_ybsqljjg, 23 };
constexpr FzConverter kFzDp__TZE200_ybsqljjg{
    ...
    .user_config       = &kMap__TZE200_ybsqljjg,
};
const FzConverter* const kFz__TZE200_ybsqljjg[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE200_ybsqljjg,
};
constexpr TzConverter kTzDp__TZE200_ybsqljjg{
...
const TzConverter* const kTz__TZE200_ybsqljjg[] = { &kTzDp__TZE200_ybsqljjg };
constexpr const char* kM__TZE200_ybsqljjg[] = { "TS0601" };
constexpr const char* kN__TZE200_ybsqljjg[] = { "_TZE200_ybsqljjg" };
}  // namespace
...
extern const PreparedDefinition kDefAva__TZE200_ybsqljjg{
    .zigbee_models=kM__TZE200_ybsqljjg,.zigbee_models_count=1,
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE200_ybsqljjg,.manufacturer_names_count=1,
    .model="TS0601__TZE200_ybsqljjg",.vendor="Avatto",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr,.white_labels_count=0,
    .from_zigbee=kFz__TZE200_ybsqljjg,
    .from_zigbee_count=sizeof(kFz__TZE200_ybsqljjg)/sizeof(kFz__TZE200_ybsqljjg[0]),
    .to_zigbee=kTz__TZE200_ybsqljjg,
    .to_zigbee_count=sizeof(kTz__TZE200_ybsqljjg)/sizeof(kTz__TZE200_ybsqljjg[0]),
