...
// Tier 2: Hornbach 10011725 — graduated to shared ColorCTLight bundle (added color + color_temp / 0x0300).
...
// z2m-source: hornbach.ts #10011725.
#include "definitions/_generic/_shared.hpp"
#include "definitions/hornbach/_shared.hpp"

namespace zhc::devices::hornbach {
namespace {
constexpr const char* kModels_D10011725[] = { "VIYU-A60-806-RGBW-10011725" };
}  // namespace

extern const PreparedDefinition kDef_D10011725{
    .zigbee_models=kModels_D10011725, .zigbee_models_count=sizeof(kModels_D10011725)/sizeof(kModels_D10011725[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="10011725", .vendor="Hornbach",
