...
// Tier 2: Hornbach 10454470 — graduated to shared CTLight bundle (added color_temp / 0x0300).
...
// z2m-source: hornbach.ts #10454470.
#include "definitions/_generic/_shared.hpp"
#include "definitions/hornbach/_shared.hpp"

namespace zhc::devices::hornbach {
namespace {
constexpr const char* kModels_D10454470[] = { "VIYU_GU10_350_CCT_10454470" };
}  // namespace

extern const PreparedDefinition kDef_D10454470{
    .zigbee_models=kModels_D10454470, .zigbee_models_count=sizeof(kModels_D10454470)/sizeof(kModels_D10454470[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="10454470", .vendor="Hornbach",
