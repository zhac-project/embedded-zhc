...
// Tier 2: Hornbach 10011722 — graduated to shared CTLight bundle (added color_temp / 0x0300).
...
// z2m-source: hornbach.ts #10011722.
#include "definitions/_generic/_shared.hpp"
#include "definitions/hornbach/_shared.hpp"

namespace zhc::devices::hornbach {
namespace {
constexpr const char* kModels_D10011722[] = { "VIYU-C35-470-CCT-10011722" };
}  // namespace

extern const PreparedDefinition kDef_D10011722{
    .zigbee_models=kModels_D10011722, .zigbee_models_count=sizeof(kModels_D10011722)/sizeof(kModels_D10011722[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="10011722", .vendor="Hornbach",
