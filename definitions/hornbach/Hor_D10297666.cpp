...
// Tier 2: Hornbach 10297666 — graduated to shared ColorCTLight bundle (added color + color_temp / 0x0300).
...
// z2m-source: hornbach.ts #10297666.
#include "definitions/_generic/_shared.hpp"
#include "definitions/hornbach/_shared.hpp"

namespace zhc::devices::hornbach {
namespace {
constexpr const char* kModels_D10297666[] = { "VIYU_GU10_350_RGBW_10297666" };
}  // namespace

extern const PreparedDefinition kDef_D10297666{
    .zigbee_models=kModels_D10297666, .zigbee_models_count=sizeof(kModels_D10297666)/sizeof(kModels_D10297666[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="10297666", .vendor="Hornbach",
