...
// Tier 2: Hive OTR1 — auto-generated.
// Single channel heating receiver
// z2m-source: hive.ts #OTR1.
...
namespace {
const FzConverter* const kFz_OTR1[] = {
    &::zhc::generic::kFzThermostat,
    &::zhc::hive::kFzHiveThermostatExtras,
};
const TzConverter* const kTz_OTR1[] = {
    &::zhc::generic::kTzThermostat,
};
constexpr const char* kModels_OTR1[] = { "OTR1" };
...
extern const PreparedDefinition kDef_OTR1{
    .zigbee_models=kModels_OTR1, .zigbee_models_count=sizeof(kModels_OTR1)/sizeof(kModels_OTR1[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="OTR1", .vendor="Hive",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_OTR1, .from_zigbee_count=sizeof(kFz_OTR1)/sizeof(kFz_OTR1[0]),
    .to_zigbee=kTz_OTR1, .to_zigbee_count=sizeof(kTz_OTR1)/sizeof(kTz_OTR1[0]),
