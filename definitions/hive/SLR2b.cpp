...
// Tier 2: Hive SLR2b — auto-generated.
// Dual channel heating and hot water thermostat
// z2m-source: hive.ts #SLR2b.
...
namespace {
const FzConverter* const kFz_SLR2b[] = {
    &::zhc::generic::kFzThermostat,
    &::zhc::hive::kFzHiveThermostatExtras,
};
const TzConverter* const kTz_SLR2b[] = {
    &::zhc::generic::kTzThermostat,
};
constexpr const char* kModels_SLR2b[] = { "SLR2b" };
...
extern const PreparedDefinition kDef_SLR2b{
    .zigbee_models=kModels_SLR2b, .zigbee_models_count=sizeof(kModels_SLR2b)/sizeof(kModels_SLR2b[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="SLR2b", .vendor="Hive",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_SLR2b, .from_zigbee_count=sizeof(kFz_SLR2b)/sizeof(kFz_SLR2b[0]),
    .to_zigbee=kTz_SLR2b, .to_zigbee_count=sizeof(kTz_SLR2b)/sizeof(kTz_SLR2b[0]),
