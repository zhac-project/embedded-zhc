...
// Tier 2: Hive SLR1d — auto-generated.
// Single channel receiver
// z2m-source: hive.ts #SLR1d.
...
namespace {
const FzConverter* const kFz_SLR1d[] = {
    &::zhc::generic::kFzThermostat,
    &::zhc::hive::kFzHiveThermostatExtras,
};
const TzConverter* const kTz_SLR1d[] = {
    &::zhc::generic::kTzThermostat,
};
constexpr const char* kModels_SLR1d[] = { "SLR1d" };
...
extern const PreparedDefinition kDef_SLR1d{
    .zigbee_models=kModels_SLR1d, .zigbee_models_count=sizeof(kModels_SLR1d)/sizeof(kModels_SLR1d[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="SLR1d", .vendor="Hive",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_SLR1d, .from_zigbee_count=sizeof(kFz_SLR1d)/sizeof(kFz_SLR1d[0]),
    .to_zigbee=kTz_SLR1d, .to_zigbee_count=sizeof(kTz_SLR1d)/sizeof(kTz_SLR1d[0]),
