...
constexpr const char* kModels_D74746[] = { "Panel Light 2x2 TW" };

}  // namespace

extern const PreparedDefinition kDef_D74746{
    .zigbee_models=kModels_D74746, .zigbee_models_count=sizeof(kModels_D74746)/sizeof(kModels_D74746[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="74746", .vendor="Ledvance",
