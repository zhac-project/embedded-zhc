...
// Tier 1: Ikea LED1837R5 — auto-generated.
// TRADFRI bulb GU10, warm white, 400 lm
// z2m-source: ikea.ts #LED1837R5.
...
constexpr const char* kModels_LED1837R5[] = { "TRADFRI bulb GU10 WW 400lm" };

}  // namespace

extern const PreparedDefinition kDef_LED1837R5{
    .zigbee_models=kModels_LED1837R5, .zigbee_models_count=sizeof(kModels_LED1837R5)/sizeof(kModels_LED1837R5[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="LED1837R5", .vendor="Ikea",
