...
// Tier 1: Ikea T2105 — auto-generated.
// STOFTMOLN ceiling/wall lamp, warm white, 10 cm
// z2m-source: ikea.ts #T2105.
...
constexpr const char* kModels_T2105[] = { "STOFTMOLN ceiling/wall lamp WW10" };

}  // namespace

extern const PreparedDefinition kDef_T2105{
    .zigbee_models=kModels_T2105, .zigbee_models_count=sizeof(kModels_T2105)/sizeof(kModels_T2105[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="T2105", .vendor="Ikea",
