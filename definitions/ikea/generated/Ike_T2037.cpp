...
// Tier 1: Ikea T2037 — auto-generated.
// STOFTMOLN ceiling/wall lamp, warm white, 37 cm
// z2m-source: ikea.ts #T2037.
...
constexpr const char* kModels_T2037[] = { "STOFTMOLN ceiling/wall lamp WW37" };

}  // namespace

extern const PreparedDefinition kDef_T2037{
    .zigbee_models=kModels_T2037, .zigbee_models_count=sizeof(kModels_T2037)/sizeof(kModels_T2037[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="T2037", .vendor="Ikea",
