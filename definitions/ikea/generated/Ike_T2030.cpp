...
// Tier 1: Ikea T2030 — auto-generated.
// PILSKOTT pendant lamp, warm white
// z2m-source: ikea.ts #T2030.
...
constexpr const char* kModels_T2030[] = { "Pendant lamp WW" };

}  // namespace

extern const PreparedDefinition kDef_T2030{
    .zigbee_models=kModels_T2030, .zigbee_models_count=sizeof(kModels_T2030)/sizeof(kModels_T2030[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="T2030", .vendor="Ikea",
