...
// Tier 1: Ikea LED2107C4 — auto-generated.
// TRADFRI bulb E14, white spectrum, candle, opal, 470 lm
// z2m-source: ikea.ts #LED2107C4.
...
constexpr const char* kModels_LED2107C4[] = { "TRADFRI bulb E14 WS candle 470lm", "TRADFRI bulb E12 WS candle 450lm" };

}  // namespace

extern const PreparedDefinition kDef_LED2107C4{
    .zigbee_models=kModels_LED2107C4, .zigbee_models_count=sizeof(kModels_LED2107C4)/sizeof(kModels_LED2107C4[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="LED2107C4", .vendor="Ikea",
