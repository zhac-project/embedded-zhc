...
// Tier 1: Ikea LED2104R3 — auto-generated.
// TRADFRI bulb GU10, warm white, 345/380 lm
// z2m-source: ikea.ts #LED2104R3.
...
constexpr const char* kModels_LED2104R3[] = { "\\u001aTRADFRI bulb GU10 WW 345lm", "TRADFRI bulb GU10 WW 345lm", "\\\\u001TRADFRI bulb GU10 WW 345lm", "\\u001aTRADFRI bulb GU10 WW 345lm8", "TRADFRI bulb GU10 WW 380lm" };

}  // namespace

extern const PreparedDefinition kDef_LED2104R3{
    .zigbee_models=kModels_LED2104R3, .zigbee_models_count=sizeof(kModels_LED2104R3)/sizeof(kModels_LED2104R3[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="LED2104R3", .vendor="Ikea",
