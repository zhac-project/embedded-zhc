...
// Tier 1: Ikea LED1650R5 — auto-generated.
// TRADFRI bulb GU10, white, 400 lm
// z2m-source: ikea.ts #LED1650R5.
...
constexpr const char* kModels_LED1650R5[] = { "TRADFRI bulb GU10 W 400lm" };

}  // namespace

extern const PreparedDefinition kDef_LED1650R5{
    .zigbee_models=kModels_LED1650R5, .zigbee_models_count=sizeof(kModels_LED1650R5)/sizeof(kModels_LED1650R5[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="LED1650R5", .vendor="Ikea",
