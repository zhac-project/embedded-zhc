...
constexpr const char* kModels_LED2109G6[] = { "TRADFRI bulb E26 CWS globe 800lm", "TRADFRI bulb E26 CWS globe 806lm", "TRADFRI bulb E26 CWS globe 810lm", "TRADFRI bulb E27 CWS globe 806lm" };

}  // namespace

extern const PreparedDefinition kDef_LED2109G6{
    .zigbee_models=kModels_LED2109G6, .zigbee_models_count=sizeof(kModels_LED2109G6)/sizeof(kModels_LED2109G6[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="LED2109G6", .vendor="Ikea",
