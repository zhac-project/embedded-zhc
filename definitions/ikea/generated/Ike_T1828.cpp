...
// Tier 1: Ikea T1828 — auto-generated.
// GUNNARP light panel, round
// z2m-source: ikea.ts #T1828.
...
constexpr const char* kModels_T1828[] = { "GUNNARP panel round" };

}  // namespace

extern const PreparedDefinition kDef_T1828{
    .zigbee_models=kModels_T1828, .zigbee_models_count=sizeof(kModels_T1828)/sizeof(kModels_T1828[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="T1828", .vendor="Ikea",
