...
// Tier 1: Ikea T2106 — auto-generated.
// STOFTMOLN ceiling/wall lamp, warm white, 15 cm
// z2m-source: ikea.ts #T2106.
...
constexpr const char* kModels_T2106[] = { "STOFTMOLN ceiling/wall lamp WW15" };

}  // namespace

extern const PreparedDefinition kDef_T2106{
    .zigbee_models=kModels_T2106, .zigbee_models_count=sizeof(kModels_T2106)/sizeof(kModels_T2106[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="T2106", .vendor="Ikea",
