...
constexpr const char* kAutoOpts_QUAD_ZIG_SW_action[] = {"single", "double", "triple", "hold", "release"};
// --- auto-generated exposes by zhac-tools/emit/emit_exposes.py (26.105.0): action ---
constexpr Expose kAutoExposes[] = {
    {"battery", ExposeType::Numeric, Access::State, "%", nullptr, nullptr, 0},
    {"voltage", ExposeType::Numeric, Access::State, "mV", nullptr, nullptr, 0},
    {"action", ExposeType::Enum, Access::State, nullptr, nullptr, kAutoOpts_QUAD_ZIG_SW_action, 5},
};
