...
// Tier 1: Paulmann 929.63 — hand-rewritten to use shared CTLight bundle.
// SmartHome Zigbee LED-Modul Coin 1x6W Tunable White
// z2m-source: paulmann.ts #929.63.
#include "definitions/_generic/_shared.hpp"
#include "definitions/paulmann/_shared.hpp"

namespace zhc::devices::paulmann {
namespace {
constexpr const char* kModels_D929_63[] = { "H036-0006" };
}  // namespace

extern const PreparedDefinition kDef_D929_63{
    .zigbee_models=kModels_D929_63, .zigbee_models_count=sizeof(kModels_D929_63)/sizeof(kModels_D929_63[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="929.63", .vendor="Paulmann",
