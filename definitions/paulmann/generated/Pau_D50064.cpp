...
// Tier 1: Paulmann 50064 — hand-rewritten to use shared CTLight bundle.
// SmartHome led spot
// z2m-source: paulmann.ts #50064.
#include "definitions/_generic/_shared.hpp"
#include "definitions/paulmann/_shared.hpp"

namespace zhc::devices::paulmann {
namespace {
constexpr const char* kModels_D50064[] = { "CCT light", "CCT_light", "CCT light ", "CCT Light", "CCT" };
}  // namespace

extern const PreparedDefinition kDef_D50064{
    .zigbee_models=kModels_D50064, .zigbee_models_count=sizeof(kModels_D50064)/sizeof(kModels_D50064[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="50064", .vendor="Paulmann",
