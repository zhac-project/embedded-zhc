...
// Tier 1: Paulmann 94842 — hand-rewritten to use shared CTLight bundle.
// Outdoor lighting Zigbee motion detector
// z2m-source: paulmann.ts #94842.
#include "definitions/_generic/_shared.hpp"
#include "definitions/paulmann/_shared.hpp"

namespace zhc::devices::paulmann {
namespace {
constexpr const char* kModels_D94842[] = { "94842" };
}  // namespace

extern const PreparedDefinition kDef_D94842{
    .zigbee_models=kModels_D94842, .zigbee_models_count=sizeof(kModels_D94842)/sizeof(kModels_D94842[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="94842", .vendor="Paulmann",
