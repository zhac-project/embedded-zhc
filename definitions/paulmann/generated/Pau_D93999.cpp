...
// Tier 1: Paulmann 93999 — hand-rewritten to use shared Light bundle.
// Plug Shine Zigbee controller
// z2m-source: paulmann.ts #93999.
#include "definitions/_generic/_shared.hpp"
#include "definitions/paulmann/_shared.hpp"

namespace zhc::devices::paulmann {
namespace {
constexpr const char* kModels_D93999[] = { "H036-0001", "Dimmable" };
}  // namespace

extern const PreparedDefinition kDef_D93999{
    .zigbee_models=kModels_D93999, .zigbee_models_count=sizeof(kModels_D93999)/sizeof(kModels_D93999[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="93999", .vendor="Paulmann",
