...
// Tier 1: Paulmann 150257 — hand-rewritten to use shared ColorLight bundle.
// SimpLED SmartHome dimmable RGB LED-stripe
// z2m-source: paulmann.ts #150257.
#include "definitions/_generic/_shared.hpp"
#include "definitions/paulmann/_shared.hpp"

namespace zhc::devices::paulmann {
namespace {
constexpr const char* kModels_D150257[] = { "RGB" };
}  // namespace

extern const PreparedDefinition kDef_D150257{
    .zigbee_models=kModels_D150257, .zigbee_models_count=sizeof(kModels_D150257)/sizeof(kModels_D150257[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="150257", .vendor="Paulmann",
