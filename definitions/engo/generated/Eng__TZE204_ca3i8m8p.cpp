...
// Auto-generated from z2m devices/engo.ts (fingerprint TS0601 / _TZE204_ca3i8m8p).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::engo {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_system_mode_dp2[] = {
    { 0, "heat" },
    { 1, "cool" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_running_state_dp3[] = {
    { 1, "heat" },
    { 2, "idle" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_sensor_choose_dp43[] = {
    { 0, "internal" },
    { 1, "floor_temp" },
    { 2, "external" },
    { 3, "external_on_off" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_preset_dp58[] = {
    { 0, "manual" },
    { 1, "schedule" },
    { 2, "holiday" },
    { 5, "frost" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_control_algorithm_dp101[] = {
    { 0, "TPI_UFH" },
    { 1, "TPI_RAD" },
    { 2, "TPI_ELE" },
    { 3, "HIS_02" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_relay_mode_dp108[] = {
    { 0, "NO" },
    { 1, "NC" },
    { 2, "OFF" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_temp_resolution_dp117[] = {
    { 0, "one" },
    { 1, "five" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_comfort_warm_floor_dp118[] = {
    { 0, "OFF" },
    { 1, "LEVEL1" },
    { 2, "LEVEL2" },
    { 3, "LEVEL3" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_sensor_error_dp120[] = {
    { 0, "normal" },
    { 1, "E1" },
    { 2, "E2" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_ca3i8m8p_valve_protection_dp122[] = {
    { 0, "off" },
    { 1, "on" },
    { 2, "anti_stop" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE204_ca3i8m8p[] = {
    { 1, "state", ::zhc::TuyaDpType::Bool, 1, nullptr, 0, 0 },
    { 2, "system_mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_system_mode_dp2, sizeof(kEnum__TZE204_ca3i8m8p_system_mode_dp2)/sizeof(kEnum__TZE204_ca3i8m8p_system_mode_dp2[0]) },
    { 3, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_running_state_dp3, sizeof(kEnum__TZE204_ca3i8m8p_running_state_dp3)/sizeof(kEnum__TZE204_ca3i8m8p_running_state_dp3[0]) },
    ...
    { 43, "sensor_choose", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_sensor_choose_dp43, sizeof(kEnum__TZE204_ca3i8m8p_sensor_choose_dp43)/sizeof(kEnum__TZE204_ca3i8m8p_sensor_choose_dp43[0]) },
    { 44, "backlight", ::zhc::TuyaDpType::Numeric, 1, nullptr, 0, 0 },
    { 58, "preset", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_preset_dp58, sizeof(kEnum__TZE204_ca3i8m8p_preset_dp58)/sizeof(kEnum__TZE204_ca3i8m8p_preset_dp58[0]) },
    { 101, "control_algorithm", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_control_algorithm_dp101, sizeof(kEnum__TZE204_ca3i8m8p_control_algorithm_dp101)/sizeof(kEnum__TZE204_ca3i8m8p_control_algorithm_dp101[0]) },
    ...
    { 108, "relay_mode", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_relay_mode_dp108, sizeof(kEnum__TZE204_ca3i8m8p_relay_mode_dp108)/sizeof(kEnum__TZE204_ca3i8m8p_relay_mode_dp108[0]) },
    ...
    { 117, "temp_resolution", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_temp_resolution_dp117, sizeof(kEnum__TZE204_ca3i8m8p_temp_resolution_dp117)/sizeof(kEnum__TZE204_ca3i8m8p_temp_resolution_dp117[0]) },
    { 118, "comfort_warm_floor", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_comfort_warm_floor_dp118, sizeof(kEnum__TZE204_ca3i8m8p_comfort_warm_floor_dp118)/sizeof(kEnum__TZE204_ca3i8m8p_comfort_warm_floor_dp118[0]) },
    { 120, "sensor_error", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_sensor_error_dp120, sizeof(kEnum__TZE204_ca3i8m8p_sensor_error_dp120)/sizeof(kEnum__TZE204_ca3i8m8p_sensor_error_dp120[0]) },
    { 122, "valve_protection", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_ca3i8m8p_valve_protection_dp122, sizeof(kEnum__TZE204_ca3i8m8p_valve_protection_dp122)/sizeof(kEnum__TZE204_ca3i8m8p_valve_protection_dp122[0]) },
};
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE204_ca3i8m8p{ kEntries__TZE204_ca3i8m8p, 34 };
constexpr FzConverter kFzDp__TZE204_ca3i8m8p{
    ...
    .user_config       = &kMap__TZE204_ca3i8m8p,
};
const FzConverter* const kFz__TZE204_ca3i8m8p[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE204_ca3i8m8p,
};
constexpr TzConverter kTzDp__TZE204_ca3i8m8p{
...
const TzConverter* const kTz__TZE204_ca3i8m8p[] = { &kTzDp__TZE204_ca3i8m8p };
constexpr const char* kM__TZE204_ca3i8m8p[] = { "TS0601" };
constexpr const char* kN__TZE204_ca3i8m8p[] = { "_TZE204_ca3i8m8p" };
}  // namespace
...
extern const PreparedDefinition kDefEng__TZE204_ca3i8m8p{
    ...
    .from_zigbee=kFz__TZE204_ca3i8m8p,
    .from_zigbee_count=sizeof(kFz__TZE204_ca3i8m8p)/sizeof(kFz__TZE204_ca3i8m8p[0]),
    .to_zigbee=kTz__TZE204_ca3i8m8p,
    .to_zigbee_count=sizeof(kTz__TZE204_ca3i8m8p)/sizeof(kTz__TZE204_ca3i8m8p[0]),
