...
// Auto-generated from z2m devices/engo.ts (fingerprint TS0601 / _TZE204_djurk6p5).
#include "definitions/tuya/_shared.hpp"
#include "definitions/tuya/extend.hpp"
namespace zhc::devices::engo {
namespace {

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_djurk6p5_running_state_dp3[] = {
    { 1, "heat" },
    { 3, "cool" },
};

constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_djurk6p5_sensor_choose_dp43[] = {
    { 0, "internal" },
    { 1, "floor" },
    { 2, "external" },
    { 3, "occupancy" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_djurk6p5_preset_dp58[] = {
    { 0, "manual" },
    { 1, "schedule" },
    { 2, "holiday" },
    { 3, "temporary" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_djurk6p5_control_algorithm_dp101[] = {
    { 0, "TPI_UFH" },
    { 1, "TPI_RAD" },
    { 2, "TPI_ELE" },
    { 3, "HIS_02" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_djurk6p5_warm_floor_dp118[] = {
    { 0, "OFF" },
    { 1, "7_min" },
    { 2, "11_min" },
    { 3, "15_min" },
...
constexpr ::zhc::tuya::TuyaEnumEntry kEnum__TZE204_djurk6p5_sensor_error_dp120[] = {
    { 0, "Normal" },
    { 1, "E1" },
    { 2, "E2" },
};

constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE204_djurk6p5[] = {
    { 3, "running_state", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_djurk6p5_running_state_dp3, sizeof(kEnum__TZE204_djurk6p5_running_state_dp3)/sizeof(kEnum__TZE204_djurk6p5_running_state_dp3[0]) },
    ...
    { 32, "holiday_temp_set", ::zhc::TuyaDpType::Numeric, 10, nullptr, 0, 0 },
    { 33, "holiday_days_set", ::zhc::TuyaDpType::Numeric, 1, nullptr, 0, 0 },
    ...
    { 43, "sensor_choose", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_djurk6p5_sensor_choose_dp43, sizeof(kEnum__TZE204_djurk6p5_sensor_choose_dp43)/sizeof(kEnum__TZE204_djurk6p5_sensor_choose_dp43[0]) },
    { 44, "brightness", ::zhc::TuyaDpType::Numeric, 1, nullptr, 0, 0 },
    { 58, "preset", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_djurk6p5_preset_dp58, sizeof(kEnum__TZE204_djurk6p5_preset_dp58)/sizeof(kEnum__TZE204_djurk6p5_preset_dp58[0]) },
    { 101, "control_algorithm", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_djurk6p5_control_algorithm_dp101, sizeof(kEnum__TZE204_djurk6p5_control_algorithm_dp101)/sizeof(kEnum__TZE204_djurk6p5_control_algorithm_dp101[0]) },
    ...
    { 118, "warm_floor", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_djurk6p5_warm_floor_dp118, sizeof(kEnum__TZE204_djurk6p5_warm_floor_dp118)/sizeof(kEnum__TZE204_djurk6p5_warm_floor_dp118[0]) },
    { 120, "sensor_error", ::zhc::TuyaDpType::Enum, 1, kEnum__TZE204_djurk6p5_sensor_error_dp120, sizeof(kEnum__TZE204_djurk6p5_sensor_error_dp120)/sizeof(kEnum__TZE204_djurk6p5_sensor_error_dp120[0]) },
};
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE204_djurk6p5{ kEntries__TZE204_djurk6p5, 26 };
constexpr FzConverter kFzDp__TZE204_djurk6p5{
    ...
    .user_config       = &kMap__TZE204_djurk6p5,
};
const FzConverter* const kFz__TZE204_djurk6p5[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE204_djurk6p5,
};
constexpr TzConverter kTzDp__TZE204_djurk6p5{
...
const TzConverter* const kTz__TZE204_djurk6p5[] = { &kTzDp__TZE204_djurk6p5 };
constexpr const char* kM__TZE204_djurk6p5[] = { "TS0601" };
constexpr const char* kN__TZE204_djurk6p5[] = { "_TZE204_djurk6p5" };
}  // namespace
...
constexpr Expose kAutoExposes[] = {
    ...
    {"holiday_temp_set", ExposeType::Numeric, Access::State, nullptr, nullptr, nullptr, 0},
    {"holiday_days_set", ExposeType::Numeric, Access::State, nullptr, nullptr, nullptr, 0},
    ...
    {"warm_floor", ExposeType::Binary, Access::StateSet, nullptr, nullptr, nullptr, 0},
...
extern const PreparedDefinition kDefEng__TZE204_djurk6p5{
    ...
    .from_zigbee=kFz__TZE204_djurk6p5,
    .from_zigbee_count=sizeof(kFz__TZE204_djurk6p5)/sizeof(kFz__TZE204_djurk6p5[0]),
    .to_zigbee=kTz__TZE204_djurk6p5,
    .to_zigbee_count=sizeof(kTz__TZE204_djurk6p5)/sizeof(kTz__TZE204_djurk6p5[0]),
