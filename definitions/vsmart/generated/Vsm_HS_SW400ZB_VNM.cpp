...
// Tier 2: VSmart HS-SW400ZB-VNM — uses shared vsmart converters.
// Wall switch 4 gang. PARTIAL coverage — see docs/VSMART_PARITY.md.
// z2m-source: vsmart.ts #HS-SW400ZB-VNM.
#include "definitions/_generic/_shared.hpp"
#include "definitions/vsmart/_shared.hpp"

namespace zhc::devices::vsmart {
namespace {
const FzConverter* const kFz_HS_SW400ZB_VNM[] = {
    &::zhc::generic::kFzOnOff,
};
const TzConverter* const kTz_HS_SW400ZB_VNM[] = {
...
constexpr const char* kModels_HS_SW400ZB_VNM[] = { "HS-SWL400ZB-VNM" };
...
constexpr ::zhc::EndpointLabel kEndpoints_HS_SW400ZB_VNM[] = { {"1", 1}, {"2", 2}, {"3", 3}, {"4", 4} };

}  // namespace

extern const PreparedDefinition kDef_HS_SW400ZB_VNM{
    .zigbee_models=kModels_HS_SW400ZB_VNM, .zigbee_models_count=sizeof(kModels_HS_SW400ZB_VNM)/sizeof(kModels_HS_SW400ZB_VNM[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="HS-SW400ZB-VNM", .vendor="VSmart",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_HS_SW400ZB_VNM, .from_zigbee_count=sizeof(kFz_HS_SW400ZB_VNM)/sizeof(kFz_HS_SW400ZB_VNM[0]),
    .to_zigbee=kTz_HS_SW400ZB_VNM, .to_zigbee_count=sizeof(kTz_HS_SW400ZB_VNM)/sizeof(kTz_HS_SW400ZB_VNM[0]),
    .configure=nullptr, .on_event=nullptr,
    .bindings=kAutoBindings, .bindings_count=sizeof(kAutoBindings)/sizeof(kAutoBindings[0]),
    .endpoint_map       = kEndpoints_HS_SW400ZB_VNM,
    .endpoint_map_count = sizeof(kEndpoints_HS_SW400ZB_VNM)/sizeof(kEndpoints_HS_SW400ZB_VNM[0]),
};
