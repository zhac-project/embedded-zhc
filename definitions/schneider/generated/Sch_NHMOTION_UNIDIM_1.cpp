...
// Tier 1: Schneider NHMOTION/UNIDIM/1 — auto-generated.
// Motion sensor with dimmer
// z2m-source: schneider.ts #NHMOTION/UNIDIM/1.
#include "definitions/_generic/_shared.hpp"

namespace zhc::devices::schneider {
namespace {
const FzConverter* const kFz_NHMOTION_UNIDIM_1[] = {
    &::zhc::generic::kFzOnOff,
    &::zhc::generic::kFzBrightness,
};
const TzConverter* const kTz_NHMOTION_UNIDIM_1[] = {
    &::zhc::generic::kTzOnOff,
    &::zhc::generic::kTzBrightness,
};
constexpr const char* kModels_NHMOTION_UNIDIM_1[] = { "NHMOTION/UNIDIM/1" };
