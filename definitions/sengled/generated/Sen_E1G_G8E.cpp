...
// Tier 1: Sengled E1G-G8E — hand-rewritten 2026-04-28.
// Multicolor light strip (2M)
// z2m-source: sengled.ts #E1G-G8E.
...
constexpr const char* kModels_E1G_G8E[] = { "E1G-G8E" };

}  // namespace

extern const PreparedDefinition kDef_E1G_G8E{
    .zigbee_models=kModels_E1G_G8E, .zigbee_models_count=sizeof(kModels_E1G_G8E)/sizeof(kModels_E1G_G8E[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="E1G-G8E", .vendor="Sengled",
