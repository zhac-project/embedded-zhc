...
// Tier 1: Sengled E22-N1E — hand-rewritten 2026-04-28.
// Smart LED multicolor BR30 bulb
// z2m-source: sengled.ts #E22-N1E.
...
namespace {
constexpr const char* kModels_E22_N1E[] = { "E22-N1E" };
}  // namespace

extern const PreparedDefinition kDef_E22_N1E{
    .zigbee_models=kModels_E22_N1E, .zigbee_models_count=sizeof(kModels_E22_N1E)/sizeof(kModels_E22_N1E[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="E22-N1E", .vendor="Sengled",
