...
// Tier 1: Sengled E21-N1EA — hand-rewritten 2026-04-28.
// Smart LED multicolor A19 bulb
// z2m-source: sengled.ts #E21-N1EA.
...
namespace {
constexpr const char* kModels_E21_N1EA[] = { "E21-N1EA" };
}  // namespace

extern const PreparedDefinition kDef_E21_N1EA{
    .zigbee_models=kModels_E21_N1EA, .zigbee_models_count=sizeof(kModels_E21_N1EA)/sizeof(kModels_E21_N1EA[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="E21-N1EA", .vendor="Sengled",
