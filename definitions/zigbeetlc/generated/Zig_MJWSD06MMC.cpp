...
// Tier 2: Zigbeetlc MJWSD06MMC — uses shared zigbeetlc converters.
// Temperature and Humidity Monitor 3 Mini (pvxx/ZigbeeTLc)
// z2m-source: zigbeetlc.ts #MJWSD06MMC.
#include "definitions/_generic/_shared.hpp"
#include "definitions/zigbeetlc/_shared.hpp"

namespace zhc::devices::zigbeetlc {
namespace {
constexpr const char* kModels_MJWSD06MMC[] = { "MJWSD06MMC-z", "MJWSD06MMC-bz" };
}  // namespace

extern const PreparedDefinition kDef_MJWSD06MMC{
    .zigbee_models=kModels_MJWSD06MMC, .zigbee_models_count=sizeof(kModels_MJWSD06MMC)/sizeof(kModels_MJWSD06MMC[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="MJWSD06MMC", .vendor="Xiaomi",
    .meta=nullptr,
