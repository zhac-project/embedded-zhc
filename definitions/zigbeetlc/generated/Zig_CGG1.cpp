...
// Tier 2: Zigbeetlc CGG1 — uses shared zigbeetlc converters.
// Temp & RH Monitor (pvxx/ZigbeeTLc)
// z2m-source: zigbeetlc.ts #CGG1.
#include "definitions/_generic/_shared.hpp"
#include "definitions/zigbeetlc/_shared.hpp"

namespace zhc::devices::zigbeetlc {
namespace {
constexpr const char* kModels_CGG1[] = { "CGG1-z", "CGG1-bz", "CGG1N-z", "CGG1N-bz" };
}  // namespace

extern const PreparedDefinition kDef_CGG1{
    .zigbee_models=kModels_CGG1, .zigbee_models_count=sizeof(kModels_CGG1)/sizeof(kModels_CGG1[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="CGG1", .vendor="Qingping",
    .meta=nullptr,
