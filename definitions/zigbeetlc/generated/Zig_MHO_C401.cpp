...
// Tier 2: Zigbeetlc MHO-C401 — uses shared zigbeetlc converters.
// Temperature and Humidity Monitor (pvxx/ZigbeeTLc)
// z2m-source: zigbeetlc.ts #MHO-C401.
#include "definitions/_generic/_shared.hpp"
#include "definitions/zigbeetlc/_shared.hpp"

namespace zhc::devices::zigbeetlc {
namespace {
constexpr const char* kModels_MHO_C401[] = { "MHO-C401-z", "MHO-C401-bz", "MHO-C401N-z", "MHO-C401N-bz" };
}  // namespace

extern const PreparedDefinition kDef_MHO_C401{
    .zigbee_models=kModels_MHO_C401, .zigbee_models_count=sizeof(kModels_MHO_C401)/sizeof(kModels_MHO_C401[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="MHO-C401", .vendor="MiaoMiaoCe",
    .meta=nullptr,
