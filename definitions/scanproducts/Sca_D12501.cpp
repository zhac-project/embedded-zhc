...
extern const PreparedDefinition kDef_D12501{
    .zigbee_models=kModels_D12501, .zigbee_models_count=sizeof(kModels_D12501)/sizeof(kModels_D12501[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="12501", .vendor="Scanproducts",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_D12501, .from_zigbee_count=sizeof(kFz_D12501)/sizeof(kFz_D12501[0]),
    .to_zigbee=kTz_D12501, .to_zigbee_count=sizeof(kTz_D12501)/sizeof(kTz_D12501[0]),
