...
// Tier 1: Gledopto GL-D-006P — auto-generated.
// Zigbee 6W anti-glare downlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-D-006P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_D_006P[] = { "GL-D-006P" };
}  // namespace

extern const PreparedDefinition kDef_GL_D_006P{
    .zigbee_models=kModels_GL_D_006P,
    .zigbee_models_count=sizeof(kModels_GL_D_006P)/sizeof(kModels_GL_D_006P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-D-006P", .vendor="Gledopto",
    .meta=nullptr,
