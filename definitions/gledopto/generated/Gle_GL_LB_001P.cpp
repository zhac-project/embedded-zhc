...
// Tier 1: Gledopto GL-LB-001P — auto-generated.
// Zigbee USB LED bar RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-LB-001P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_LB_001P[] = { "GL-LB-001P" };
}  // namespace

extern const PreparedDefinition kDef_GL_LB_001P{
    .zigbee_models=kModels_GL_LB_001P,
    .zigbee_models_count=sizeof(kModels_GL_LB_001P)/sizeof(kModels_GL_LB_001P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-LB-001P", .vendor="Gledopto",
    .meta=nullptr,
