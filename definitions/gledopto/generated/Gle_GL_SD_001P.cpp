...
// Tier 1: Gledopto GL-SD-001P — auto-generated.
// Triac-dimmer
// z2m-source: gledopto.ts #GL-SD-001P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_SD_001P[] = { "GL-SD-001P" };
}  // namespace

extern const PreparedDefinition kDef_GL_SD_001P{
    .zigbee_models=kModels_GL_SD_001P,
    .zigbee_models_count=sizeof(kModels_GL_SD_001P)/sizeof(kModels_GL_SD_001P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-SD-001P", .vendor="Gledopto",
    .meta=nullptr,
