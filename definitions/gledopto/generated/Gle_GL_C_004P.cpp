...
// Tier 1: Gledopto GL-C-004P — auto-generated.
// Zigbee LED Strip Light Kit
// z2m-source: gledopto.ts #GL-C-004P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_C_004P[] = { "GL-C-004P" };
}  // namespace

extern const PreparedDefinition kDef_GL_C_004P{
    .zigbee_models=kModels_GL_C_004P,
    .zigbee_models_count=sizeof(kModels_GL_C_004P)/sizeof(kModels_GL_C_004P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-C-004P", .vendor="Gledopto",
    .meta=nullptr,
