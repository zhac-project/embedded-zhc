...
// Tier 1: Gledopto GL-B-007Z — auto-generated.
// Zigbee 6W E26/E27 Bulb RGB+CCT
// z2m-source: gledopto.ts #GL-B-007Z.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_B_007Z[] = { "GL-B-007Z" };
}  // namespace

extern const PreparedDefinition kDef_GL_B_007Z{
    .zigbee_models=kModels_GL_B_007Z,
    .zigbee_models_count=sizeof(kModels_GL_B_007Z)/sizeof(kModels_GL_B_007Z[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-B-007Z", .vendor="Gledopto",
    .meta=nullptr,
