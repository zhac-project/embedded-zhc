...
// Tier 1: Gledopto GL-G-005P — auto-generated.
// Zigbee 7W garden light Pro RGB+CCT
// z2m-source: gledopto.ts #GL-G-005P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_G_005P[] = { "GL-G-005P" };
}  // namespace

extern const PreparedDefinition kDef_GL_G_005P{
    .zigbee_models=kModels_GL_G_005P,
    .zigbee_models_count=sizeof(kModels_GL_G_005P)/sizeof(kModels_GL_G_005P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-G-005P", .vendor="Gledopto",
    .meta=nullptr,
