...
// Tier 1: Gledopto GL-D-004P — auto-generated.
// Zigbee 9W Downlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-D-004P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_D_004P[] = { "GL-D-004P" };
}  // namespace

extern const PreparedDefinition kDef_GL_D_004P{
    .zigbee_models=kModels_GL_D_004P,
    .zigbee_models_count=sizeof(kModels_GL_D_004P)/sizeof(kModels_GL_D_004P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-D-004P", .vendor="Gledopto",
    .meta=nullptr,
