...
// Tier 1: Gledopto GL-S-004P — auto-generated.
// Zigbee 4W MR16 Bulb RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-S-004P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_S_004P[] = { "GL-S-004P", "GL-S-005P" };
}  // namespace

extern const PreparedDefinition kDef_GL_S_004P{
    .zigbee_models=kModels_GL_S_004P,
    .zigbee_models_count=sizeof(kModels_GL_S_004P)/sizeof(kModels_GL_S_004P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-S-004P", .vendor="Gledopto",
    .meta=nullptr,
