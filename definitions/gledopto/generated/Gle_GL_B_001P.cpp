...
// Tier 1: Gledopto GL-B-001P — auto-generated.
// Zigbee 4W E12/E14 Bulb RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-B-001P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_B_001P[] = { "GL-B-001P" };
}  // namespace

extern const PreparedDefinition kDef_GL_B_001P{
    .zigbee_models=kModels_GL_B_001P,
    .zigbee_models_count=sizeof(kModels_GL_B_001P)/sizeof(kModels_GL_B_001P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-B-001P", .vendor="Gledopto",
    .meta=nullptr,
