...
// Tier 1: Gledopto GL-FL-004P — auto-generated.
// Zigbee 10W Floodlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-FL-004P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_FL_004P[] = { "GL-FL-004P", "GL-FL-004TZP" };
}  // namespace

extern const PreparedDefinition kDef_GL_FL_004P{
    .zigbee_models=kModels_GL_FL_004P,
    .zigbee_models_count=sizeof(kModels_GL_FL_004P)/sizeof(kModels_GL_FL_004P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-FL-004P", .vendor="Gledopto",
    .meta=nullptr,
