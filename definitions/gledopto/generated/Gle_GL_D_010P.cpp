...
// Tier 1: Gledopto GL-D-010P — auto-generated.
// Zigbee 12W Downlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-D-010P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_D_010P[] = { "GL-D-010P" };
}  // namespace

extern const PreparedDefinition kDef_GL_D_010P{
    .zigbee_models=kModels_GL_D_010P,
    .zigbee_models_count=sizeof(kModels_GL_D_010P)/sizeof(kModels_GL_D_010P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-D-010P", .vendor="Gledopto",
    .meta=nullptr,
