...
// Tier 1: Gledopto GL-C-006 — auto-generated.
// Zigbee LED Controller WW/CW
// z2m-source: gledopto.ts #GL-C-006.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_C_006[] = { "GL-C-006" };
}  // namespace

extern const PreparedDefinition kDef_GL_C_006{
    .zigbee_models=kModels_GL_C_006,
    .zigbee_models_count=sizeof(kModels_GL_C_006)/sizeof(kModels_GL_C_006[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-C-006", .vendor="Gledopto",
    .meta=nullptr,
