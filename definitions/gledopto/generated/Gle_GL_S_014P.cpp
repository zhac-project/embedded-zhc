...
// Tier 1: Gledopto GL-S-014P — auto-generated.
// Zigbee 5W MR16 bulb RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-S-014P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_S_014P[] = { "GL-S-014P" };
}  // namespace

extern const PreparedDefinition kDef_GL_S_014P{
    .zigbee_models=kModels_GL_S_014P,
    .zigbee_models_count=sizeof(kModels_GL_S_014P)/sizeof(kModels_GL_S_014P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-S-014P", .vendor="Gledopto",
    .meta=nullptr,
