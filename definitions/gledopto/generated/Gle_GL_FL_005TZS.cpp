...
// Tier 1: Gledopto GL-FL-005TZS — auto-generated.
// Zigbee 30W Floodlight RGB+CCT (plus)
// z2m-source: gledopto.ts #GL-FL-005TZS.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_FL_005TZS[] = { "GL-FL-005TZS" };
}  // namespace

extern const PreparedDefinition kDef_GL_FL_005TZS{
    .zigbee_models=kModels_GL_FL_005TZS,
    .zigbee_models_count=sizeof(kModels_GL_FL_005TZS)/sizeof(kModels_GL_FL_005TZS[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-FL-005TZS", .vendor="Gledopto",
    .meta=nullptr,
