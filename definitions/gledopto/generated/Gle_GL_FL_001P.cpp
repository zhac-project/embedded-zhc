...
// Tier 1: Gledopto GL-FL-001P — auto-generated.
// Zigbee 10W Floodlight RGB+CCT 12V Low Voltage (pro)
// z2m-source: gledopto.ts #GL-FL-001P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_FL_001P[] = { "GL-FL-001P" };
}  // namespace

extern const PreparedDefinition kDef_GL_FL_001P{
    .zigbee_models=kModels_GL_FL_001P,
    .zigbee_models_count=sizeof(kModels_GL_FL_001P)/sizeof(kModels_GL_FL_001P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-FL-001P", .vendor="Gledopto",
    .meta=nullptr,
