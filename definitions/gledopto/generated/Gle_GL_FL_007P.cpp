...
// Tier 1: Gledopto GL-FL-007P — auto-generated.
// Zigbee 100W Floodlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-FL-007P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_FL_007P[] = { "GL-FL-007P" };
}  // namespace

extern const PreparedDefinition kDef_GL_FL_007P{
    .zigbee_models=kModels_GL_FL_007P,
    .zigbee_models_count=sizeof(kModels_GL_FL_007P)/sizeof(kModels_GL_FL_007P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-FL-007P", .vendor="Gledopto",
    .meta=nullptr,
