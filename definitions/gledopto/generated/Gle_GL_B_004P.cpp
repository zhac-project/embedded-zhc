...
// Tier 1: Gledopto GL-B-004P — auto-generated.
// Filament LED light bulb E27 G95 7W pro
// z2m-source: gledopto.ts #GL-B-004P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_B_004P[] = { "GL-B-004P" };
}  // namespace

extern const PreparedDefinition kDef_GL_B_004P{
    .zigbee_models=kModels_GL_B_004P,
    .zigbee_models_count=sizeof(kModels_GL_B_004P)/sizeof(kModels_GL_B_004P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-B-004P", .vendor="Gledopto",
    .meta=nullptr,
