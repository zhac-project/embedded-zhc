...
// Tier 1: Gledopto GL-G-007Z — auto-generated.
// Zigbee 9W garden lamp RGB+CCT
// z2m-source: gledopto.ts #GL-G-007Z.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_G_007Z[] = { "GL-G-007Z" };
}  // namespace

extern const PreparedDefinition kDef_GL_G_007Z{
    .zigbee_models=kModels_GL_G_007Z,
    .zigbee_models_count=sizeof(kModels_GL_G_007Z)/sizeof(kModels_GL_G_007Z[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-G-007Z", .vendor="Gledopto",
    .meta=nullptr,
