...
// Tier 1: Gledopto GL-MC-002P — auto-generated.
// Zigbee USB Mini LED Controller RGB+CCT (Pro)
// z2m-source: gledopto.ts #GL-MC-002P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_MC_002P[] = { "GL-MC-002P" };
}  // namespace

extern const PreparedDefinition kDef_GL_MC_002P{
    .zigbee_models=kModels_GL_MC_002P,
    .zigbee_models_count=sizeof(kModels_GL_MC_002P)/sizeof(kModels_GL_MC_002P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-MC-002P", .vendor="Gledopto",
    .meta=nullptr,
