...
// Tier 1: Gledopto GL-D-015P — auto-generated.
// Zigbee 12W Downlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-D-015P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_D_015P[] = { "GL-D-015P" };
}  // namespace

extern const PreparedDefinition kDef_GL_D_015P{
    .zigbee_models=kModels_GL_D_015P,
    .zigbee_models_count=sizeof(kModels_GL_D_015P)/sizeof(kModels_GL_D_015P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-D-015P", .vendor="Gledopto",
    .meta=nullptr,
