...
// Tier 1: Gledopto GL-C-103P — auto-generated.
// Zigbee LED controller (pro)
// z2m-source: gledopto.ts #GL-C-103P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_C_103P[] = { "GL-C-103P" };
}  // namespace

extern const PreparedDefinition kDef_GL_C_103P{
    .zigbee_models=kModels_GL_C_103P,
    .zigbee_models_count=sizeof(kModels_GL_C_103P)/sizeof(kModels_GL_C_103P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-C-103P", .vendor="Gledopto",
    .meta=nullptr,
