...
// Tier 1: Gledopto GL-G-001Z — auto-generated.
// Zigbee 12W Garden Lamp RGB+CCT
// z2m-source: gledopto.ts #GL-G-001Z.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_G_001Z[] = { "GL-G-001Z" };
}  // namespace

extern const PreparedDefinition kDef_GL_G_001Z{
    .zigbee_models=kModels_GL_G_001Z,
    .zigbee_models_count=sizeof(kModels_GL_G_001Z)/sizeof(kModels_GL_G_001Z[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-G-001Z", .vendor="Gledopto",
    .meta=nullptr,
