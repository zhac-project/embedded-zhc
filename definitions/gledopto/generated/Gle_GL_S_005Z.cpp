...
// Tier 1: Gledopto GL-S-005Z — auto-generated.
// Zigbee 4W MR16 Bulb 120deg RGB+CCT
// z2m-source: gledopto.ts #GL-S-005Z.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_S_005Z[] = { "GL-S-005Z" };
}  // namespace

extern const PreparedDefinition kDef_GL_S_005Z{
    .zigbee_models=kModels_GL_S_005Z,
    .zigbee_models_count=sizeof(kModels_GL_S_005Z)/sizeof(kModels_GL_S_005Z[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-S-005Z", .vendor="Gledopto",
    .meta=nullptr,
