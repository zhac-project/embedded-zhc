...
// Tier 1: Gledopto GL-D-003Z — auto-generated.
// Zigbee 6W Downlight RGB+CCT
// z2m-source: gledopto.ts #GL-D-003Z.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_D_003Z[] = { "GL-D-003Z" };
}  // namespace

extern const PreparedDefinition kDef_GL_D_003Z{
    .zigbee_models=kModels_GL_D_003Z,
    .zigbee_models_count=sizeof(kModels_GL_D_003Z)/sizeof(kModels_GL_D_003Z[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-D-003Z", .vendor="Gledopto",
    .meta=nullptr,
