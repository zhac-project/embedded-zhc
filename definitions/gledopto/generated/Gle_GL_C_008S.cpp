...
// Tier 1: Gledopto GL-C-008S — auto-generated.
// Zigbee LED Controller RGB+CCT (plus)
// z2m-source: gledopto.ts #GL-C-008S.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_C_008S[] = { "GL-C-008S" };
}  // namespace

extern const PreparedDefinition kDef_GL_C_008S{
    .zigbee_models=kModels_GL_C_008S,
    .zigbee_models_count=sizeof(kModels_GL_C_008S)/sizeof(kModels_GL_C_008S[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-C-008S", .vendor="Gledopto",
    .meta=nullptr,
