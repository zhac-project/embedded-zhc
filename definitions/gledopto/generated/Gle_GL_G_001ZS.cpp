...
// Tier 1: Gledopto GL-G-001ZS — auto-generated.
// Zigbee 12W Garden Lamp RGB+CCT (plus)
// z2m-source: gledopto.ts #GL-G-001ZS.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_G_001ZS[] = { "GL-G-001ZS" };
}  // namespace

extern const PreparedDefinition kDef_GL_G_001ZS{
    .zigbee_models=kModels_GL_G_001ZS,
    .zigbee_models_count=sizeof(kModels_GL_G_001ZS)/sizeof(kModels_GL_G_001ZS[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-G-001ZS", .vendor="Gledopto",
    .meta=nullptr,
