...
// Tier 1: Gledopto GL-G-101P — auto-generated.
// Zigbee 12W garden lamp RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-G-101P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_G_101P[] = { "GL-G-101P" };
}  // namespace

extern const PreparedDefinition kDef_GL_G_101P{
    .zigbee_models=kModels_GL_G_101P,
    .zigbee_models_count=sizeof(kModels_GL_G_101P)/sizeof(kModels_GL_G_101P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-G-101P", .vendor="Gledopto",
    .meta=nullptr,
