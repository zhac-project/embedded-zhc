...
// Tier 1: Gledopto GL-G-002P — auto-generated.
// Zigbee 7W garden lamp RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-G-002P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_G_002P[] = { "GL-G-002P" };
}  // namespace

extern const PreparedDefinition kDef_GL_G_002P{
    .zigbee_models=kModels_GL_G_002P,
    .zigbee_models_count=sizeof(kModels_GL_G_002P)/sizeof(kModels_GL_G_002P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-G-002P", .vendor="Gledopto",
    .meta=nullptr,
