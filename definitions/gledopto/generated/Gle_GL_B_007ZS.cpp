...
// Tier 1: Gledopto GL-B-007ZS — auto-generated.
// Zigbee 6W E26/E27 Bulb RGB+CCT (plus)
// z2m-source: gledopto.ts #GL-B-007ZS.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_B_007ZS[] = { "GL-B-007ZS" };
}  // namespace

extern const PreparedDefinition kDef_GL_B_007ZS{
    .zigbee_models=kModels_GL_B_007ZS,
    .zigbee_models_count=sizeof(kModels_GL_B_007ZS)/sizeof(kModels_GL_B_007ZS[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-B-007ZS", .vendor="Gledopto",
    .meta=nullptr,
