...
// Tier 1: Gledopto GL-FL-005P — auto-generated.
// Zigbee 30W Floodlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-FL-005P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_FL_005P[] = { "GL-FL-005P", "GL-FL-005TZP" };
}  // namespace

extern const PreparedDefinition kDef_GL_FL_005P{
    .zigbee_models=kModels_GL_FL_005P,
    .zigbee_models_count=sizeof(kModels_GL_FL_005P)/sizeof(kModels_GL_FL_005P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-FL-005P", .vendor="Gledopto",
    .meta=nullptr,
