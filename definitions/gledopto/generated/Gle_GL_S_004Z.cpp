...
// Tier 1: Gledopto GL-S-004Z — auto-generated.
// Zigbee 4W MR16 Bulb 30deg RGB+CCT
// z2m-source: gledopto.ts #GL-S-004Z.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_S_004Z[] = { "GL-S-004Z" };
}  // namespace

extern const PreparedDefinition kDef_GL_S_004Z{
    .zigbee_models=kModels_GL_S_004Z,
    .zigbee_models_count=sizeof(kModels_GL_S_004Z)/sizeof(kModels_GL_S_004Z[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-S-004Z", .vendor="Gledopto",
    .meta=nullptr,
