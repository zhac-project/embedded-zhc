...
// Tier 1: Gledopto GL-W-001Z — auto-generated.
// Zigbee on/off wall switch
// z2m-source: gledopto.ts #GL-W-001Z.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_W_001Z[] = { "GL-W-001Z" };
}  // namespace

extern const PreparedDefinition kDef_GL_W_001Z{
    .zigbee_models=kModels_GL_W_001Z,
    .zigbee_models_count=sizeof(kModels_GL_W_001Z)/sizeof(kModels_GL_W_001Z[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-W-001Z", .vendor="Gledopto",
    .meta=nullptr,
