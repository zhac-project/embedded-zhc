...
// Tier 1: Gledopto GL-SD-002 — auto-generated.
// Zigbee 3.0 smart home switch
// z2m-source: gledopto.ts #GL-SD-002.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_SD_002[] = { "GL-SD-002" };
}  // namespace

extern const PreparedDefinition kDef_GL_SD_002{
    .zigbee_models=kModels_GL_SD_002,
    .zigbee_models_count=sizeof(kModels_GL_SD_002)/sizeof(kModels_GL_SD_002[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-SD-002", .vendor="Gledopto",
    .meta=nullptr,
