...
// Tier 1: Gledopto GL-D-013P — auto-generated.
// Zigbee 6W Downlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-D-013P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_D_013P[] = { "GL-D-013P" };
}  // namespace

extern const PreparedDefinition kDef_GL_D_013P{
    .zigbee_models=kModels_GL_D_013P,
    .zigbee_models_count=sizeof(kModels_GL_D_013P)/sizeof(kModels_GL_D_013P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-D-013P", .vendor="Gledopto",
    .meta=nullptr,
