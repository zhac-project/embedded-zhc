...
// Tier 1: Gledopto GL-FL-006TZS — auto-generated.
// Zigbee 60W Floodlight RGB+CCT (plus)
// z2m-source: gledopto.ts #GL-FL-006TZS.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_FL_006TZS[] = { "GL-FL-006TZS" };
}  // namespace

extern const PreparedDefinition kDef_GL_FL_006TZS{
    .zigbee_models=kModels_GL_FL_006TZS,
    .zigbee_models_count=sizeof(kModels_GL_FL_006TZS)/sizeof(kModels_GL_FL_006TZS[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-FL-006TZS", .vendor="Gledopto",
    .meta=nullptr,
