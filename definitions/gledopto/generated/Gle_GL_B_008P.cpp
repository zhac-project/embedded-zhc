...
// Tier 1: Gledopto GL-B-008P — auto-generated.
// Zigbee 12W E26/E27 Bulb RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-B-008P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_B_008P[] = { "GL-B-008P" };
}  // namespace

extern const PreparedDefinition kDef_GL_B_008P{
    .zigbee_models=kModels_GL_B_008P,
    .zigbee_models_count=sizeof(kModels_GL_B_008P)/sizeof(kModels_GL_B_008P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-B-008P", .vendor="Gledopto",
    .meta=nullptr,
