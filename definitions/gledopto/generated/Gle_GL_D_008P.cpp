...
// Tier 1: Gledopto GL-D-008P — auto-generated.
// Na Versiion smart led 9w downlight
// z2m-source: gledopto.ts #GL-D-008P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_D_008P[] = { "GL-D-008P" };
}  // namespace

extern const PreparedDefinition kDef_GL_D_008P{
    .zigbee_models=kModels_GL_D_008P,
    .zigbee_models_count=sizeof(kModels_GL_D_008P)/sizeof(kModels_GL_D_008P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-D-008P", .vendor="Gledopto",
    .meta=nullptr,
