...
// Tier 1: Gledopto GL-S-008Z — auto-generated.
// Zigbee 5W PAR16 Bulb RGB+CCT
// z2m-source: gledopto.ts #GL-S-008Z.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_S_008Z[] = { "GL-S-008Z" };
}  // namespace

extern const PreparedDefinition kDef_GL_S_008Z{
    .zigbee_models=kModels_GL_S_008Z,
    .zigbee_models_count=sizeof(kModels_GL_S_008Z)/sizeof(kModels_GL_S_008Z[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-S-008Z", .vendor="Gledopto",
    .meta=nullptr,
