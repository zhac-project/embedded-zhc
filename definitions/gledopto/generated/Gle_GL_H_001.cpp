...
// Tier 1: Gledopto GL-H-001 — auto-generated.
// Zigbee RF Hub
// z2m-source: gledopto.ts #GL-H-001.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_H_001[] = { "GL-H-001" };
}  // namespace

extern const PreparedDefinition kDef_GL_H_001{
    .zigbee_models=kModels_GL_H_001,
    .zigbee_models_count=sizeof(kModels_GL_H_001)/sizeof(kModels_GL_H_001[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-H-001", .vendor="Gledopto",
    .meta=nullptr,
