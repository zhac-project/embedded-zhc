...
// Tier 1: Gledopto GL-C-009 — auto-generated.
// Zigbee LED Controller W
// z2m-source: gledopto.ts #GL-C-009.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_C_009[] = { "GL-C-009" };
}  // namespace

extern const PreparedDefinition kDef_GL_C_009{
    .zigbee_models=kModels_GL_C_009,
    .zigbee_models_count=sizeof(kModels_GL_C_009)/sizeof(kModels_GL_C_009[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-C-009", .vendor="Gledopto",
    .meta=nullptr,
