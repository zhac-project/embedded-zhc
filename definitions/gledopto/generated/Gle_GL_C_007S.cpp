...
// Tier 1: Gledopto GL-C-007S — auto-generated.
// Zigbee LED Controller RGBW (plus)
// z2m-source: gledopto.ts #GL-C-007S.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_C_007S[] = { "GL-C-007S" };
}  // namespace

extern const PreparedDefinition kDef_GL_C_007S{
    .zigbee_models=kModels_GL_C_007S,
    .zigbee_models_count=sizeof(kModels_GL_C_007S)/sizeof(kModels_GL_C_007S[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-C-007S", .vendor="Gledopto",
    .meta=nullptr,
