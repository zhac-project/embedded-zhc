...
// Tier 1: Gledopto GL-C-007-2ID — auto-generated.
// Zigbee LED Controller RGBW (2 ID)
// z2m-source: gledopto.ts #GL-C-007-2ID.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_C_007_2ID[] = { "GL-C-007-2ID" };
}  // namespace

extern const PreparedDefinition kDef_GL_C_007_2ID{
    .zigbee_models=kModels_GL_C_007_2ID,
    .zigbee_models_count=sizeof(kModels_GL_C_007_2ID)/sizeof(kModels_GL_C_007_2ID[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-C-007-2ID", .vendor="Gledopto",
    .meta=nullptr,
