...
// Tier 1: Gledopto GL-FL-006P — auto-generated.
// Zigbee 60W Floodlight RGB+CCT (pro)
// z2m-source: gledopto.ts #GL-FL-006P.
#include "definitions/_generic/_shared.hpp"
#include "definitions/gledopto/_shared.hpp"

namespace zhc::devices::gledopto {
namespace {
constexpr const char* kModels_GL_FL_006P[] = { "GL-FL-006P", "GL-FL-006TZP" };
}  // namespace

extern const PreparedDefinition kDef_GL_FL_006P{
    .zigbee_models=kModels_GL_FL_006P,
    .zigbee_models_count=sizeof(kModels_GL_FL_006P)/sizeof(kModels_GL_FL_006P[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="GL-FL-006P", .vendor="Gledopto",
    .meta=nullptr,
