...
// Tier 3: Aqara ZNCLDJ14LM roller shade.
// z2m-source: lumi.ts #ZNCLDJ14LM (lumi.curtain.acn002).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzLumiCurtainPosition };
constexpr const char* kModels[] = { "lumi.curtain.acn002", "lumi.curtain.hagl07" };
}
...
extern const PreparedDefinition kDefZNCLDJ14LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNCLDJ14LM",.vendor="Xiaomi",
