...
// Tier 2: Aqara WXKG26LM wireless remote.
// z2m-source: lumi.ts #WXKG26LM (lumi.remote.acn013).
#include "definitions/lumi/_shared.hpp"
#include "definitions/lumi/factories.hpp"
namespace zhc::devices::lumi {
namespace {
struct WXKG26_Actions {
...
using FX = ::zhc::lumi::factory::LumiAction<WXKG26_Actions>;
constexpr const char* kModels[] = { "lumi.remote.acn013" };
}
