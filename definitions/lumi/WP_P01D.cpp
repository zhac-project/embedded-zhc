...
// Tier 2: Aqara WP-P01D smart plug (US Pro).
// z2m-source: lumi.ts #WP-P01D (lumi.plug.maus02).
...
constexpr const char* kModels[] = { "lumi.plug.aeu001", "lumi.plug.maus02" };
}
...
extern const PreparedDefinition kDefWPP01D{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="WP-P01D",.vendor="Xiaomi",
