...
// Tier 1: Aqara MCCGQ16LM door/window sensor (P1).
// z2m-source: lumi.ts #MCCGQ16LM (lumi.magnet.agl03).
...
constexpr const char* kModels[] = { "lumi.magnet.agl03" };
}
