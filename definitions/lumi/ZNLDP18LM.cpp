...
// Tier 2: Aqara ZNLDP18LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP18LM (lumi.light.acn003).
...
constexpr const char* kModels[] = { "lumi.light.acn003" };
}
...
extern const PreparedDefinition kDefZNLDP18LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP18LM",.vendor="Xiaomi",
