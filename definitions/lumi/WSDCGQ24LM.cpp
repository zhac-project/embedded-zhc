...
// Tier 2: Aqara WSDCGQ24LM temp/humidity/pressure sensor (E1).
// z2m-source: lumi.ts #WSDCGQ24LM (lumi.weather.acn001).
...
constexpr const char* kModels[] = { "lumi.weather.acn001" };
}
...
extern const PreparedDefinition kDefWSDCGQ24LM{
    ...
    .model = "WSDCGQ24LM", .vendor = "Xiaomi",
