...
// Tier 2: Aqara ZNCZ04LM smart plug (CN).
// z2m-source: lumi.ts #ZNCZ04LM (lumi.plug.lumi1).
...
constexpr const char* kModels[] = { "lumi.plug.lumi1", "lumi.plug.mmeu01" };
}
...
extern const PreparedDefinition kDefZNCZ04LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNCZ04LM",.vendor="Xiaomi",
