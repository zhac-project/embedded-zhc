...
// Tier 3: Aqara SJCGQ14LM water-leak sensor (T1 Pro). IAS — muted v2.
// z2m-source: lumi.ts #SJCGQ14LM (lumi.sensor_wleak.acn02).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic };
constexpr const char* kModels[] = { "lumi.sensor_wleak.acn02" };
}
