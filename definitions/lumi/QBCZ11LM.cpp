...
// Tier 2: Aqara QBCZ11LM outlet (EU, metering).
// z2m-source: lumi.ts #QBCZ11LM (lumi.plug.maeu04).
...
constexpr const char* kModels[] = { "lumi.ctrl_86plug", "lumi.ctrl_86plug.aq1", "lumi.plug.maeu04" };
}
...
extern const PreparedDefinition kDefQBCZ11LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBCZ11LM",.vendor="Xiaomi",
