...
// Tier 2: Aqara ZNLDP24LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP24LM (lumi.light.acn009).
...
constexpr const char* kModels[] = { "lumi.light.acn009" };
}
...
extern const PreparedDefinition kDefZNLDP24LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP24LM",.vendor="Xiaomi",
