...
// Tier 1: Aqara ZNCWWSQ01LM — auto-generated stub (battery + basic).
...
constexpr const char* kModels[] = { "aqara.feeder.acn001" };
}
...
constexpr WhiteLabel kWhiteLabels_ZNCWWSQ01LM[] = {
    {"Aqara","PETC1-M01"},
};
extern const PreparedDefinition kDefZNCWWSQ01LM{
    ...
    .model="ZNCWWSQ01LM",.vendor="Xiaomi",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_ZNCWWSQ01LM, .white_labels_count=sizeof(kWhiteLabels_ZNCWWSQ01LM)/sizeof(kWhiteLabels_ZNCWWSQ01LM[0]),
