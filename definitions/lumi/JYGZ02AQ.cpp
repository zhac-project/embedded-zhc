...
// Tier 3: Aqara JY-GZ-02AQ smoke sensor (T1 Pro).
// IAS zone alarm — muted until v2.
// z2m-source: lumi.ts #JY-GZ-02AQ (lumi.sensor_smoke.acn03).
...
constexpr const char* kModels[] = { "lumi.sensor_smoke.acn03" };
}
