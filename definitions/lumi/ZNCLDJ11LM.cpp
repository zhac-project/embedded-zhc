...
// Tier 3: Aqara ZNCLDJ11LM curtain motor.
// genAnalogOutput attr 0x0055 → position; running/stopped state is v2.
// z2m-source: lumi.ts #ZNCLDJ11LM (lumi.curtain).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzLumiCurtainPosition };
constexpr const char* kModels[] = { "lumi.curtain" };
}
...
extern const PreparedDefinition kDefZNCLDJ11LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNCLDJ11LM",.vendor="Xiaomi",
