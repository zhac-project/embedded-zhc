...
// Tier 2: Aqara WXKG23LM wireless remote (H2 dual).
// z2m-source: lumi.ts #WXKG23LM (lumi.remote.acn010).
#include "definitions/lumi/_shared.hpp"
#include "definitions/lumi/factories.hpp"
namespace zhc::devices::lumi {
namespace {
struct WXKG23_Actions {
...
using FX = ::zhc::lumi::factory::LumiAction<WXKG23_Actions>;
constexpr const char* kModels[] = { "lumi.remote.acn010" };
}
