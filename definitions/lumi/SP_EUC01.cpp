...
// Tier 2: Aqara SP-EUC01 smart plug (EU, metering).
// z2m-source: lumi.ts #SP-EUC01 (lumi.plug.maeu03).
...
extern const PreparedDefinition kDefSPEUC01{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="SP-EUC01",.vendor="Xiaomi",
