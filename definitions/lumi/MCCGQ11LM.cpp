...
// Tier 1: Aqara MCCGQ11LM door/window contact sensor.
//
// Same shape as MCCGQ01LM — fz_lumi_basic + fz_lumi_contact.
// z2m-source: lumi.ts #MCCGQ11LM (lumi.sensor_magnet.aq2).
...
constexpr const char* kModels[] = { "lumi.sensor_magnet.aq2" };
}
