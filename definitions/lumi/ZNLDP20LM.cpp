...
// Tier 2: Aqara ZNLDP20LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP20LM (lumi.light.acn005).
...
constexpr const char* kModels[] = { "lumi.light.acn005" };
}
...
extern const PreparedDefinition kDefZNLDP20LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP20LM",.vendor="Xiaomi",
