...
// Tier 2: Aqara ZNLDP19LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP19LM (lumi.light.acn004).
...
constexpr const char* kModels[] = { "lumi.light.acn004" };
}
...
extern const PreparedDefinition kDefZNLDP19LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP19LM",.vendor="Xiaomi",
