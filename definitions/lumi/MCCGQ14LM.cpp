...
// Tier 1: Aqara MCCGQ14LM door/window contact (T1).
// z2m-source: lumi.ts #MCCGQ14LM (lumi.magnet.agl02).
...
constexpr const char* kModels[] = { "lumi.magnet.acn001", "lumi.magnet.agl02" };
}
