...
// Tier 2: Aqara WSDCGQ12LM temp/humidity/pressure sensor (T1).
// Same shape as WSDCGQ11LM with an updated zigbeeModel.
// z2m-source: lumi.ts #WSDCGQ12LM (lumi.weather.v2).
...
extern const PreparedDefinition kDefWSDCGQ12LM{
    ...
    .model = "WSDCGQ12LM", .vendor = "Xiaomi",
    .meta = &kTagMap,
