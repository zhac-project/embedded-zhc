...
// Tier 2: Aqara QBKG34LM 2-gang CN H1 Pro.
// z2m-source: lumi.ts #QBKG34LM (lumi.switch.acn027).
...
constexpr const char* kModels[] = { "lumi.switch.acn027", "lumi.switch.b3n01" };
}
...
extern const PreparedDefinition kDefQBKG34LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG34LM",.vendor="Xiaomi",
