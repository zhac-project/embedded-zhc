...
// Tier 2: Aqara QBKG32LM 1-gang CN wall switch.
// z2m-source: lumi.ts #QBKG32LM (lumi.switch.acn025).
...
extern const PreparedDefinition kDefQBKG32LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG32LM",.vendor="Xiaomi",
