...
// Tier 2: Aqara ZNQBKG14LM 2-gang CN mass market.
// z2m-source: lumi.ts #ZNQBKG14LM (lumi.switch.acn023).
...
constexpr const char* kModels[] = { "lumi.switch.acn023" };
}
...
extern const PreparedDefinition kDefZNQBKG14LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNQBKG14LM",.vendor="Xiaomi",
