...
// Tier 2: Aqara ZNQBKG16LM 3-gang CN mass market.
// z2m-source: lumi.ts #ZNQBKG16LM (lumi.switch.acn031).
...
constexpr const char* kModels[] = { "lumi.switch.acn031" };
}
...
extern const PreparedDefinition kDefZNQBKG16LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNQBKG16LM",.vendor="Xiaomi",
