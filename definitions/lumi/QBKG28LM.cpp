...
// Tier 1: Aqara QBKG28LM — auto-generated stub.
// z2m-source: lumi.ts #QBKG28LM.
#include "definitions/lumi/_shared.hpp"
#include "definitions/lumi/factories.hpp"
namespace zhc::devices::lumi {
namespace {
struct E { static constexpr ::zhc::lumi::DeviceEndpointLabel e[]={{1,"state_left"}, {2,"state_right"}};
          static constexpr ::zhc::lumi::DeviceEndpointLabels map{e,2}; };
using FX = ::zhc::lumi::factory::LumiOnOff<E>;
constexpr const char* kModels[] = { "lumi.switch.l2acn1" };
}
