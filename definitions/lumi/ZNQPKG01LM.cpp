...
// Tier 3: Aqara ZNQPKG01LM scene panel (6-button).
// Scene dispatch via Aqara manu-specific commands — v2.
// z2m-source: lumi.ts #ZNQPKG01LM (lumi.switch.acn050).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic };
constexpr const char* kModels[] = { "lumi.switch.acn050" };
}
...
extern const PreparedDefinition kDefZNQPKG01LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNQPKG01LM",.vendor="Xiaomi",
