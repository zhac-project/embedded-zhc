...
// Tier 2: Aqara ZNLDP17LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP17LM (lumi.light.acn002).
...
constexpr const char* kModels[] = { "lumi.light.acn002" };
}
...
extern const PreparedDefinition kDefZNLDP17LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP17LM",.vendor="Xiaomi",
