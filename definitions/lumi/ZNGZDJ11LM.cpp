...
// Tier 1: Aqara ZNGZDJ11LM — auto-generated stub (battery + basic).
...
constexpr const char* kModels[] = { "lumi.curtain.aq2" };
}
...
constexpr WhiteLabel kWhiteLabels_ZNGZDJ11LM[] = {
    {"Aqara","SRSC-M01"},
};
extern const PreparedDefinition kDefZNGZDJ11LM{
    ...
    .model="ZNGZDJ11LM",.vendor="Xiaomi",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_ZNGZDJ11LM, .white_labels_count=sizeof(kWhiteLabels_ZNGZDJ11LM)/sizeof(kWhiteLabels_ZNGZDJ11LM[0]),
