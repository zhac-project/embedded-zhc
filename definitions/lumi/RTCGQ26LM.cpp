...
// Tier 1: Aqara RTCGQ26LM motion sensor.
// z2m-source: lumi.ts #RTCGQ26LM (lumi.motion.acn004).
...
constexpr const char* kModels[] = { "lumi.motion.acn004" };
}
