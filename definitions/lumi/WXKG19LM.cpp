...
// Tier 2: Aqara WXKG19LM wireless remote (H1 Pro dual).
// z2m-source: lumi.ts #WXKG19LM (lumi.remote.acn003).
...
using FX = ::zhc::lumi::factory::LumiAction<WXKG19_Actions>;
