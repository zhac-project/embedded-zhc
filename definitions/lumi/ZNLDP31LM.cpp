...
// Tier 2: Aqara ZNLDP31LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP31LM (lumi.light.acn016).
...
constexpr const char* kModels[] = { "lumi.light.acn016" };
}
...
extern const PreparedDefinition kDefZNLDP31LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP31LM",.vendor="Xiaomi",
