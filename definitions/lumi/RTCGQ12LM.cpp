...
// Tier 1: Aqara RTCGQ12LM motion sensor (T1 revision).
//
// Shares converters with RTCGQ11LM — lumi_basic (battery) + occupancy.
// z2m-source: lumi.ts #RTCGQ12LM (lumi.sensor_motion.aq2 variant).
...
constexpr const char* kModels[] = { "lumi.motion.ac01", "lumi.motion.agl02" };
}
