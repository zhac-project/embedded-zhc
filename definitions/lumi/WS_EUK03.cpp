...
// Tier 2: Aqara WS-EUK03 2-gang EU switch (no neutral).
// z2m-source: lumi.ts #WS-EUK03 (lumi.switch.l2aeu1).
...
constexpr const char* kModels[] = { "lumi.switch.l2aeu1", "lumi.switch.n1aeu1" };
}
...
extern const PreparedDefinition kDefWSEUK03{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="WS-EUK03",.vendor="Xiaomi",
