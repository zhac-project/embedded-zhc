...
// Tier 2: Aqara ZNLDP21LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP21LM (lumi.light.acn006).
...
constexpr const char* kModels[] = { "lumi.light.acn006" };
}
...
extern const PreparedDefinition kDefZNLDP21LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP21LM",.vendor="Xiaomi",
