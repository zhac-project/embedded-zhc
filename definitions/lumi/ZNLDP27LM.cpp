...
// Tier 2: Aqara ZNLDP27LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP27LM (lumi.light.acn012).
...
constexpr const char* kModels[] = { "lumi.light.acn012" };
}
...
extern const PreparedDefinition kDefZNLDP27LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP27LM",.vendor="Xiaomi",
