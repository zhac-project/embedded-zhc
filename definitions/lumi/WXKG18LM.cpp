...
// Tier 2: Aqara WXKG18LM wireless remote (E1).
// z2m-source: lumi.ts #WXKG18LM (lumi.remote.acn001).
...
namespace {
struct WXKG18_Actions {
    static constexpr ::zhc::lumi::LumiActionEntry entries[] = {
        {0, "hold"}, {1, "single"}, {2, "double"}, {255, "release"},
    };
    static constexpr ::zhc::lumi::LumiActionMap map{ entries, 4 };
};
using FX = ::zhc::lumi::factory::LumiAction<WXKG18_Actions>;
constexpr const char* kModels[] = { "lumi.remote.acn001" };
}
