...
// Tier 2: Aqara ZNMCPZ01LM meter-only plug (CN).
// z2m-source: lumi.ts #ZNMCPZ01LM (lumi.plug.macn03).
...
constexpr const char* kModels[] = { "lumi.plug.macn03" };
}
...
extern const PreparedDefinition kDefZNMCPZ01LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNMCPZ01LM",.vendor="Xiaomi",
