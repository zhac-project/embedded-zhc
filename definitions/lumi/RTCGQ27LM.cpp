...
// Tier 1: Aqara RTCGQ27LM motion sensor.
// z2m-source: lumi.ts #RTCGQ27LM (lumi.motion.acn005).
...
constexpr const char* kModels[] = { "lumi.motion.acn005" };
}
