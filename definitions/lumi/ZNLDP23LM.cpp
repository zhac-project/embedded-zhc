...
// Tier 2: Aqara ZNLDP23LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP23LM (lumi.light.acn008).
...
constexpr const char* kModels[] = { "lumi.light.acn008" };
}
...
extern const PreparedDefinition kDefZNLDP23LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP23LM",.vendor="Xiaomi",
