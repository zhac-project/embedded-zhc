...
// Tier 1: Aqara MCCGQ20LM door/window sensor.
// z2m-source: lumi.ts #MCCGQ20LM (lumi.magnet.acn004).
...
constexpr const char* kModels[] = { "lumi.magnet.acn004" };
}
