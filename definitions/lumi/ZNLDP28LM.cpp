...
// Tier 2: Aqara ZNLDP28LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP28LM (lumi.light.acn013).
...
constexpr const char* kModels[] = { "lumi.light.acn013" };
}
...
extern const PreparedDefinition kDefZNLDP28LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP28LM",.vendor="Xiaomi",
