...
// Tier 2: Aqara ZNQBKG11LM 1-gang CN mass market.
// z2m-source: lumi.ts #ZNQBKG11LM (lumi.switch.acn020).
...
constexpr const char* kModels[] = { "lumi.switch.acn020" };
}
...
extern const PreparedDefinition kDefZNQBKG11LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNQBKG11LM",.vendor="Xiaomi",
