...
constexpr WhiteLabel kWhiteLabels_LLKZMK12LM[] = {
    {"Aqara","DCM-K01"},
};
extern const PreparedDefinition kDefLLKZMK12LM{
    ...
    .model="LLKZMK12LM",.vendor="Xiaomi",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_LLKZMK12LM, .white_labels_count=sizeof(kWhiteLabels_LLKZMK12LM)/sizeof(kWhiteLabels_LLKZMK12LM[0]),
