...
// Tier 2: Aqara ZNQBKG13LM 2-gang CN mass market.
// z2m-source: lumi.ts #ZNQBKG13LM (lumi.switch.acn022).
...
constexpr const char* kModels[] = { "lumi.switch.acn022" };
}
...
extern const PreparedDefinition kDefZNQBKG13LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNQBKG13LM",.vendor="Xiaomi",
