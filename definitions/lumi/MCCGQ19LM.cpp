...
// Tier 1: Aqara MCCGQ19LM door/window sensor (pro).
// z2m-source: lumi.ts #MCCGQ19LM (lumi.magnet.agl04).
...
constexpr const char* kModels[] = { "lumi.magnet.agl04" };
}
