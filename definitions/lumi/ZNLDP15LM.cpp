...
// Tier 2: Aqara ZNLDP15LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP15LM (lumi.light.aqcn02).
...
constexpr const char* kModels[] = { "lumi.light.aqcn02" };
}
...
extern const PreparedDefinition kDefZNLDP15LM{
    .zigbee_models=kModels,.zigbee_models_count=1,.model="ZNLDP15LM",.vendor="Xiaomi",
