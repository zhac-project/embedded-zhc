...
// Tier 2: Aqara ZNLDP16LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP16LM (lumi.light.acn001).
...
constexpr const char* kModels[] = { "lumi.light.acn001" };
}
...
extern const PreparedDefinition kDefZNLDP16LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP16LM",.vendor="Xiaomi",
