...
// Tier 1: Aqara LGYCDD01LM — auto-generated stub (battery + basic).
...
constexpr const char* kModels[] = { "lumi.light.acn132" };
}
...
constexpr WhiteLabel kWhiteLabels_LGYCDD01LM[] = {
    {"Aqara","RLS-K01D"},
};
extern const PreparedDefinition kDefLGYCDD01LM{
    ...
    .model="LGYCDD01LM",.vendor="Xiaomi",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_LGYCDD01LM, .white_labels_count=sizeof(kWhiteLabels_LGYCDD01LM)/sizeof(kWhiteLabels_LGYCDD01LM[0]),
