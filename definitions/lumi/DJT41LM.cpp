...
// Tier 3: Aqara DJT41LM vibration sensor (T2). IAS — muted v2.
// z2m-source: lumi.ts #DJT41LM (lumi.vibration.acn02).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic };
constexpr const char* kModels[] = { "lumi.vibration.acn02" };
}
