...
// Tier 2: Aqara QBKG12LM 2-gang wall switch (L+N).
// z2m-source: lumi.ts #QBKG12LM (lumi.ctrl_ln2).
...
constexpr const char* kModels[] = { "lumi.ctrl_ln2", "lumi.ctrl_ln2.aq1" };
}
...
extern const PreparedDefinition kDefQBKG12LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG12LM",.vendor="Xiaomi",
