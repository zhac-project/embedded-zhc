...
// Tier 3: Aqara DJT31LM vibration sensor (E1).
// IAS zone alarm — muted until v2.
// z2m-source: lumi.ts #DJT31LM (lumi.vibration.acn01).
...
constexpr const char* kModels[] = { "lumi.vibration.acn01" };
}
