...
// Tier 2: Aqara ZNCZ14LM smart plug (EU variant).
// z2m-source: lumi.ts #ZNCZ14LM (lumi.plug.maeu02).
...
constexpr const char* kModels[] = { "lumi.plug.maeu02" };
}
...
extern const PreparedDefinition kDefZNCZ14LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNCZ14LM",.vendor="Xiaomi",
