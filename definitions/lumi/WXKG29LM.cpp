...
// Tier 2: Aqara WXKG29LM wireless remote.
// z2m-source: lumi.ts #WXKG29LM (lumi.remote.acn016).
...
constexpr const char* kModels[] = { "lumi.remote.acn016" };
}
