...
// Tier 1: Aqara RTCGQ24LM motion sensor.
// z2m-source: lumi.ts #RTCGQ24LM (lumi.motion.acn002).
...
constexpr const char* kModels[] = { "lumi.motion.acn002" };
}
