...
// Tier 2: Aqara ZNXNKG05LM rotary dimmer (dim only).
// z2m-source: lumi.ts #ZNXNKG05LM (lumi.dimmer.rcbac5).
...
constexpr const char* kModels[] = { "lumi.dimmer.rcbac5" };
}
...
extern const PreparedDefinition kDefZNXNKG05LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNXNKG05LM",.vendor="Xiaomi",
