...
// Tier 2: Aqara QBKG21LM 1-gang US wall switch.
// z2m-source: lumi.ts #QBKG21LM (lumi.switch.b1naus01).
...
extern const PreparedDefinition kDefQBKG21LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG21LM",.vendor="Xiaomi",
