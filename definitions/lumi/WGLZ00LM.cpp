...
// Tier 3: Aqara WGLZ00LM smart heater.
// Thermostat cluster support lands in v2.
// z2m-source: lumi.ts #WGLZ00LM (lumi.heater.acn01).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic };
constexpr const char* kModels[] = { "lumi.heater.acn01" };
}
...
extern const PreparedDefinition kDefWGLZ00LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="WGLZ00LM",.vendor="Xiaomi",
