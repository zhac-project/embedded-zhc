...
// Tier 2: Aqara WXKG25LM wireless remote (quad).
// z2m-source: lumi.ts #WXKG25LM (lumi.remote.acn012).
#include "definitions/lumi/_shared.hpp"
#include "definitions/lumi/factories.hpp"
namespace zhc::devices::lumi {
namespace {
struct WXKG25_Actions {
    static constexpr ::zhc::lumi::LumiActionEntry entries[] = {
        {0, "hold"},    {1, "single"},    {2, "double"},
        {3, "triple"},  {4, "quadruple"}, {255, "release"},
    };
    static constexpr ::zhc::lumi::LumiActionMap map{ entries, 6 };
};
using FX = ::zhc::lumi::factory::LumiAction<WXKG25_Actions>;
constexpr const char* kModels[] = { "lumi.remote.acn012" };
}
