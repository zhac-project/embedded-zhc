...
// Tier 1: Aqara RTCGQ28LM motion sensor.
// z2m-source: lumi.ts #RTCGQ28LM (lumi.motion.acn006).
#include "definitions/_generic/_shared.hpp"
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = {
    &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzOccupancy,
    &::zhc::generic::kFzIgnoreIlluminanceReport,
};
constexpr const char* kModels[] = { "lumi.motion.acn006" };
}
