...
// Tier 3: Aqara ZNMS12LM door lock v2.
// z2m-source: lumi.ts #ZNMS12LM (lumi.lock.aq1).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzLumiDoorLockReport };
constexpr const char* kModels[] = { "lumi.lock.acn02" };
}
...
extern const PreparedDefinition kDefZNMS12LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNMS12LM",.vendor="Xiaomi",
