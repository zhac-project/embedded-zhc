...
// Tier 2: Aqara QBCZ13LM outlet (CN H1).
// z2m-source: lumi.ts #QBCZ13LM (lumi.plug.macn02).
...
constexpr const char* kModels[] = { "lumi.plug.macn02" };
}
...
extern const PreparedDefinition kDefQBCZ13LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBCZ13LM",.vendor="Xiaomi",
