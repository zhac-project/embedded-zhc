...
// Tier 3: Aqara RTCZCGQ12LM FP1E presence radar.
// Same v2-blocked path as RTCZCGQ11LM.
// z2m-source: lumi.ts #RTCZCGQ12LM (lumi.motion.acn004fp1e).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic };
constexpr const char* kModels[] = { "lumi.motion.acn004fp1e" };
}
...
extern const PreparedDefinition kDefRTCZCGQ12LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="RTCZCGQ12LM",.vendor="Xiaomi",
