...
// Tier 2: Aqara QBKG23LM 1-gang EU wall switch.
// z2m-source: lumi.ts #QBKG23LM (lumi.switch.n1aeu1).
...
constexpr const char* kModels[] = { "lumi.switch.b1nacn02" };
}
...
extern const PreparedDefinition kDefQBKG23LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG23LM",.vendor="Xiaomi",
