...
// Tier 2: Aqara QBKG29LM 3-gang CN wall switch.
// z2m-source: lumi.ts #QBKG29LM (lumi.switch.b3nacn02).
...
constexpr const char* kModels[] = { "lumi.switch.b3nacn02", "lumi.switch.l3acn1" };
}
...
extern const PreparedDefinition kDefQBKG29LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG29LM",.vendor="Xiaomi",
