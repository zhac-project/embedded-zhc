...
// Tier 2: Aqara QBKG04LM 1-gang wall switch (no neutral).
// z2m-source: lumi.ts #QBKG04LM (lumi.ctrl_neutral1).
...
constexpr const char* kModels[] = { "lumi.ctrl_neutral1" };
}
...
extern const PreparedDefinition kDefQBKG04LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG04LM",.vendor="Xiaomi",
