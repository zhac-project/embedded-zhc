...
// Tier 1: Aqara TDL01LM — auto-generated stub (battery + basic).
...
constexpr const char* kModels[] = { "lumi.light.acn128" };
}
...
constexpr WhiteLabel kWhiteLabels_TDL01LM[] = {
    {"Aqara","MZSD11LM"},
    {"Aqara","MZSD12LM"},
    {"Aqara","MZTD11LM"},
};
extern const PreparedDefinition kDefTDL01LM{
    ...
    .model="TDL01LM",.vendor="Xiaomi",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_TDL01LM, .white_labels_count=sizeof(kWhiteLabels_TDL01LM)/sizeof(kWhiteLabels_TDL01LM[0]),
