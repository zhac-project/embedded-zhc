...
// Tier 1: Aqara MCCGQ13LM door/window contact P1.
// z2m-source: lumi.ts #MCCGQ13LM (lumi.magnet.agl01).
...
constexpr const char* kModels[] = { "lumi.magnet.ac01", "lumi.magnet.agl01" };
}
