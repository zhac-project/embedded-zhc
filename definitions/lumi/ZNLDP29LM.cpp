...
// Tier 2: Aqara ZNLDP29LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP29LM (lumi.light.acn014).
...
constexpr const char* kModels[] = { "lumi.light.acn014" };
}
...
extern const PreparedDefinition kDefZNLDP29LM{
    .zigbee_models=kModels,.zigbee_models_count=1,.model="ZNLDP29LM",.vendor="Xiaomi",
