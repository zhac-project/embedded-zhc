...
// Tier 1: Aqara RTCGQ32LM motion sensor.
// z2m-source: lumi.ts #RTCGQ32LM (lumi.motion.agl08).
...
constexpr const char* kModels[] = { "lumi.motion.agl08" };
}
