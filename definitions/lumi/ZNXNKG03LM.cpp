...
// Tier 2: Aqara ZNXNKG03LM rotary dimmer (dim only).
// z2m-source: lumi.ts #ZNXNKG03LM (lumi.dimmer.rcbac3).
...
constexpr const char* kModels[] = { "lumi.dimmer.rcbac3" };
}
...
extern const PreparedDefinition kDefZNXNKG03LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNXNKG03LM",.vendor="Xiaomi",
