...
// Tier 2: Aqara SP-EUC02 smart plug (EU v2).
// z2m-source: lumi.ts #SP-EUC02 (lumi.plug.maeu05).
...
constexpr const char* kModels[] = { "lumi.plug.maeu05" };
}
...
extern const PreparedDefinition kDefSPEUC02{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="SP-EUC02",.vendor="Xiaomi",
