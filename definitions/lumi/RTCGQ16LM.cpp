...
// Tier 1: Aqara RTCGQ16LM motion sensor (T1 EU).
// z2m-source: lumi.ts #RTCGQ16LM (lumi.motion.agl03).
...
constexpr const char* kModels[] = { "lumi.motion.agl03" };
}
