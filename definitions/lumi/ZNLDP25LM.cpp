...
// Tier 2: Aqara ZNLDP25LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP25LM (lumi.light.acn010).
...
constexpr const char* kModels[] = { "lumi.light.acn010" };
}
...
extern const PreparedDefinition kDefZNLDP25LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP25LM",.vendor="Xiaomi",
