...
// Tier 2: Aqara QBKG24LM 2-gang EU wall switch.
// z2m-source: lumi.ts #QBKG24LM (lumi.switch.n2aeu1).
...
constexpr const char* kModels[] = { "lumi.switch.b2nacn02" };
}
...
extern const PreparedDefinition kDefQBKG24LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG24LM",.vendor="Xiaomi",
