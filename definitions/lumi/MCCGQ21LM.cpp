...
// Tier 1: Aqara MCCGQ21LM door/window sensor.
// z2m-source: lumi.ts #MCCGQ21LM (lumi.magnet.acn005).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzLumiContact };
constexpr const char* kModels[] = { "lumi.magnet.acn005" };
}
