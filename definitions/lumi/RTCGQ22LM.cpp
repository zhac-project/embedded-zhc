...
// Tier 1: Aqara RTCGQ22LM motion sensor (P1 Pro).
// z2m-source: lumi.ts #RTCGQ22LM (lumi.motion.agl06).
...
constexpr const char* kModels[] = { "lumi.motion.agl06" };
}
