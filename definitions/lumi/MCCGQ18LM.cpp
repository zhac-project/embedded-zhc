...
// Tier 1: Aqara MCCGQ18LM door/window sensor (U1).
// z2m-source: lumi.ts #MCCGQ18LM (lumi.magnet.acn003).
...
constexpr const char* kModels[] = { "lumi.magnet.acn003" };
}
