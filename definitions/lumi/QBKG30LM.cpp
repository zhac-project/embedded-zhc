...
// Tier 2: Aqara QBKG30LM 3-gang EU (no neutral).
// z2m-source: lumi.ts #QBKG30LM (lumi.switch.l3aeu1).
...
constexpr const char* kModels[] = { "lumi.switch.l3aeu1", "lumi.switch.n1acn1" };
}
...
extern const PreparedDefinition kDefQBKG30LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG30LM",.vendor="Xiaomi",
