...
// Tier 1: Aqara RTCGQ21LM motion sensor (E1).
// z2m-source: lumi.ts #RTCGQ21LM (lumi.motion.agl05).
...
constexpr const char* kModels[] = { "lumi.motion.agl05" };
}
