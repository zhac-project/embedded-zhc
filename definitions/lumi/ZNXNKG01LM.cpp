...
// Tier 2: Aqara ZNXNKG01LM rotary dimmer (dim only, no CT).
// z2m-source: lumi.ts #ZNXNKG01LM (lumi.dimmer.rcbac1).
...
extern const PreparedDefinition kDefZNXNKG01LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNXNKG01LM",.vendor="Xiaomi",
