...
// Tier 2: Aqara WS-EUK01 1-gang EU switch (no neutral).
// z2m-source: lumi.ts #WS-EUK01 (lumi.switch.l1aeu1).
...
constexpr const char* kModels[] = { "lumi.switch.l1aeu1" };
}
...
extern const PreparedDefinition kDefWSEUK01{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="WS-EUK01",.vendor="Xiaomi",
