...
// Tier 3: Aqara ZNWXKG01LM wireless wall switch (H1 Pro).
// z2m-source: lumi.ts #ZNWXKG01LM (lumi.switch.acn040).
...
constexpr const char* kModels[] = { "lumi.switch.acn040" };
}
...
extern const PreparedDefinition kDefZNWXKG01LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNWXKG01LM",.vendor="Xiaomi",
