...
// Tier 3: Aqara ZNCLDJ12LM curtain motor v2.
// z2m-source: lumi.ts #ZNCLDJ12LM (lumi.curtain.hagl04).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzLumiCurtainPosition };
constexpr const char* kModels[] = { "lumi.curtain.hagl04" };
}
...
extern const PreparedDefinition kDefZNCLDJ12LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNCLDJ12LM",.vendor="Xiaomi",
