...
// Tier 1: Aqara RTCGQ25LM motion sensor.
// z2m-source: lumi.ts #RTCGQ25LM (lumi.motion.acn003).
...
constexpr const char* kModels[] = { "lumi.motion.acn003" };
}
