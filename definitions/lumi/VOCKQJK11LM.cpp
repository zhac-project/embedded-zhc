...
// Tier 1: Aqara VOCKQJK11LM — auto-generated stub (battery + basic).
...
constexpr WhiteLabel kWhiteLabels_VOCKQJK11LM[] = {
    {"Aqara","AAQS-S01"},
};
extern const PreparedDefinition kDefVOCKQJK11LM{
    ...
    .model="VOCKQJK11LM",.vendor="Xiaomi",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_VOCKQJK11LM, .white_labels_count=sizeof(kWhiteLabels_VOCKQJK11LM)/sizeof(kWhiteLabels_VOCKQJK11LM[0]),
