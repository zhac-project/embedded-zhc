...
// Tier 2: Aqara ZNMCPZ02LM meter-only plug (CN v2).
// z2m-source: lumi.ts #ZNMCPZ02LM (lumi.plug.macn04).
...
constexpr const char* kModels[] = { "lumi.plug.macn04" };
}
...
extern const PreparedDefinition kDefZNMCPZ02LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNMCPZ02LM",.vendor="Xiaomi",
