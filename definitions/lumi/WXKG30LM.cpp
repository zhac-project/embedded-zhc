...
// Tier 2: Aqara WXKG30LM wireless remote.
// z2m-source: lumi.ts #WXKG30LM (lumi.remote.acn017).
#include "definitions/lumi/_shared.hpp"
#include "definitions/lumi/factories.hpp"
namespace zhc::devices::lumi {
namespace {
struct A { static constexpr ::zhc::lumi::LumiActionEntry e[] = {
    {0,"hold"},{1,"single"},{2,"double"},{16,"single_both"},{17,"double_both"}};
    static constexpr ::zhc::lumi::LumiActionMap map{e,5}; };
using FX = ::zhc::lumi::factory::LumiAction<A>;
constexpr const char* kModels[] = { "lumi.remote.acn017" };
}
