...
// Tier 2: Aqara ZNLDP13LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP13LM (lumi.light.cwopcn02).
...
constexpr const char* kModels[] = { "lumi.light.acn014", "lumi.light.cwac02", "lumi.light.cwopcn02" };
}
