...
// Tier 1: Aqara MCCGQ17LM door/window sensor (E1 2024).
// z2m-source: lumi.ts #MCCGQ17LM (lumi.magnet.acn002).
...
constexpr const char* kModels[] = { "lumi.magnet.acn002" };
}
