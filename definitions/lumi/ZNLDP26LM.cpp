...
// Tier 2: Aqara ZNLDP26LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP26LM (lumi.light.acn011).
...
constexpr const char* kModels[] = { "lumi.light.acn011" };
}
...
extern const PreparedDefinition kDefZNLDP26LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP26LM",.vendor="Xiaomi",
