...
// Tier 2: Aqara ZNXNKG02LM rotary dimmer (dim only).
// z2m-source: lumi.ts #ZNXNKG02LM (lumi.dimmer.rcbac2).
...
constexpr const char* kModels[] = { "lumi.dimmer.rcbac2", "lumi.remote.rkba01" };
}
...
extern const PreparedDefinition kDefZNXNKG02LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNXNKG02LM",.vendor="Xiaomi",
