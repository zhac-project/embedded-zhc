...
// Tier 2: Aqara QBKG33LM 1-gang CN wall switch H1 Pro.
// z2m-source: lumi.ts #QBKG33LM (lumi.switch.acn026).
...
constexpr const char* kModels[] = { "lumi.switch.acn026", "lumi.switch.b3l01" };
}
...
extern const PreparedDefinition kDefQBKG33LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG33LM",.vendor="Xiaomi",
