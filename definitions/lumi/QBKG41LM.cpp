...
// Tier 2: Aqara QBKG41LM 3-gang CN variant.
// z2m-source: lumi.ts #QBKG41LM (lumi.switch.acn030).
...
constexpr const char* kModels[] = { "lumi.switch.acn030", "lumi.switch.b2nc01" };
}
...
extern const PreparedDefinition kDefQBKG41LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG41LM",.vendor="Xiaomi",
