...
// Tier 2: Aqara ZNXNKG04LM rotary dimmer (dim only).
// z2m-source: lumi.ts #ZNXNKG04LM (lumi.dimmer.rcbac4).
...
constexpr const char* kModels[] = { "lumi.dimmer.rcbac4" };
}
...
extern const PreparedDefinition kDefZNXNKG04LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNXNKG04LM",.vendor="Xiaomi",
