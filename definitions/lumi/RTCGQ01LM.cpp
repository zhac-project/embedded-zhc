...
// Tier 1: Aqara RTCGQ01LM motion sensor (original).
// z2m-source: lumi.ts #RTCGQ01LM (lumi.sensor_motion).
...
constexpr const char* kModels[] = { "lumi.sensor_motion" };
}
