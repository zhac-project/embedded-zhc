...
// Tier 2: Aqara QBKG10LM 1-gang wall switch (neutral).
// z2m-source: lumi.ts #QBKG10LM (lumi.ctrl_ln1).
...
constexpr const char* kModels[] = { "lumi.ctrl_ln1" };
}
...
extern const PreparedDefinition kDefQBKG10LM{
    .zigbee_models=kModels,.zigbee_models_count=1,.model="QBKG10LM",.vendor="Xiaomi",
