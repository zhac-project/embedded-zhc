...
// Tier 3: Aqara DJT21LM vibration sensor (T1 Pro).
// Vibration events via IAS zone — muted until v2.
// z2m-source: lumi.ts #DJT21LM (lumi.vibration.agl02).
...
constexpr const char* kModels[] = { "lumi.vibration.agl02" };
}
