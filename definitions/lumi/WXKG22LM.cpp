...
// Tier 2: Aqara WXKG22LM wireless remote (H2).
// z2m-source: lumi.ts #WXKG22LM (lumi.remote.acn009).
#include "definitions/lumi/_shared.hpp"
#include "definitions/lumi/factories.hpp"
namespace zhc::devices::lumi {
namespace {
struct WXKG22_Actions {
...
using FX = ::zhc::lumi::factory::LumiAction<WXKG22_Actions>;
constexpr const char* kModels[] = { "lumi.remote.acn009" };
}
