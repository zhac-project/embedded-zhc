...
// Tier 2: Aqara ZNLDP14LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP14LM (lumi.light.cwopcn03).
...
constexpr const char* kModels[] = { "lumi.light.cwopcn03" };
}
...
extern const PreparedDefinition kDefZNLDP14LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP14LM",.vendor="Xiaomi",
