...
// Tier 2: Aqara LGZCDD01LM light strip controller.
//
// Uses `factory::LumiLight` with {level, color_temp} options — emits
// state + brightness + color_temp from the standard ZCL clusters and
// wires the matching outbound encoders.
//
// z2m-source: zigbee-herdsman-converters/src/devices/lumi.ts
//             #LGZCDD01LM (lumi.light.rgbac1 / lightStrip).
...
constexpr const char* kZigbeeModels[] = { "lumi.light.rgbac1" };
