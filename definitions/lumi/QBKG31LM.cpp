...
// Tier 2: Aqara QBKG31LM 3-gang EU (L+N).
// z2m-source: lumi.ts #QBKG31LM (lumi.switch.n3aeu1).
...
constexpr const char* kModels[] = { "lumi.switch.n2acn1", "lumi.switch.n3aeu1" };
}
...
extern const PreparedDefinition kDefQBKG31LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG31LM",.vendor="Xiaomi",
