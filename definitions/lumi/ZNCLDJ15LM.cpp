...
// Tier 3: Aqara ZNCLDJ15LM curtain driver (E1).
// z2m-source: lumi.ts #ZNCLDJ15LM (lumi.curtain.acn004).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzLumiCurtainPosition };
constexpr const char* kModels[] = { "lumi.curtain.acn004" };
}
...
extern const PreparedDefinition kDefZNCLDJ15LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNCLDJ15LM",.vendor="Xiaomi",
