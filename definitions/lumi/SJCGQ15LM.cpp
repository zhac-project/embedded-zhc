...
// Tier 3: Aqara SJCGQ15LM water-leak sensor (E1 2024). IAS — muted v2.
// z2m-source: lumi.ts #SJCGQ15LM (lumi.sensor_wleak.acn03).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic };
constexpr const char* kModels[] = { "lumi.sensor_wleak.acn03" };
}
