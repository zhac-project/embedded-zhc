...
// Tier 1: Aqara MCCGQ23LM door/window sensor.
// z2m-source: lumi.ts #MCCGQ23LM (lumi.magnet.agl05).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzLumiContact };
constexpr const char* kModels[] = { "lumi.magnet.agl05" };
}
