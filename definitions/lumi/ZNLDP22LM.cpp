...
// Tier 2: Aqara ZNLDP22LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP22LM (lumi.light.acn007).
...
constexpr const char* kModels[] = { "lumi.light.acn007" };
}
...
extern const PreparedDefinition kDefZNLDP22LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP22LM",.vendor="Xiaomi",
