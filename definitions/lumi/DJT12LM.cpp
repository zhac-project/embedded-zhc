...
// Tier 3: Aqara DJT12LM vibration sensor (T1).
// Vibration events arrive via IAS zone — muted until v2.
// z2m-source: lumi.ts #DJT12LM (lumi.vibration.agl01).
