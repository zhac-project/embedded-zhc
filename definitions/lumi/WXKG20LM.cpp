...
// Tier 2: Aqara WXKG20LM wireless remote E1.
// z2m-source: lumi.ts #WXKG20LM (lumi.remote.acn007).
...
using FX = ::zhc::lumi::factory::LumiAction<WXKG20_Actions>;
constexpr const char* kModels[] = { "lumi.remote.acn007" };
}
