...
// Tier 2: Aqara MCCGQ01LM door/window contact sensor.
//
// Pairs `fz_lumi_basic` (battery/voltage TLV) with `fz_lumi_contact`
// (inverted genOnOff attr 0x0000). Reports `contact: true` when the
// magnet is near the sensor (closed).
//
...
constexpr const char* kZigbeeModels[] = { "lumi.sensor_magnet" };
