...
// Tier 3: Aqara ZNMS13LM door lock Pro.
// z2m-source: lumi.ts #ZNMS13LM (lumi.lock.acn01).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::lumi::kFzLumiDoorLockReport };
constexpr const char* kModels[] = { "lumi.lock.acn01", "lumi.lock.acn03" };
}
...
extern const PreparedDefinition kDefZNMS13LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNMS13LM",.vendor="Xiaomi",
