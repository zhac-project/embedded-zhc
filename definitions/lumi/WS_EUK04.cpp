...
// Tier 2: Aqara WS-EUK04 3-gang EU switch.
// z2m-source: lumi.ts #WS-EUK04 (lumi.switch.l0acn1).
...
constexpr const char* kModels[] = { "lumi.switch.l0acn1", "lumi.switch.n2aeu1" };
}
...
extern const PreparedDefinition kDefWSEUK04{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="WS-EUK04",.vendor="Xiaomi",
