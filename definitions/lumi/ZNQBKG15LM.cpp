...
// Tier 2: Aqara ZNQBKG15LM 3-gang CN mass market.
// z2m-source: lumi.ts #ZNQBKG15LM (lumi.switch.acn024).
...
constexpr const char* kModels[] = { "lumi.switch.acn024" };
}
...
extern const PreparedDefinition kDefZNQBKG15LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNQBKG15LM",.vendor="Xiaomi",
