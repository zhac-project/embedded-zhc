...
// Tier 2: Aqara WXKG15LM wireless remote (H1 variant).
// z2m-source: lumi.ts #WXKG15LM (lumi.remote.b186acn03).
...
using FX = ::zhc::lumi::factory::LumiAction<WXKG15_Actions>;
constexpr const char* kModels[] = { "lumi.remote.b186acn03", "lumi.remote.b28ac1" };
}
