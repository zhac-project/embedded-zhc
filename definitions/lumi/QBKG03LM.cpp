...
// Tier 2: Aqara QBKG03LM 2-gang wall switch (no neutral).
// z2m-source: lumi.ts #QBKG03LM (lumi.ctrl_neutral2).
...
extern const PreparedDefinition kDefQBKG03LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG03LM",.vendor="Xiaomi",
