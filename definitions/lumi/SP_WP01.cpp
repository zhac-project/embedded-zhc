...
// Tier 3: Aqara SP-WP01 water pump controller.
// z2m-source: lumi.ts #SP-WP01 (lumi.pump.acn01).
#include "definitions/_generic/_shared.hpp"
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic, &::zhc::generic::kFzOnOff };
constexpr const char* kModels[] = { "lumi.pump.acn01" };
}
...
extern const PreparedDefinition kDefSPWP01{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="SP-WP01",.vendor="Xiaomi",
