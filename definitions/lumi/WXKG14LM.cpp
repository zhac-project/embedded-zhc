...
// Tier 2: Aqara WXKG14LM wireless switch.
// z2m-source: lumi.ts #WXKG14LM (lumi.remote.b18ac1).
...
using FX = ::zhc::lumi::factory::LumiAction<WXKG14_Actions>;
constexpr const char* kModels[] = { "lumi.remote.b18ac1" };
}
