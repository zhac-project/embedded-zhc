...
// Tier 2: Aqara QBKG35LM 3-gang CN H1 Pro.
// z2m-source: lumi.ts #QBKG35LM (lumi.switch.acn028).
...
constexpr const char* kModels[] = { "lumi.switch.acn028" };
}
...
extern const PreparedDefinition kDefQBKG35LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG35LM",.vendor="Xiaomi",
