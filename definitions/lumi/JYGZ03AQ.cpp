...
// Tier 3: Aqara JY-GZ-03AQ smoke sensor. IAS — muted v2.
// z2m-source: lumi.ts #JY-GZ-03AQ (lumi.sensor_smoke.acn04).
#include "definitions/lumi/_shared.hpp"
namespace zhc::devices::lumi {
namespace {
const FzConverter* const kFz[] = { &::zhc::lumi::kFzLumiBasic };
constexpr const char* kModels[] = { "lumi.sensor_smoke.acn04" };
}
