...
// Tier 1: Aqara JTQJ-BF-01LM/BW — auto-generated stub (battery + leak).
...
const FzConverter* const kFz[] = {
    ...
    &::zhc::lumi::kFzLumiWaterLeak,
};
constexpr const char* kModels[] = { "lumi.sensor_natgas" };
}
...
constexpr WhiteLabel kWhiteLabels_JTQJ_BF_01LM_BW[] = {
    {"Xiaomi","YTC4019RT"},
};
extern const PreparedDefinition kDefJTQJ_BF_01LM_BW{
    ...
    .model="JTQJ-BF-01LM/BW",.vendor="Xiaomi",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=kWhiteLabels_JTQJ_BF_01LM_BW, .white_labels_count=sizeof(kWhiteLabels_JTQJ_BF_01LM_BW)/sizeof(kWhiteLabels_JTQJ_BF_01LM_BW[0]),
