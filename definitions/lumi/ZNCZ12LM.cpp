...
// Tier 2: Aqara ZNCZ12LM smart plug (EU).
// z2m-source: lumi.ts #ZNCZ12LM (lumi.plug.maeu01).
...
constexpr const char* kModels[] = { "lumi.plug.maeu01", "lumi.plug.maus01" };
}
...
extern const PreparedDefinition kDefZNCZ12LM{
    .zigbee_models=kModels,.zigbee_models_count=2,.model="ZNCZ12LM",.vendor="Xiaomi",
