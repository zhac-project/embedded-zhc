...
// Tier 2: Aqara ZNQBKG12LM 1-gang CN mass market.
// z2m-source: lumi.ts #ZNQBKG12LM (lumi.switch.acn021).
...
constexpr const char* kModels[] = { "lumi.switch.acn021" };
}
...
extern const PreparedDefinition kDefZNQBKG12LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNQBKG12LM",.vendor="Xiaomi",
