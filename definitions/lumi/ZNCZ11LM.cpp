...
// Tier 2: Aqara ZNCZ11LM smart plug (US).
// z2m-source: lumi.ts #ZNCZ11LM (lumi.plug.maus01).
...
constexpr const char* kModels[] = { "lumi.plug.aq1" };
}
...
extern const PreparedDefinition kDefZNCZ11LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNCZ11LM",.vendor="Xiaomi",
