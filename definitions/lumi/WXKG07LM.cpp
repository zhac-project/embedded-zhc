...
// Tier 2: Aqara WXKG07LM dual-button wireless remote (D1).
// Same 5-entry action map as WXKG06LM.
// z2m-source: lumi.ts #WXKG07LM (lumi.remote.b286acn01).
...
namespace {
struct WXKG07_Actions {
    static constexpr ::zhc::lumi::LumiActionEntry entries[] = {
        {0, "hold"},       {1, "single"},      {2, "double"},
        {16, "single_both"}, {17, "double_both"},
    };
    static constexpr ::zhc::lumi::LumiActionMap map{ entries, 5 };
};
using FX = ::zhc::lumi::factory::LumiAction<WXKG07_Actions>;
constexpr const char* kModels[] = { "lumi.remote.b286acn01", "lumi.remote.b286acn02" };
}
