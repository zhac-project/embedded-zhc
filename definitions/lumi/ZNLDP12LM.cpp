...
// Tier 2: Aqara ZNLDP12LM ceiling light (CT).
// z2m-source: lumi.ts #ZNLDP12LM (lumi.light.cwopcn01).
...
constexpr const char* kModels[] = { "lumi.light.aqcn02", "lumi.light.cwopcn01" };
}
...
extern const PreparedDefinition kDefZNLDP12LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNLDP12LM",.vendor="Xiaomi",
