...
// Tier 2: Aqara QBCZ12LM outlet (CN).
// z2m-source: lumi.ts #QBCZ12LM (lumi.plug.macn01).
...
constexpr const char* kModels[] = { "lumi.plug.macn01" };
}
...
extern const PreparedDefinition kDefQBCZ12LM{
    .zigbee_models=kModels,.zigbee_models_count=1,.model="QBCZ12LM",.vendor="Xiaomi",
