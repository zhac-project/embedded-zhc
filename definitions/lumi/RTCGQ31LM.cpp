...
// Tier 1: Aqara RTCGQ31LM motion sensor.
// z2m-source: lumi.ts #RTCGQ31LM (lumi.motion.agl07).
...
constexpr const char* kModels[] = { "lumi.motion.agl07" };
}
