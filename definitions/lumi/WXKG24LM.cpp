...
// Tier 2: Aqara WXKG24LM wireless remote.
// z2m-source: lumi.ts #WXKG24LM (lumi.remote.acn011).
#include "definitions/lumi/_shared.hpp"
#include "definitions/lumi/factories.hpp"
namespace zhc::devices::lumi {
namespace {
struct WXKG24_Actions {
...
using FX = ::zhc::lumi::factory::LumiAction<WXKG24_Actions>;
constexpr const char* kModels[] = { "lumi.remote.acn011" };
}
