...
// Tier 3: Aqara SJCGQ13LM water-leak sensor (E1).
// IAS zone alarm — muted until v2.
// z2m-source: lumi.ts #SJCGQ13LM (lumi.sensor_wleak.acn01).
...
constexpr const char* kModels[] = { "lumi.flood.acn001", "lumi.sensor_wleak.acn01" };
}
