...
// Tier 2: Aqara QBKG25LM 2-gang CN H1 Pro wall switch.
// z2m-source: lumi.ts #QBKG25LM (lumi.switch.b2nacn02).
...
constexpr const char* kModels[] = { "lumi.switch.l3acn3" };
}
...
extern const PreparedDefinition kDefQBKG25LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG25LM",.vendor="Xiaomi",
