...
// Tier 1: Aqara RTCGQ15LM motion sensor P1 (longer battery life).
// z2m-source: lumi.ts #RTCGQ15LM (lumi.motion.ac02).
...
constexpr const char* kModels[] = { "lumi.motion.ac02", "lumi.motion.acn001" };
}
