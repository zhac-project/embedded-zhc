...
// Tier 2: Aqara WXKG27LM wireless remote.
// z2m-source: lumi.ts #WXKG27LM (lumi.remote.acn014).
...
constexpr const char* kModels[] = { "lumi.remote.acn014" };
}
