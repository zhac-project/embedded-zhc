...
// Tier 2: Aqara ZNQBKG17LM 3-gang CN mass market.
// z2m-source: lumi.ts #ZNQBKG17LM (lumi.switch.acn032).
...
constexpr const char* kModels[] = { "lumi.switch.acn032" };
}
...
extern const PreparedDefinition kDefZNQBKG17LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="ZNQBKG17LM",.vendor="Xiaomi",
