...
// Tier 2: Aqara WP-P03D smart plug (CN Pro).
// z2m-source: lumi.ts #WP-P03D (lumi.plug.macn06).
...
constexpr const char* kModels[] = { "lumi.plug.macn06" };
}
...
extern const PreparedDefinition kDefWPP03D{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="WP-P03D",.vendor="Xiaomi",
