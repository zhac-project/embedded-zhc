...
// Tier 3: Aqara RTCZCGQ11LM FP1 human-presence radar.
// Rich Aqara-specific attrs on manuSpecificLumi (presence_event / region
// enter/leave). That cluster lives in v2 — for now the device reports
// only battery via lumi_basic.
// z2m-source: lumi.ts #RTCZCGQ11LM (lumi.motion.ac01).
...
extern const PreparedDefinition kDefRTCZCGQ11LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="RTCZCGQ11LM",.vendor="Xiaomi",
