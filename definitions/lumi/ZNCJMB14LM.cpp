...
// Tier 1: Aqara ZNCJMB14LM — auto-generated stub.
// z2m-source: lumi.ts #ZNCJMB14LM.
#include "definitions/lumi/_shared.hpp"
#include "definitions/lumi/factories.hpp"
namespace zhc::devices::lumi {
namespace {
struct E { static constexpr ::zhc::lumi::DeviceEndpointLabel e[]={{1,"state_left"}, {2,"state_center"}, {3,"state_right"}};
          static constexpr ::zhc::lumi::DeviceEndpointLabels map{e,3}; };
using FX = ::zhc::lumi::factory::LumiOnOff<E>;
constexpr const char* kModels[] = { "lumi.switch.n4acn4" };
}
...
extern const PreparedDefinition kDefZNCJMB14LM{
    ...
    .model="ZNCJMB14LM",.vendor="Xiaomi",
