...
// Tier 2: Aqara QBKG22LM 2-gang US wall switch.
// z2m-source: lumi.ts #QBKG22LM (lumi.switch.b2naus01).
...
constexpr const char* kModels[] = { "lumi.switch.b2lacn02", "lumi.switch.b2naus01" };
}
...
extern const PreparedDefinition kDefQBKG22LM{
    .zigbee_models=kModels,.zigbee_models_count=sizeof(kModels)/sizeof(kModels[0]),.model="QBKG22LM",.vendor="Xiaomi",
