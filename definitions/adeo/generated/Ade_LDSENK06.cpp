...
extern const PreparedDefinition kDef_LDSENK06{
    .zigbee_models=kModels_LDSENK06, .zigbee_models_count=sizeof(kModels_LDSENK06)/sizeof(kModels_LDSENK06[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="LDSENK06", .vendor="Adeo",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_LDSENK06, .from_zigbee_count=sizeof(kFz_LDSENK06)/sizeof(kFz_LDSENK06[0]),
