...
// Tier 2: Iluminize 5717 — DIN-rail smart dimmer with energy metering.
//
...
const TzConverter* const kTz_D5717[] = {
    &::zhc::generic::kTzOnOff,
    &::zhc::generic::kTzBrightness,
};
constexpr const char* kModels_D5717[] = { "5717" };

constexpr Expose kExposes_D5717[] = {
...
constexpr BindingSpec kBindings_D5717[] = {
    {1, 0x0006},   // genOnOff
...
extern const PreparedDefinition kDef_D5717{
    .zigbee_models=kModels_D5717, .zigbee_models_count=sizeof(kModels_D5717)/sizeof(kModels_D5717[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="5717", .vendor="Iluminize",
    .meta=nullptr, .exposes=kExposes_D5717, .exposes_count=sizeof(kExposes_D5717)/sizeof(kExposes_D5717[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_D5717, .from_zigbee_count=sizeof(kFz_D5717)/sizeof(kFz_D5717[0]),
    .to_zigbee=kTz_D5717, .to_zigbee_count=sizeof(kTz_D5717)/sizeof(kTz_D5717[0]),
    .configure=nullptr, .on_event=nullptr,
    .bindings=kBindings_D5717, .bindings_count=sizeof(kBindings_D5717)/sizeof(kBindings_D5717[0]),
};
