...
extern const PreparedDefinition kDef_ZD1_EN{
    .zigbee_models=kModels_ZD1_EN, .zigbee_models_count=sizeof(kModels_ZD1_EN)/sizeof(kModels_ZD1_EN[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="ZD1-EN", .vendor="Imou",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_ZD1_EN, .from_zigbee_count=sizeof(kFz_ZD1_EN)/sizeof(kFz_ZD1_EN[0]),
