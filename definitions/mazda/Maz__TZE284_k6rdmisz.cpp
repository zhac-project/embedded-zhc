...
// Tier 2: MAZDA TR-M2Z thermostatic radiator valve (TS0601 / _TZE284_k6rdmisz).
...
constexpr ::zhc::tuya::TuyaDpMapEntry kEntries__TZE284_k6rdmisz[] = {
...
// kEntries__TZE284_k6rdmisz holds 23 rows — every DP lookup that missed walked one
// element past the end of the array. Made sizeof-derived so it cannot
// drift again when a DP is added or removed.
constexpr ::zhc::tuya::TuyaDatapointMap kMap__TZE284_k6rdmisz{
    kEntries__TZE284_k6rdmisz, sizeof(kEntries__TZE284_k6rdmisz) / sizeof(kEntries__TZE284_k6rdmisz[0]) };
constexpr FzConverter kFzDp__TZE284_k6rdmisz{
    ...
    .user_config       = &kMap__TZE284_k6rdmisz,
};
const FzConverter* const kFz__TZE284_k6rdmisz[] = {
    &::zhc::tuya::kFzTuyaMcuSyncTime,
    &kFzDp__TZE284_k6rdmisz,
};
constexpr TzConverter kTzDp__TZE284_k6rdmisz{
...
const TzConverter* const kTz__TZE284_k6rdmisz[] = { &kTzDp__TZE284_k6rdmisz };
constexpr const char* kM__TZE284_k6rdmisz[] = { "TS0601" };
constexpr const char* kN__TZE284_k6rdmisz[] = { "_TZE284_k6rdmisz" };
}  // namespace
...
extern const PreparedDefinition kDefMaz__TZE284_k6rdmisz{
    .zigbee_models=kM__TZE284_k6rdmisz,.zigbee_models_count=sizeof(kM__TZE284_k6rdmisz)/sizeof(kM__TZE284_k6rdmisz[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=kN__TZE284_k6rdmisz,.manufacturer_names_count=1,
    .model="TR-M2Z",.vendor="Mazda",
    .meta=nullptr,.exposes=kAutoExposes,.exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr,.white_labels_count=0,
    .from_zigbee=kFz__TZE284_k6rdmisz,
    .from_zigbee_count=sizeof(kFz__TZE284_k6rdmisz)/sizeof(kFz__TZE284_k6rdmisz[0]),
    .to_zigbee=kTz__TZE284_k6rdmisz,
    .to_zigbee_count=sizeof(kTz__TZE284_k6rdmisz)/sizeof(kTz__TZE284_k6rdmisz[0]),
