...
// Tier 1: Yokis E2BPA-UP — parity-extended 2026-04-28.
// Flush-mounted independent 2-channel transmitter (mains-powered)
// z2m-source: yokis.ts #E2BPA-UP.
//
// Same shape as E2BP-UP minus battery; mains-powered antenna variant.
...
namespace {
const FzConverter* const kFz_E2BPA_UP[] = {
...
const TzConverter* const kTz_E2BPA_UP[] = {
    &::zhc::generic::kTzOnOff,
};
constexpr const char* kModels_E2BPA_UP[] = { "E2BPA-UP" };
...
extern const PreparedDefinition kDef_E2BPA_UP{
    .zigbee_models=kModels_E2BPA_UP, .zigbee_models_count=sizeof(kModels_E2BPA_UP)/sizeof(kModels_E2BPA_UP[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="E2BPA-UP", .vendor="Yokis",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_E2BPA_UP, .from_zigbee_count=sizeof(kFz_E2BPA_UP)/sizeof(kFz_E2BPA_UP[0]),
    .to_zigbee=kTz_E2BPA_UP, .to_zigbee_count=sizeof(kTz_E2BPA_UP)/sizeof(kTz_E2BPA_UP[0]),
