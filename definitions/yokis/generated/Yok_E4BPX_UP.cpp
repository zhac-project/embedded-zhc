...
// Tier 1: Yokis E4BPX-UP — parity-extended 2026-04-28.
// Flush-mounted independent 4-channel transmitter (with antenna)
// z2m-source: yokis.ts #E4BPX-UP.
//
...
namespace {
const FzConverter* const kFz_E4BPX_UP[] = {
...
const TzConverter* const kTz_E4BPX_UP[] = {
    &::zhc::generic::kTzOnOff,
};
constexpr const char* kModels_E4BPX_UP[] = { "E4BPX-UP" };
...
extern const PreparedDefinition kDef_E4BPX_UP{
    .zigbee_models=kModels_E4BPX_UP, .zigbee_models_count=sizeof(kModels_E4BPX_UP)/sizeof(kModels_E4BPX_UP[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="E4BPX-UP", .vendor="Yokis",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_E4BPX_UP, .from_zigbee_count=sizeof(kFz_E4BPX_UP)/sizeof(kFz_E4BPX_UP[0]),
    .to_zigbee=kTz_E4BPX_UP, .to_zigbee_count=sizeof(kTz_E4BPX_UP)/sizeof(kTz_E4BPX_UP[0]),
