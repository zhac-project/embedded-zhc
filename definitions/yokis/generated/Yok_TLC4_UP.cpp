...
// Tier 1: Yokis TLC4-UP — parity-extended 2026-04-28.
// Keyring Design series 4-button remote control
// z2m-source: yokis.ts #TLC4-UP.
//
...
namespace {
const FzConverter* const kFz_TLC4_UP[] = {
...
const TzConverter* const kTz_TLC4_UP[] = {
    &::zhc::generic::kTzOnOff,
};
constexpr const char* kModels_TLC4_UP[] = { "TLC4-UP" };
...
extern const PreparedDefinition kDef_TLC4_UP{
    .zigbee_models=kModels_TLC4_UP, .zigbee_models_count=sizeof(kModels_TLC4_UP)/sizeof(kModels_TLC4_UP[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="TLC4-UP", .vendor="Yokis",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_TLC4_UP, .from_zigbee_count=sizeof(kFz_TLC4_UP)/sizeof(kFz_TLC4_UP[0]),
    .to_zigbee=kTz_TLC4_UP, .to_zigbee_count=sizeof(kTz_TLC4_UP)/sizeof(kTz_TLC4_UP[0]),
