...
// Tier 1: Yokis TLM4-UP — parity-extended 2026-04-28.
// Wall-mounted 4-button transmitter
// z2m-source: yokis.ts #TLM4-UP.
//
...
namespace {
const FzConverter* const kFz_TLM4_UP[] = {
...
const TzConverter* const kTz_TLM4_UP[] = {
    &::zhc::generic::kTzOnOff,
};
constexpr const char* kModels_TLM4_UP[] = { "TLM4-UP", "TLM4T503-UP", "TLM4TNO-UP", "TLM4TDK-UP" };
...
extern const PreparedDefinition kDef_TLM4_UP{
    .zigbee_models=kModels_TLM4_UP, .zigbee_models_count=sizeof(kModels_TLM4_UP)/sizeof(kModels_TLM4_UP[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="TLM4-UP", .vendor="Yokis",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_TLM4_UP, .from_zigbee_count=sizeof(kFz_TLM4_UP)/sizeof(kFz_TLM4_UP[0]),
    .to_zigbee=kTz_TLM4_UP, .to_zigbee_count=sizeof(kTz_TLM4_UP)/sizeof(kTz_TLM4_UP[0]),
