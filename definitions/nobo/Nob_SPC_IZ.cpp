...
// Tier 2: Nobø SPC-IZ — graduated from generated/ 2026-06-10.
// Control unit for panel heaters.
//
// z2m-source: nobo.ts #SPC-IZ (m.identify + m.thermostat).
//
...
const FzConverter* const kFz_SPC_IZ[] = {
    &kFzNoboThermostat,
};
const TzConverter* const kTz_SPC_IZ[] = {
    &::zhc::generic::kTzThermostat,
};
constexpr Expose kExp_SPC_IZ[] = {
...
constexpr BindingSpec kBind_SPC_IZ[] = {
...
extern const PreparedDefinition kDef_SPC_IZ{
    ...
    .meta=nullptr, .exposes=kExp_SPC_IZ, .exposes_count=sizeof(kExp_SPC_IZ)/sizeof(kExp_SPC_IZ[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_SPC_IZ, .from_zigbee_count=sizeof(kFz_SPC_IZ)/sizeof(kFz_SPC_IZ[0]),
    .to_zigbee=kTz_SPC_IZ, .to_zigbee_count=sizeof(kTz_SPC_IZ)/sizeof(kTz_SPC_IZ[0]),
    .configure=nullptr, .on_event=nullptr,
    .bindings                 = kBind_SPC_IZ,
    .bindings_count           = sizeof(kBind_SPC_IZ)/sizeof(kBind_SPC_IZ[0]),
};
