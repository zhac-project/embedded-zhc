...
// Tier 2: Rademacher 35144001 — graduated from generated/ for a parity fix.
// addZ white + colour
...
// z2m-source: rademacher.ts #35144001.
#include "definitions/_generic/_shared.hpp"

namespace zhc::devices::rademacher {
namespace {
const FzConverter* const kFz_D35144001[] = {
    &::zhc::generic::kFzOnOff,
    &::zhc::generic::kFzBrightness,
    &::zhc::generic::kFzColorTemperature,
    &::zhc::generic::kFzColor,
};
const TzConverter* const kTz_D35144001[] = {
    &::zhc::generic::kTzOnOff,
    &::zhc::generic::kTzBrightness,
    &::zhc::generic::kTzColorTemp,
    &::zhc::generic::kTzColor,
};
constexpr const char* kModels_D35144001[] = { "RDM-35144001" };
...
extern const PreparedDefinition kDef_D35144001{
    .zigbee_models=kModels_D35144001, .zigbee_models_count=sizeof(kModels_D35144001)/sizeof(kModels_D35144001[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="35144001", .vendor="Rademacher",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_D35144001, .from_zigbee_count=sizeof(kFz_D35144001)/sizeof(kFz_D35144001[0]),
    .to_zigbee=kTz_D35144001, .to_zigbee_count=sizeof(kTz_D35144001)/sizeof(kTz_D35144001[0]),
