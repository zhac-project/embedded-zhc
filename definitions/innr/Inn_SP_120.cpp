...
// Tier 2: Innr SP 120 — hand-maintained parity override.
// Smart plug with power monitoring.
//
// Graduated from generated/Inn_SP_120.cpp: the auto-generator wired only
...
// power-plug override.
// z2m-source: innr.ts #SP 120.
#include "definitions/_generic/_shared.hpp"

namespace zhc::devices::innr {
namespace {
const FzConverter* const kFz_SP_120[] = {
    &::zhc::generic::kFzOnOff,
    &::zhc::generic::kFzElectricalMeasurement,
    &::zhc::generic::kFzMetering,
};
const TzConverter* const kTz_SP_120[] = {
    &::zhc::generic::kTzOnOff,
};
constexpr const char* kModels_SP_120[] = { "SP 120" };
...
extern const PreparedDefinition kDef_SP_120{
    .zigbee_models=kModels_SP_120, .zigbee_models_count=sizeof(kModels_SP_120)/sizeof(kModels_SP_120[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="SP 120", .vendor="Innr",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_SP_120, .from_zigbee_count=sizeof(kFz_SP_120)/sizeof(kFz_SP_120[0]),
    .to_zigbee=kTz_SP_120, .to_zigbee_count=sizeof(kTz_SP_120)/sizeof(kTz_SP_120[0]),
