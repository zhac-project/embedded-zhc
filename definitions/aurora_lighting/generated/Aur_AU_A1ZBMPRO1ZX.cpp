...
// Tier 1: AuroraLighting AU-A1ZBMPRO1ZX — shared CT-light bundle.
// AOne MPROZX fixed IP65 fire rated smart tuneable LED downlight
// z2m-source: aurora_lighting.ts #AU-A1ZBMPRO1ZX  (m.light({colorTemp:[200,455]}))
#include "definitions/aurora_lighting/_shared.hpp"

namespace zhc::devices::aurora_lighting {
namespace {
constexpr const char* kModels_AU_A1ZBMPRO1ZX[] = { "TWMPROZXBulb50AU" };
}  // namespace

extern const PreparedDefinition kDef_AU_A1ZBMPRO1ZX{
    .zigbee_models=kModels_AU_A1ZBMPRO1ZX,
    .zigbee_models_count=sizeof(kModels_AU_A1ZBMPRO1ZX)/sizeof(kModels_AU_A1ZBMPRO1ZX[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="AU-A1ZBMPRO1ZX", .vendor="AuroraLighting",
    .meta=nullptr,
