...
extern const PreparedDefinition kDef_KKZ_DO021{
    .zigbee_models=kModels_KKZ_DO021, .zigbee_models_count=sizeof(kModels_KKZ_DO021)/sizeof(kModels_KKZ_DO021[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="KKZ-DO021", .vendor="Hej",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_KKZ_DO021, .from_zigbee_count=sizeof(kFz_KKZ_DO021)/sizeof(kFz_KKZ_DO021[0]),
