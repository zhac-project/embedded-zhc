...
// Tier 1: Philips 4440156P6 — Hue Wellner white ambiance E27 806lm with Bluetooth.
// New upstream in z2m v26.100.0.
// z2m-source: philips.ts #4440156P6.
...
constexpr const char* kModels_D4440156P6[] = { "4440156P6" };

}  // namespace

extern const PreparedDefinition kDef_D4440156P6{
    .zigbee_models           = kModels_D4440156P6,
    .zigbee_models_count     = sizeof(kModels_D4440156P6)/sizeof(kModels_D4440156P6[0]),
