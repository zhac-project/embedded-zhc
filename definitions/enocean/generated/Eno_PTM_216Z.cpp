...
// Tier 1: Enocean PTM 216Z — auto-generated.
// Pushbutton transmitter module
// z2m-source: enocean.ts #PTM 216Z.
#include "definitions/_generic/_shared.hpp"

namespace zhc::devices::enocean {
namespace {
const FzConverter* const kFz_PTM_216Z[] = {
    &::zhc::generic::kFzOnOff,
};
const TzConverter* const kTz_PTM_216Z[] = {
...
extern const PreparedDefinition kDef_PTM_216Z{
    ...
    .from_zigbee=kFz_PTM_216Z, .from_zigbee_count=sizeof(kFz_PTM_216Z)/sizeof(kFz_PTM_216Z[0]),
    .to_zigbee=kTz_PTM_216Z, .to_zigbee_count=sizeof(kTz_PTM_216Z)/sizeof(kTz_PTM_216Z[0]),
