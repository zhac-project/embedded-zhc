...
const TzConverter* const kTz_SPM02_U00[] = {
    &::zhc::generic::kTzOnOff,
};
constexpr const char* kModels_SPM02_U00[] = { "SPM02-E0" };
...
extern const PreparedDefinition kDef_SPM02_U00{
    .zigbee_models=kModels_SPM02_U00, .zigbee_models_count=sizeof(kModels_SPM02_U00)/sizeof(kModels_SPM02_U00[0]),
    .manufacturer_name_prefix=nullptr,
    .manufacturer_names=nullptr, .manufacturer_names_count=0,
    .model="SPM02-U00", .vendor="BituoTechnik",
    .meta=nullptr, .exposes=kAutoExposes, .exposes_count=sizeof(kAutoExposes)/sizeof(kAutoExposes[0]),
    .white_labels=nullptr, .white_labels_count=0,
    .from_zigbee=kFz_SPM02_U00, .from_zigbee_count=sizeof(kFz_SPM02_U00)/sizeof(kFz_SPM02_U00[0]),
    .to_zigbee=kTz_SPM02_U00, .to_zigbee_count=sizeof(kTz_SPM02_U00)/sizeof(kTz_SPM02_U00[0]),
