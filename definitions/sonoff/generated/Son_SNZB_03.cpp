...
// Tier 1: Sonoff SNZB-03 — auto-generated.
// Motion sensor
// z2m-source: sonoff.ts #SNZB-03.
#include "definitions/_generic/_shared.hpp"

namespace zhc::devices::sonoff {
namespace {
const FzConverter* const kFz_SNZB_03[] = {
    &::zhc::generic::kFzIasZone,
    &::zhc::generic::kFzBattery,
};

constexpr const char* kModels_SNZB_03[] = { "MS01", "MSO1", "SNZB-03", "CK-TLSR8656-SS5-01(7002)", "66666" };
